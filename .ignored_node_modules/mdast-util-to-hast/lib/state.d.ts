 ...
 *   Wrapped nodes.
 */
export function wrap<Type extends HastRootContent>(
  nodes: Array<Type>,
...
export type FootnoteBackContentTemplate =
  import('./footer.js').FootnoteBackContentTemplate
export type FootnoteBackLabelTemplate =
  import('./footer.js').FootnoteBackLabelTemplate
/**
 * Handle a node.
 */
export type Handler = (
...
) => Array<HastElementContent> | HastElementContent | undefined
/**
 * Handle nodes.
 */
...
export type State = {
   ...
   */
  wrap: <Type extends HastRootContent>(
    nodes: Array<Type>,
    loose?: boolean | undefined
  ) => Array<HastText | Type>
}
