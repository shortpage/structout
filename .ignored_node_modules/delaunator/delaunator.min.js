!(function (t, i) {
  ...
  function u(t, n, u, _, d, g) {
    const y = (n - g) * (u - d),
      ...
      b = y - w,
      A = Math.abs(y + w);
    return Math.abs(b) >= 33306690738754716e-32 * A
      ? b
      : -(function (t, n, u, _, d, g, y) {
  ...
  class g {
    ...
    update() {
      ...
      for (let i = 0; i < h; i++)
        this._dists[i] = y(t[2 * i], t[2 * i + 1], U.x, U.y);
      ...
      (s[d] = i[w] = g),
        ...
        (e[w] = 2),
        n.fill(-1),
        (n[this._hashKey(k, M)] = d),
        (n[this._hashKey(p, x)] = g),
        (n[this._hashKey(T, z)] = w),
        (this.trianglesLen = 0),
        this._addTriangle(d, g, w, -1, -1, -1);
      for (let h, r, l = 0; l < this._ids.length; l++) {
        ...
        let c = 0;
        for (
          let t = 0, i = this._hashKey(a, f);
          t < this._hashSize &&
          ((c = n[(i + t) % this._hashSize]), -1 === c || c === s[c]);
          t++
        );
        c = i[c];
        let y,
        ...
        for (
          ;
          (y = s[b]),
            u(a, f, t[2 * b], t[2 * b + 1], t[2 * y], t[2 * y + 1]) >= 0;
        ...
        for (
          ;
          (y = s[k]),
            u(a, f, t[2 * k], t[2 * k + 1], t[2 * y], t[2 * y + 1]) < 0;

        )
          (A = this._addTriangle(k, o, y, e[o], -1, e[k])),
            (e[o] = this._legalize(A + 2)),
            (s[k] = k),
            m--,
            (k = y);
        if (b === c)
          for (
            ;
            (y = i[b]),
              u(a, f, t[2 * y], t[2 * y + 1], t[2 * b], t[2 * b + 1]) < 0;

          )
            (A = this._addTriangle(y, o, b, -1, e[b], e[y])),
              this._legalize(A + 2),
              (e[y] = A),
              (s[b] = b),
              m--,
              (b = y);
        (this._hullStart = i[o] = b),
          (s[b] = i[k] = o),
          (s[o] = k),
          (n[this._hashKey(a, f)] = o),
          (n[this._hashKey(t[2 * b], t[2 * b + 1])] = b);
      }
      this.hull = new Uint32Array(m);
      for (let t = 0, i = this._hullStart; t < m; t++)
        (this.hull[t] = i), (i = s[i]);
  ...
  function A(t, i, s, e) {
    if (e - s <= 20)
      ...
      (t[s + 1] = t[h]),
        (t[h] = r),
        e - n + 1 >= h - s
          ? (A(t, i, n, e), A(t, i, s, h - 1))
          : (A(t, i, s, h - 1), A(t, i, n, e));
    }
  }
  function k(t, i, s) {
    const e = t[i];
