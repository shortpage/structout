...
exports.stripLineComment =
  exports.minifyRawValues =
  exports.minifyRaw =
  exports.minifyCookedValues =
  exports.minifyCooked =
  exports.compressSymbols =
    void 0;
...
const injectUniquePlaceholders = (strArr) => {
  ...
  return strArr.reduce((str, val, index, arr) => {
    return (
      ...
      val +
      (index < arr.length - 1
        ? (0, _placeholderUtils.makePlaceholder)(i++)
        : "")
    );
  }, "");
};
...
const minify = (linebreakPattern) => {
  ...
  return (code) => {
    ...
    const eliminatedExpressionIndices = (0, _difference.default)(
...
const minifyRawValues = (rawValues) =>
  (0, _placeholderUtils.splitByPlaceholders)(
