...
exports.isWithThemeHelper =
  exports.isValidTopLevelImport =
  exports.isUseTheme =
  exports.isStyled =
  exports.isPureHelper =
  exports.isKeyframesHelper =
  exports.isInjectGlobalHelper =
  exports.isHelper =
  exports.isCreateGlobalStyleHelper =
  exports.isCSSHelper =
  exports.importLocalName =
    void 0;
var _getSequenceExpressionValue = _interopRequireDefault(
  require("./getSequenceExpressionValue"),
);
...
const isValidTopLevelImport = (x, state) => {
  return [
    ...
    ...(0, _options.useTopLevelImportPathMatchers)(state),
...
const isStyled = (t) => (tag, state) => {
  if (
    ...
    t.isMemberExpression(
      (0, _getSequenceExpressionValue.default)(tag.callee),
    ) &&
    (0, _getSequenceExpressionValue.default)(tag.callee).property.name !==
    ...
    return (
      ...
      (t.isCallExpression(tag) &&
        t.isSequenceExpression(tag.callee) &&
        (0, _getSequenceExpressionValue.default)(tag.callee).name ===
          importLocalName("default", state, {
            cacheIdentifier: (0, _getSequenceExpressionValue.default)(
              tag.callee,
            ).name,
          })) ||
      /**
      ...
      (state.styledRequired &&
        ...
        (0, _getSequenceExpressionValue.default)(tag.callee).property.name ===
          "default" &&
        (0, _getSequenceExpressionValue.default)(tag.callee).object.name ===
          state.styledRequired) ||
      (importLocalName("default", state) &&
        t.isMemberExpression(tag) &&
        t.isMemberExpression(tag.object) &&
...
const isCreateGlobalStyleHelper = (t) => (tag, state) =>
  t.isIdentifier(tag) &&
...
const isPureHelper = (t) => (tag, state) =>
  isCreateGlobalStyleHelper(t)(tag, state) ||
  isCSSHelper(t)(tag, state) ||
  isKeyframesHelper(t)(tag, state) ||
  isUseTheme(t)(tag, state) ||
