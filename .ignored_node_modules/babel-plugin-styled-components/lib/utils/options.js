...
exports.useTranspileTemplateLiterals =
  exports.useTopLevelImportPathMatchers =
  exports.useSSR =
  exports.usePureAnnotation =
  exports.useNamespace =
  exports.useMinify =
  exports.useMeaninglessFileNames =
  exports.useFileName =
  exports.useDisplayName =
  exports.useCssProp =
    void 0;
...
const useTopLevelImportPathMatchers = (state) =>
  getOption(state, "topLevelImportPaths", []).map((pattern) =>
    (0, _picomatch.default)(pattern),
  );
...
const useMeaninglessFileNames = (state) =>
...
const useTranspileTemplateLiterals = (state) =>
