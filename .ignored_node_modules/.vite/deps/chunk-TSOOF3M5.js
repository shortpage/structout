import { IconButton_default } from "./chunk-O22ZMNIE.js";
import { Paper_default } from "./chunk-CI2U4IRN.js";
import { createSvgIcon, init_createSvgIcon } from "./chunk-N5DYI26U.js";
import { capitalize_default, init_capitalize } from "./chunk-H3XAG6DZ.js";
import {
  init_DefaultPropsProvider,
  useDefaultProps,
} from "./chunk-M4KRUI7Z.js";
import { init_styled, styled_default } from "./chunk-ZZD5HFOM.js";
import {
...
function useSlot(name, parameters) {
  ...
  const resolvedComponentsProps = resolveComponentProps_default(
    slotProps[name],
    ownerState,
  );
  const _mergeSlotProps = mergeSlotProps_default(
      _extends(
        {
          className,
        },
...
var ReportProblemOutlined_default = createSvgIcon(
...
var ErrorOutline_default = createSvgIcon(
...
var InfoOutlined_default = createSvgIcon(
...
var Close_default = createSvgIcon(
...
var AlertRoot = styled_default(Paper_default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[
        `${ownerState.variant}${capitalize_default(ownerState.color || ownerState.severity)}`
      ],
    ];
  },
})(({ theme }) => {
  const getColor =
    theme.palette.mode === "light"
      ? import_colorManipulator.darken
      : import_colorManipulator.lighten;
  ...
  return (0, import_jsx_runtime7.jsxs)(
    ...
    _extends(
      ...
      other,
      {
        children: [
          icon !== false
            ? (0, import_jsx_runtime6.jsx)(AlertIcon, {
                ownerState,
            ...
            : null,
          (0, import_jsx_runtime6.jsx)(AlertMessage, {
            ownerState,
            className: classes.message,
            children,
          }),
          action != null
            ? (0, import_jsx_runtime6.jsx)(AlertAction, {
                ownerState,
...
true
  ? (Alert.propTypes = {
       ...
       * @default 'success'
       */
      severity: import_prop_types.default.oneOfType([
        import_prop_types.default.oneOf([
          "error",
          "info",
          "success",
      ...
      slotProps: import_prop_types.default.shape({
        closeButton: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
        closeIcon: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
      }),
      ...
      variant: import_prop_types.default.oneOfType([
        import_prop_types.default.oneOf(["filled", "outlined", "standard"]),
        import_prop_types.default.string,
      ]),
    })
  : void 0;
...
//# sourceMappingURL=chunk-TSOOF3M5.js.map
