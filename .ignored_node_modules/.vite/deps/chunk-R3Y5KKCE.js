...
true
  ? (Grow.propTypes = {
       ...
       */
      easing: import_prop_types2.default.oneOfType([
       ...
       * @default 'auto'
       */
      timeout: import_prop_types2.default.oneOfType([
        import_prop_types2.default.oneOf(["auto"]),
...
var SnackbarContentRoot = styled_default(Paper_default, {
  ...
  const backgroundColor = (0, import_colorManipulator.emphasize)(
...
var SnackbarContent = React4.forwardRef(
  function SnackbarContent2(inProps, ref) {
    ...
    return (0, import_jsx_runtime4.jsxs)(
      ...
      _extends(
        ...
        {
          children: [
            (0, import_jsx_runtime3.jsx)(SnackbarContentMessage, {
              className: classes.message,
              ownerState,
              children: message,
            }),
            action
              ? (0, import_jsx_runtime3.jsx)(SnackbarContentAction, {
...
var SnackbarRoot = styled_default("div", {
  ...
  overridesResolver: (props, styles2) => {
    ...
    return [
      styles2.root,
      styles2[
        `anchorOrigin${capitalize_default(ownerState.anchorOrigin.vertical)}${capitalize_default(ownerState.anchorOrigin.horizontal)}`
      ],
    ];
  },
})(({ theme, ownerState }) => {
...
var Snackbar = React5.forwardRef(function Snackbar2(inProps, ref) {
  ...
  const { getRootProps, onClickAway } = useSnackbar_default(
    _extends({}, ownerState),
  );
...
true
  ? (Snackbar.propTypes = {
      ...
      anchorOrigin: import_prop_types4.default.shape({
        horizontal: import_prop_types4.default.oneOf([
          "center",
          "left",
          "right",
        ]).isRequired,
...
//# sourceMappingURL=chunk-R3Y5KKCE.js.map
