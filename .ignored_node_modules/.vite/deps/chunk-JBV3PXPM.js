import { getTransitionProps, reflow } from "./chunk-TJ4WWSAQ.js";
import { Transition_default } from "./chunk-I4LR2DJ2.js";
import { Paper_default } from "./chunk-CI2U4IRN.js";
import { useTheme } from "./chunk-7X7Y3BD3.js";
import { require_react_dom } from "./chunk-KPD4VVXB.js";
import {
  capitalize_default,
  init_capitalize,
  init_useForkRef,
  useForkRef_default,
} from "./chunk-H3XAG6DZ.js";
import {
...
var Portal = React2.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(
    React2.isValidElement(children) ? getReactElementRef(children) : null,
    forwardedRef,
  );
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var Fade = React3.forwardRef(function Fade2(props, ref) {
  ...
  const handleRef = useForkRef_default(
    nodeRef,
...
true
  ? (Backdrop.propTypes = {
       ...
       * You may specify a single timeout for all transitions, or individually with an object.
       */
      transitionDuration: import_prop_types4.default.oneOfType([
...
function useModal(parameters) {
  ...
  const isTopModal = React5.useCallback(
...
true
  ? (Modal.propTypes = {
      ...
      componentsProps: import_prop_types5.default.shape({
        backdrop: import_prop_types5.default.oneOfType([
       ...
       * so it's simply `document.body` most of the time.
       */
      container: import_prop_types5.default.oneOfType([
        HTMLElementType,
        import_prop_types5.default.func,
      ]),
      /**
...
var DialogContainer = styled_default("div", {
  ...
  overridesResolver: (props, styles2) => {
    ...
    return [
      styles2.container,
      styles2[`scroll${capitalize_default(ownerState.scroll)}`],
    ];
  },
})(({ ownerState }) =>
  _extends(
...
var DialogPaper = styled_default(Paper_default, {
  ...
  overridesResolver: (props, styles2) => {
    ...
    return [
      styles2.paper,
      styles2[`scrollPaper${capitalize_default(ownerState.scroll)}`],
      styles2[`paperWidth${capitalize_default(String(ownerState.maxWidth))}`],
                ...
                children: (0, import_jsx_runtime8.jsx)(
                  ...
                  _extends(
                    ...
                    PaperProps,
                    {
                      ...
                      ownerState,
                      children: (0, import_jsx_runtime8.jsx)(
                        DialogContext_default.Provider,
                        {
...
true
  ? (Dialog.propTypes = {
       ...
       * @default 'sm'
       */
      maxWidth: import_prop_types6.default.oneOfType([
        import_prop_types6.default.oneOf(["xs", "sm", "md", "lg", "xl", false]),
       ...
       * }
       */
      transitionDuration: import_prop_types6.default.oneOfType([
...
//# sourceMappingURL=chunk-JBV3PXPM.js.map
