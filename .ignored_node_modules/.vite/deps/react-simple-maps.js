import { require_prop_types } from "./chunk-XWMEDHYJ.js";
import { require_react } from "./chunk-I773Y2XN.js";
  ...
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (
      ...
      var point1 = ring[j],
        ...
        k = sinPhi0 * sinPhi1;
      sum.add(
        atan2(k * sign2 * sin(absDelta), cosPhi0 * cosPhi1 + k * cos(absDelta)),
      );
    ...
    return {
      ...
      point: function (lambda, phi) {
        ...
        if (v !== v0) {
          ...
          if (
            !point2 ||
            pointEqual_default(point0, point2) ||
            pointEqual_default(point1, point2)
          )
            point1[2] = 1;
        }
        if (v !== v0) {
    ...
    if (
      meridian
        ? polar
          ...
          : phi0 <= q[1] && q[1] <= phi1
        : (delta2 > pi) ^ (lambda0 <= q[0] && q[0] <= lambda1)
    ) {
...
function clipRectangle(x05, y05, x12, y12) {
  ...
  function interpolate(from, to, direction, stream) {
    ...
    if (
      ...
      do stream.point(a === 0 || a === 3 ? x05 : x12, a > 1 ? y12 : y05);
  ...
  return function (stream) {
    ...
    function polygonEnd() {
      var startInside = polygonInside(),
        ...
        visible2 = (segments = merge_default(segments)).length;
...
function graticule() {
  ...
  function lines() {
    return range_default(ceil(X02 / DX) * DX, X12, DX)
      .map(X)
      .concat(range_default(ceil(Y02 / DY) * DY, Y12, DY).map(Y))
      .concat(
        range_default(ceil(x05 / dx) * dx, x12, dx)
          .filter(function (x2) {
      ...
      .concat(
        range_default(ceil(y05 / dy) * dy, y12, dy)
          .filter(function (y2) {
...
function path_default(projection2, context) {
  ...
  path.projection = function (_) {
    return arguments.length
      ? ((projectionStream =
          _ == null
            ? ((projection2 = null), identity_default2)
...
function projectionMutator(projectAt) {
  ...
  projection2.postclip = function (_) {
    return arguments.length
      ? ((postclip = _), (x05 = y05 = x12 = y12 = null), reset())
      : postclip;
  };
  projection2.clipAngle = function (_) {
    return arguments.length
      ? ((preclip = +_
          ? circle_default((theta = _ * radians))
  ...
  projection2.clipExtent = function (_) {
    return arguments.length
      ? ((postclip =
          _ == null
            ? ((x05 = y05 = x12 = y12 = null), identity_default2)
            : clipRectangle(
                (x05 = +_[0][0]),
                (y05 = +_[0][1]),
                (x12 = +_[1][0]),
...
function mercatorProjection(project) {
  ...
  function reclip() {
    var k = pi * scale(),
      t = m(rotation_default(m.rotate()).invert([0, 0]));
    return clipExtent(
      x05 == null
        ? [
            [t[0] - k, t[1] - k],
        ...
        : project === mercatorRaw
          ? [
              [Math.max(t[0] - k, x05), y05],
              [Math.min(t[0] + k, x12), y12],
            ]
          : [
              [x05, Math.max(t[1] - k, y05)],
...
function conicConformalRaw(y05, y12) {
  var cy0 = cos(y05),
    n =
      y05 === y12 ? sin(y05) : log(cy0 / cos(y12)) / log(tany(y12) / tany(y05)),
    f = (cy0 * pow(tany(y05), n)) / n;
...
function conicEquidistantRaw(y05, y12) {
  var cy0 = cos(y05),
    n = y05 === y12 ? sin(y05) : (cy0 - cos(y12)) / (y12 - y05),
    g = cy0 / n + y05;
...
function naturalEarth1Raw(lambda, phi) {
  ...
  return [
    lambda *
      (0.8707 -
        0.131979 * phi2 +
        phi4 * (-0.013791 + phi4 * (3971e-6 * phi2 - 1529e-6 * phi4))),
    phi *
      (1.007226 +
        phi2 *
          (0.015085 + phi4 * (-0.044475 + 0.028874 * phi2 - 5916e-6 * phi4))),
  ];
}
    ...
    phi -= delta =
      (phi *
        (1.007226 +
          phi2 *
            (0.015085 +
              phi4 * (-0.044475 + 0.028874 * phi2 - 5916e-6 * phi4))) -
        y) /
      (1.007226 +
        phi2 *
          (0.015085 * 3 +
            phi4 *
              (-0.044475 * 7 + 0.028874 * 9 * phi2 - 5916e-6 * 11 * phi4)));
    ...
    x /
      (0.8707 +
        (phi2 = phi * phi) *
          (-0.131979 +
            phi2 *
              (-0.013791 + phi2 * phi2 * phi2 * (3971e-6 - 1529e-6 * phi2)))),
    phi,
  ];
};
...
function object(topology, o) {
  var transformPoint = transform_default2(topology.transform),
    arcs = topology.arcs;
...
var makeProjection = function makeProjection2(_ref) {
  var _ref$projectionConfig = _ref.projectionConfig,
    projectionConfig =
      _ref$projectionConfig === void 0 ? {} : _ref$projectionConfig,
    _ref$projection = _ref.projection,
    projection2 =
      _ref$projection === void 0 ? "geoEqualEarth" : _ref$projection,
...
function createConnectorPath() {
  ...
  var curve =
    arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0.5;
...
function useGeographies(_ref) {
  ...
  var _useContext = (0, import_react.useContext)(MapContext),
  ...
  var output = (0, import_react.useMemo)(
    function () {
...
var Geographies = function Geographies2(_ref) {
  ...
  var _useContext = (0, import_react.useContext)(MapContext),
    path = _useContext.path,
    projection2 = _useContext.projection;
  var _useGeographies = useGeographies({ geography, parseGeographies }),
  ...
  return import_react.default.createElement(
    ...
    geographies &&
      ...
      children({ geographies, path, projection: projection2 }),
  );
};
...
var Geography = function Geography2(_ref) {
  ...
  var _useState3 = (0, import_react.useState)(false),
...
function useZoomPan(_ref) {
  var _ref$center = _ref.center,
    ...
    zoomSensitivity =
      _ref$zoomSensitivity === void 0 ? 0.025 : _ref$zoomSensitivity,
    ...
    disablePanning =
      _ref$disablePanning === void 0 ? false : _ref$disablePanning,
    _ref$disableZooming = _ref.disableZooming,
    disableZooming =
      _ref$disableZooming === void 0 ? false : _ref$disableZooming;
  var _useContext = (0, import_react.useContext)(MapContext),
  ...
  function handleWheel(event) {
    ...
    setPosition(function (position2) {
      ...
      var zoom2 =
        newZoom < minZoom ? minZoom : newZoom > maxZoom ? maxZoom : newZoom;
      var pointerPosition = getPointFromEvent(event);
      var x =
        ((position2.x - pointerPosition.x) * zoom2) / position2.zoom +
        pointerPosition.x;
      var y =
        ((position2.y - pointerPosition.y) * zoom2) / position2.zoom +
        pointerPosition.y;
  ...
  (0, import_react.useEffect)(
    function () {
      setPosition(function (position2) {
        ...
        var y =
          ((position2.y - height / 2) * zoom) / position2.zoom + height / 2;
    ...
    function () {
      ...
      setPosition(function (position2) {
        return _extends({}, position2, {
          ...
          last: [
            width / 2 - c[0] * position2.zoom,
            height / 2 - c[1] * position2.zoom,
          ],
        });
      });
    },
...
var Sphere = function Sphere2(_ref) {
  ...
  var _useContext = (0, import_react.useContext)(MapContext),
    path = _useContext.path;
  var spherePath = (0, import_react.useMemo)(
    function () {
...
var Marker = function Marker2(_ref) {
  ...
  var _useState3 = (0, import_react.useState)(false),
    ...
    isFocused = _useState4[0],
    setFocus = _useState4[1];
  var _projection = projection2(coordinates),
...
var Annotation = function Annotation2(_ref) {
  ...
  var _useContext = (0, import_react.useContext)(MapContext),
    projection2 = _useContext.projection;
  var _projection = projection2(subject),
    _projection2 = slicedToArray(_projection, 2),
    x = _projection2[0],
    y = _projection2[1];
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "path",
      _extends(
        { d: connectorPath, fill: "transparent", stroke: "#000" },
        connectorProps,
      ),
    ),
    children,
