import { toPropertyKey } from "./chunk-EXOAFPCI.js";
import {
  exactProp,
  init_esm,
  init_exactProp,
...
import { ThemeContext } from "./chunk-QLQ7MDZB.js";
import {
  _extends,
...
function useThemeProps({ props, name, defaultTheme: defaultTheme4, themeId }) {
...
function useMediaQueryNew(
  ...
  const getDefaultSnapshot = React2.useCallback(
    () => defaultMatches,
    [defaultMatches],
  );
...
function useCurrentColorScheme(options) {
  ...
  const setColorScheme = React11.useCallback(
    (value) => {
      if (!value) {
        setState((currentState) => {
          try {
  ...
  const handleMediaQuery = React11.useCallback(
    (event) => {
                ...
                unstable_level:
                  (_unstable_level =
                    (_child$props = child.props) == null
                      ? void 0
                      : _child$props.unstable_level) != null
                    ? _unstable_level
                    : level + 1,
              });
            }
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(
        React15.cloneElement(separator, {
          key: `separator-${index}`,
        }),
      );
    }
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PPYW5GKJ.js.map
