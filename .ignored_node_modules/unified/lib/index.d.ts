...
export class Processor<
  ParseTree extends import('unist').Node | undefined = undefined,
  HeadTree extends import('unist').Node | undefined = undefined,
  TailTree extends import('unist').Node | undefined = undefined,
  CompileTree extends import('unist').Node | undefined = undefined,
...
> {
   ...
   */
  attachers: Array<
    [plugin: Plugin<unknown[], undefined, undefined>, ...parameters: unknown[]]
  >
  /**
   * Compiler to use.
   *
  ...
  use<
    ...
    Input extends string | import('unist').Node | undefined = undefined,
    Output = Input
  >(
 ...
 * ({@linkcode Node }).
 */
export type Parser<Tree extends import('unist').Node = import('unist').Node> = (
  document: string,
  file: VFile
) => Tree
/**
...
export type TransformCallback<
  Output extends import('unist').Node = import('unist').Node
> = (
  error?: Error | undefined,
  tree?: Output | undefined,
  file?: VFile | undefined
) => undefined
/**
...
export type Transformer<
  Input extends import('unist').Node = import('unist').Node,
...
export type UsePlugin<
  ParseTree extends import('unist').Node | undefined,
  HeadTree extends import('unist').Node | undefined,
  TailTree extends import('unist').Node | undefined,
  CompileTree extends import('unist').Node | undefined,
 ...
 */
export type VFileWithOutput<Result extends CompileResults | undefined> =
