...
import {
  gfmFootnote,
  gfmFootnoteHtml
} from 'https://esm.sh/micromark-extension-gfm-footnote@2'
```
...
<script type="module">
  import {
    gfmFootnote,
    gfmFootnoteHtml
  } from 'https://esm.sh/micromark-extension-gfm-footnote@2?bundle'
</script>
```
...
<p>
  Using footnotes is fun!<sup
    ...
    ></sup
  >
  They let you reference relevant information without disrupting the flow of
  what you’re trying to say.<sup
    ><a
      href="#user-content-fn-bignote"
      id="user-content-fnref-bignote"
      data-footnote-ref=""
      aria-describedby="footnote-label"
      >2</a
    ></sup
...
<p>
  Text here and here and here.
  <a
    href="https://docs.github.com/en/github/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax#footnotes"
    >Learn more about markdown and footnotes in markdown</a
  >
</p>
  ...
  <ol>
    ...
    <li id="user-content-fn-bignote">
      ...
      <p>
        Add as many paragraphs as you like.
        <a
          href="#user-content-fnref-bignote"
          data-footnote-backref=""
          class="data-footnote-backref"
          aria-label="Back to content"
          >↩</a
...
See [_§ 4.5.19 The `sub` and `sup` elements_][html-sup],
[_§ 4.5.1 The `a` element_][html-a], and
[_§ 3.2.6.6 Embedding custom non-visible data with the `data-_`
attributes\*][html-data]
in the HTML spec, and
[_§ 6.8 `aria-describedby` property_][aria-describedby]
...
See
[_§ 4.5.1 The `a` element_][html-a],
[_§ 4.3.6 The `h1`, `h2`, `h3`, `h4`, `h5`, and `h6` elements_][html-h],
[_§ 4.4.8 The `li` element_][html-li],
[_§ 4.4.5 The `ol` element_][html-ol],
[_§ 4.4.1 The `p` element_][html-p],
[_§ 4.3.3 The `section` element_][html-section], and
[_§ 4.5.19 The `sub` and `sup` elements_][html-sup]
in the HTML spec, and
[_§ 6.8 `aria-label` property_][aria-label]
in WAI-ARIA, for more info.
...
See [_§ Phase 1: block structure_ in `CommonMark`][commonmark-block] for more
on parsing details.
...
Importantly, while labels _can_ include [string][micromark-content-types]
