...
declare type ElementHook<E, P> = (
  props: P,
) => MutableRefObject<LeafletElement<E>>;
export declare type PropsWithChildren = {
  children?: ReactNode;
};
export declare function createContainerComponent<
  E,
...
>;
export declare function createDivOverlayComponent<
...
>(
  ...
  React.PropsWithoutRef<P> & React.RefAttributes<E>
>;
export declare function createLeafComponent<E, P>(
  useElement: ElementHook<E, P>,
): React.ForwardRefExoticComponent<
  React.PropsWithoutRef<P> & React.RefAttributes<E>
>;
