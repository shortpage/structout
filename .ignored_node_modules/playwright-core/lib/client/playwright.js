...
class Playwright extends import_channelOwner.ChannelOwner {
  constructor(parent, type, guid, initializer) {
    ...
    this._bidiChromium = import_browserType.BrowserType.from(
      initializer.bidiChromium,
    );
    this._bidiChromium._playwright = this;
    this._bidiFirefox = import_browserType.BrowserType.from(
      initializer.bidiFirefox,
    );
    this._bidiFirefox._playwright = this;
    this.devices = this._connection.localUtils()?.devices ?? {};
    this.selectors = new import_selectors.Selectors();
    this.errors = { TimeoutError: import_errors.TimeoutError };
    const selectorsOwner = import_selectors.SelectorsOwner.from(
  ...
  _preLaunchedBrowser() {
    const browser = import_browser.Browser.from(
      this._initializer.preLaunchedBrowser,
    );
