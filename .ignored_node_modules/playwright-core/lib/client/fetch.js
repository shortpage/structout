  ...
  async newContext(options = {}) {
    ...
    const storageState =
      typeof options.storageState === "string"
        ? JSON.parse(
            await this._playwright._platform
              .fs()
              .promises.readFile(options.storageState, "utf8"),
          )
    ...
    const context = APIRequestContext.from(
      (
        await this._playwright._channel.newRequest({
          ...
          import_browserContext.toClientCertificatesProtocol)(
    ...
    context._tracing._tracesDir =
      this._playwright._defaultLaunchOptions?.tracesDir;
...
class APIRequestContext extends import_channelOwner.ChannelOwner {
  ...
  async fetch(urlOrRequest, options = {}) {
    ...
    const request = (0, import_rtti.isString)(urlOrRequest)
      ? void 0
      : urlOrRequest;
  ...
  async _innerFetch(options = {}) {
    return await this._wrapApiCall(async () => {
      ...
      const headers = headersObj
        ? (0, import_headers.headersObjectToArray)(headersObj)
        : void 0;
      let jsonData;
      let formData;
      let multipartData;
      ...
      if (options.data !== void 0) {
        if ((0, import_rtti.isString)(options.data)) {
          if (isJsonContentType(headers))
            jsonData = isJsonParsable(options.data)
              ? options.data
