...
class Locator {
  constructor(frame, selector, options) {
    ...
    if (options?.hasNot) {
      ...
      this._selector +=
        ` >> internal:has-not=` + JSON.stringify(locator._selector);
    }
  ...
  async _withElement(task, timeout) {
    ...
    return await this._frame._wrapApiCall(async () => {
      ...
      const handle = import_elementHandle.ElementHandle.fromNullable(
        result.element,
      );
      if (!handle)
      ...
      try {
        return await task(
          handle,
          deadline ? deadline - (0, import_time.monotonicTime)() : 0,
        );
      } finally {
  ...
  _equals(locator) {
    return (
      this._frame === locator._frame && this._selector === locator._selector
    );
  }
  page() {
  ...
  getByAltText(text, options) {
    return this.locator(
      (0, import_locatorUtils.getByAltTextSelector)(text, options),
    );
  }
  getByLabel(text, options) {
    return this.locator(
      (0, import_locatorUtils.getByLabelSelector)(text, options),
    );
  }
  getByPlaceholder(text, options) {
    return this.locator(
      (0, import_locatorUtils.getByPlaceholderSelector)(text, options),
    );
  }
  getByText(text, options) {
    return this.locator(
      (0, import_locatorUtils.getByTextSelector)(text, options),
    );
  }
  getByTitle(text, options) {
    return this.locator(
      (0, import_locatorUtils.getByTitleSelector)(text, options),
    );
  }
  getByRole(role, options = {}) {
    return this.locator(
      (0, import_locatorUtils.getByRoleSelector)(role, options),
    );
  }
  ...
  async screenshot(options = {}) {
    ...
    return await this._withElement(
      (h, timeout) => h.screenshot({ ...options, mask, timeout }),
      options.timeout,
    );
  }
  ...
  async _expect(expression, options) {
    ...
    params.expectedValue = (0, import_jsHandle.serializeArgument)(
  ...
  toString() {
    return (0, import_locatorGenerators.asLocator)(
      "javascript",
      this._selector,
    );
  }
