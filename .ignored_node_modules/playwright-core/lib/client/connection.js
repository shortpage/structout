...
class Connection extends import_eventEmitter.EventEmitter {
  constructor(platform, localUtils, instrumentation, headers = []) {
    ...
    this._instrumentation =
      instrumentation ||
      (0, import_clientInstrumentation.createInstrumentation)();
  ...
  async sendMessageToServer(object, method, params, apiName, frames, stepId) {
    ...
    const location = frames[0]
      ? { file: frames[0].file, line: frames[0].line, column: frames[0].column }
      : void 0;
    const metadata = { apiName, location, internal: !apiName, stepId };
    if (this._tracingCount && frames && type !== "LocalUtils")
      this._localUtils
        ?.addStackToTracingNoReply({ callData: { stack: frames, id } })
        .catch(() => {});
    this._platform.zones.empty.run(() =>
      this.onmessage({ ...message, metadata }),
    );
    return await new Promise((resolve, reject) =>
      this._callbacks.set(id, { resolve, reject, apiName, type, method }),
    );
  }
  ...
  dispatch(message) {
    ...
    if (id) {
      ...
      if (error && !result) {
        ...
        callback.resolve(
          validator2(result, "", this._validatorFromWireContext()),
        );
      }
      return;
    }
    ...
    object._channel.emit(
      method,
      validator(params, "", this._validatorFromWireContext()),
    );
  }
  close(cause) {
    if (this._closedError) return;
  ...
  _createRemoteObject(parentGuid, type, guid, initializer) {
    ...
    switch (type) {
      case "Android":
        ...
        break;
      case "AndroidSocket":
        result = new import_android.AndroidSocket(
          parent,
          type,
          guid,
          initializer,
        ...
        break;
      case "AndroidDevice":
        result = new import_android.AndroidDevice(
          parent,
          type,
          guid,
          initializer,
      ...
      case "APIRequestContext":
        result = new import_fetch.APIRequestContext(
          parent,
          type,
          guid,
          initializer,
      ...
      case "Browser":
        ...
        break;
      case "BrowserContext":
        result = new import_browserContext.BrowserContext(
          parent,
          type,
          guid,
          initializer,
        ...
        break;
      case "BrowserType":
        result = new import_browserType.BrowserType(
          parent,
          type,
          guid,
          initializer,
        ...
        break;
      case "CDPSession":
        result = new import_cdpSession.CDPSession(
          parent,
          type,
          guid,
          initializer,
      ...
      case "ElectronApplication":
        result = new import_electron.ElectronApplication(
          parent,
          type,
          guid,
          initializer,
        ...
        break;
      case "ElementHandle":
        result = new import_elementHandle.ElementHandle(
          parent,
          type,
          guid,
          initializer,
      ...
      case "JsonPipe":
        ...
        break;
      case "LocalUtils":
        result = new import_localUtils.LocalUtils(
          parent,
          type,
          guid,
          initializer,
      ...
      case "Page":
        ...
        break;
      case "Playwright":
        result = new import_playwright.Playwright(
          parent,
          type,
          guid,
          initializer,
      ...
      case "Stream":
        ...
        break;
      case "Selectors":
        result = new import_selectors.SelectorsOwner(
          parent,
          type,
          guid,
          initializer,
      ...
      case "WebSocket":
        ...
        break;
      case "WebSocketRoute":
        result = new import_network.WebSocketRoute(
          parent,
          type,
          guid,
          initializer,
      ...
      case "Worker":
        ...
        break;
      case "WritableStream":
        result = new import_writableStream.WritableStream(
          parent,
          type,
          guid,
          initializer,
