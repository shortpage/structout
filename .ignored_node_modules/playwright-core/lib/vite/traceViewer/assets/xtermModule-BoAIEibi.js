                  ...
                  var c =
                      ...
                      function (i, o, l, v) {
                        ...
                        if (
                          ...
                          p = Reflect.decorate(i, o, l, v);
                        else
                          for (var b = i.length - 1; b >= 0; b--)
                            (m = i[b]) &&
                              (p =
                                (h < 3 ? m(p) : h > 3 ? m(o, l, p) : m(o, l)) ||
                                p);
...
` &&
                    ...
                    _renderRows(i, o) {
                      ...
                      for (let m = i; m <= o; m++) {
                        const h = l.translateBufferLineToString(
                          ...
                          p = (l.ydisp + m + 1).toString(),
                          b = this._rowElements[m];
                        b &&
                          (h.length === 0
                            ? (b.innerText = " ")
                            : (b.textContent = h),
                          b.setAttribute("aria-posinset", p),
                    ...
                    _handleBoundaryFocus(i, o) {
                      ...
                      if (
                        ...
                        const p = this._createAccessibilityTreeNode();
                        this._rowElements.push(p),
                          this._rowContainer.appendChild(p);
                      }
                      this._rowElements[0].addEventListener(
                        "focus",
                        this._topBoundaryFocusListener,
                ...
                3614: (I, r) => {
                  ...
                  Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.handlePasteEvent = function (d, f, g, u) {
                      d.stopPropagation(),
                        d.clipboardData &&
                          _(d.clipboardData.getData("text/plain"), f, g, u);
                    }),
                    (r.paste = _),
                    (r.moveTextAreaUnderMouseCursor = n),
                    (r.rightClickHandler = function (d, f, g, u, e) {
                      n(d, f, g),
                        ...
                        s
                          ...
                          : v.provideLinks(e.y, (m) => {
                              ...
                              (h = this._activeProviderReplies) === null ||
                                ...
                                h.set(l, b),
                                (o = this._checkLinkProviderResult(l, e, o)),
                                ((p = this._activeProviderReplies) === null ||
                                p === void 0
                                  ? void 0
                                  : p.size) === this._linkProviders.length &&
                            ...
                            if (L) {
                              ...
                              k ||
                                i.push({
                                  ...
                                  range: y,
                                  activate: (x, T) =>
                                    o ? o.activate(x, T, y) : g(0, T),
                                  hover: (x, T) => {
                                    var O;
                                    return (O =
                                      o == null ? void 0 : o.hover) === null ||
                                      O === void 0
                                      ? void 0
                                      : O.call(o, x, T, y);
                                  },
...
WARNING: This link could potentially be dangerous`)
                      ...
                      super(),
                        ...
                        this.register(
                          this._bufferService.buffers.onBufferActivate(
                            (p) => (this._activeBuffer = p.activeBuffer),
                          ),
                        ),
                        ...
                        this.register(
                          this._renderService.onDimensionsChange(
                            (p) => (this._renderDimensions = p),
                          ),
                        ),
                        this._handleThemeChange(h.colors),
                        this.register(
                          h.onChangeColors((p) => this._handleThemeChange(p)),
                        ),
                        this.register(
                ...
                3107: function (I, r, a) {
                    ...
                    _createElement(e) {
                      ...
                      i.classList.add("xterm-decoration"),
                        i.classList.toggle(
                          ...
                          ((s = e == null ? void 0 : e.options) === null ||
                          s === void 0
                            ? void 0
                            : s.layer) === "top",
                        ),
                  ...
                  r.BufferDecorationRenderer = u = c(
                    [
                      _(1, g.IBufferService),
                      _(2, g.IDecorationService),
                ...
                9806: (I, r) => {
                  ...
                  Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.getCoords = function (c, _, n, d, f, g, u, e, s) {
                      if (!g) return;
                      const t = a(c, _, n);
                      return t
                ...
                9504: (I, r, a) => {
                      ...
                      v =
                        ...
                        (function (m, h, p) {
                          ...
                          for (let k = 0; k < Math.abs(L - y); k++) {
                            const x = d(m, h) === "A" ? -1 : 1,
                              T = p.buffer.lines.get(L + x * k);
                            T != null && T.isWrapped && b++;
                          }
                          return b;
                        })(e, s, t);
                  ...
                  r.moveToCellSequence = function (e, s, t, i) {
                    ...
                    if (!t.buffer.hasScrollback)
                      return (
                        (function (h, p, b, L, y, k) {
                          return _(p, L, y, k).length === 0
                            ? ""
                            : u(
                                f(h, p, h, p - n(p, y), !1, y).length,
                                g("D", k),
                              );
                        })(o, l, 0, s, t, i) +
                        _(l, s, t, i) +
                        (function (h, p, b, L, y, k) {
                          let x;
                          x = _(p, L, y, k).length > 0 ? L - n(L, y) : p;
                          const T = L,
                          ...
                          return u(f(h, x, b, T, O === "C", y).length, g(O, k));
                        })(o, l, e, s, t, i)
                      );
                    let v;
                    if (l === s)
                      return (
                        (v = o > e ? "D" : "C"), u(Math.abs(o - e), g(v, i))
                      );
                    v = l > s ? "D" : "C";
                    ...
                    L = (r.DomRenderer = class extends t.Disposable {
                      constructor(y, k, x, T, O, M, C, w, E, D) {
                        super(),
                          ...
                          (this._selectionContainer =
                            document.createElement("div")),
                          this._selectionContainer.classList.add(p),
                      ...
                      _injectCss(y) {
                        ...
                        (k += `${this._terminalSelector} .${l} .xterm-dim { color: ${e.color.multiplyOpacity(y.foreground, 0.5).css};}`),
                          ...
                          (k += `${this._terminalSelector} .${p} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${p} div { position: absolute; background-color: ${y.selectionBackgroundOpaque.css};}${this._terminalSelector} .${p} div { position: absolute; background-color: ${y.selectionInactiveBackgroundOpaque.css};}`);
                ...
                3787: function (I, r, a) {
                        ...
                        var b,
                          ...
                          y =
                            L < 3
                              ? m
                              : p === null
                                ? (p = Object.getOwnPropertyDescriptor(m, h))
                                : p;
                        if (
                          typeof Reflect == "object" &&
                          typeof Reflect.decorate == "function"
                        )
                          y = Reflect.decorate(v, m, h, p);
                        else
                  ...
                  let o = (r.DomRendererRowFactory = class {
                    ...
                    createRow(v, m, h, p, b, L, y, k, x, T, O) {
                      const M = [],
                    ...
                    _applyMinimumContrast(v, m, h, p, b, L) {
                      if (
                        this._optionsService.rawOptions.minimumContrastRatio ===
                          1 ||
                        (0, t.excludeFromContrastRatioDemands)(p.getCode())
                      )
                        return !1;
                  ...
                  Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.WidthCache = class {
                      ...
                      _measure(a, c) {
                        ...
                        return (
                          (_.textContent = a.repeat(32)), _.offsetWidth / 32
                        );
                      }
                    });
                },
                    ...
                    _stringRangesToCellRanges(t, i, o) {
                      ...
                      if (h) {
                        for (let p = o; p < this._bufferService.cols; p++) {
                          const b = i.getWidth(p),
                            L =
                              i.getString(p).length ||
                              d.WHITESPACE_CELL_CHAR.length;
                          if (b !== 0) {
                            if (
                              (!v && h[0] <= m && ((h[0] = p), (v = !0)),
                ...
                3230: function (I, r, a) {
                  ...
                  r.RenderService = i = c(
                    [
                      ...
                      _(3, g.ICharSizeService),
                      _(4, t.IDecorationService),
                      _(5, t.IBufferService),
                      _(6, g.ICoreBrowserService),
                      _(7, g.IThemeService),
                    ],
                    i,
                  );
                        ...
                        var y,
                          ...
                          x =
                            k < 3
                              ? p
                              : L === null
                                ? (L = Object.getOwnPropertyDescriptor(p, b))
                                : L;
                        if (
                          typeof Reflect == "object" &&
                          typeof Reflect.decorate == "function"
                        )
                          x = Reflect.decorate(h, p, b, L);
                        else
                          for (var T = h.length - 1; T >= 0; T--)
                            (y = h[T]) &&
                              (x =
                                (k < 3 ? y(x) : k > 3 ? y(p, b, x) : y(p, b)) ||
                                x);
                        return k > 3 && x && Object.defineProperty(p, b, x), x;
                      },
                    _ =
                      (this && this.__param) ||
                      function (h, p) {
                  ...
                  let m = (r.SelectionService = class extends e.Disposable {
                    ...
                    get selectionText() {
                      ...
                      if (this._activeSelectionMode === 3) {
                        if (h[0] === p[0]) return "";
                        const y = h[0] < p[0] ? h[0] : p[0],
                          k = h[0] < p[0] ? p[0] : h[0];
                        for (let x = h[1]; x <= p[1]; x++) {
...
`,
                    ...
                    _isClickInSelection(h) {
                      ...
                      return (
                        !!(b && L && p) && this._areCoordsInSelection(p, b, L)
                      );
                    }
                    isCellInSelection(h, p) {
                      const b = this._model.finalSelectionStart,
                        L = this._model.finalSelectionEnd;
                      return (
                        !(!b || !L) && this._areCoordsInSelection([h, p], b, L)
                      );
                    }
                    _areCoordsInSelection(h, p, b) {
                      return (
                        ...
                        (p[1] === b[1] &&
                          ...
                          h[0] >= p[0] &&
                          h[0] < b[0]) ||
                        (p[1] < b[1] && h[1] === b[1] && h[0] < b[0]) ||
                        (p[1] < b[1] && h[1] === p[1] && h[0] >= p[0])
                      );
                    }
                    ...
                    _getMouseBufferCoords(h) {
                      const p = this._mouseService.getCoords(
                        h,
                        this._screenElement,
                        this._bufferService.cols,
                        this._bufferService.rows,
                    ...
                    _getMouseEventScrollAmount(h) {
                      let p = (0, n.getCoordsRelativeToElement)(
                      ...
                      return p >= 0 && p <= b
                        ? 0
                        : (p > b && (p -= b),
                          (p = Math.min(Math.max(p, -50), 50)),
                          (p /= 50),
                          p / Math.abs(p) + Math.round(14 * p));
                    }
                    ...
                    _handleSingleClick(h) {
                      if (
                        ...
                        return;
                      this._model.selectionEnd = void 0;
                      const p = this._bufferService.buffer.lines.get(
                        this._model.selectionStart[1],
                      );
                      p &&
                        p.length !== this._model.selectionStart[0] &&
                        p.hasWidth(this._model.selectionStart[0]) === 0 &&
                    ...
                    _handleMouseMove(h) {
                      if (
                        ...
                        return;
                      const p = this._model.selectionEnd
                        ? [
                      ...
                      (p &&
                        p[0] === this._model.selectionEnd[0] &&
                        p[1] === this._model.selectionEnd[1]) ||
                        this.refresh(!0);
                    }
                    _dragScroll() {
                      if (
                      ...
                      b
                        ? h &&
                          ...
                          ((this._oldSelectionStart &&
                            ...
                            p[0] === this._oldSelectionEnd[0] &&
                            p[1] === this._oldSelectionEnd[1]) ||
                            this._fireOnSelectionChange(h, p, b))
                        : this._oldHasSelection &&
                          this._fireOnSelectionChange(h, p, b);
                    }
                    _fireOnSelectionChange(h, p, b) {
                      (this._oldSelectionStart = h),
                        (this._oldSelectionEnd = p),
                    ...
                    _handleBufferActivate(h) {
                      this.clearSelection(),
                        ...
                        (this._trimListener = h.activeBuffer.lines.onTrim((p) =>
                          this._handleTrim(p),
                        ));
                    }
                    ...
                    setSelection(h, p, b) {
                      this._model.clearSelection(),
                        this._removeMouseDownListeners(),
                        (this._model.selectionStart = [h, p]),
                    ...
                    _selectToWordAt(h) {
                      ...
                      if (p) {
                        let b = h[1];
                        for (; p.start < 0; )
                          (p.start += this._bufferService.cols), b--;
                        if (!this._model.areSelectionValuesReversed())
                          for (
                            ;
                            p.start + p.length > this._bufferService.cols;

                          )
                            (p.length -= this._bufferService.cols), b++;
                        this._model.selectionEnd = [
                    ...
                    _selectLineAt(h) {
                      const p =
                        ...
                        b = {
                          start: { x: 0, y: p.first },
                          end: { x: this._bufferService.cols - 1, y: p.last },
                        };
                      (this._model.selectionStart = [0, p.first]),
                        (this._model.selectionEnd = void 0),
                        (this._model.selectionStartLength = (0,
                        ...
                        var L,
                          ...
                          k =
                            y < 3
                              ? h
                              : b === null
                                ? (b = Object.getOwnPropertyDescriptor(h, p))
                                : b;
                        if (
                          typeof Reflect == "object" &&
                          typeof Reflect.decorate == "function"
                        )
                          k = Reflect.decorate(m, h, p, b);
                        else
                          for (var x = m.length - 1; x >= 0; x--)
                            (L = m[x]) &&
                              (k =
                                (y < 3 ? L(k) : y > 3 ? L(h, p, k) : L(h, p)) ||
                                k);
                ...
                6349: (I, r, a) => {
                  ...
                  class n extends _.Disposable {
                    ...
                    splice(f, g, ...u) {
                      if (g) {
                        for (let e = f; e < this._length - g; e++)
                          this._array[this._getCyclicIndex(e)] =
                            this._array[this._getCyclicIndex(e + g)];
                        (this._length -= g),
                          this.onDeleteEmitter.fire({ index: f, amount: g });
                      }
                    ...
                    (function (l) {
                      ...
                      (l.blend = function (m, h) {
                        ...
                        const p = (h.rgba >> 24) & 255,
                          ...
                          x = (m.rgba >> 8) & 255;
                        return (
                          (_ = y + Math.round((p - y) * f)),
                          (n = k + Math.round((b - k) * f)),
                          (d = x + Math.round((L - x) * f)),
                          { css: g.toCss(_, n, d), rgba: g.toRgba(_, n, d) }
                        );
                      }),
                      ...
                      l.toColor = function (h) {
                        ...
                        if (p)
                          return (
                            ...
                            (d = parseInt(p[3])),
                            (f = Math.round(
                              255 * (p[5] === void 0 ? 1 : parseFloat(p[5])),
                            )),
                            t.toColor(_, n, d, f)
                          );
                        if (!v || !m)
                ...
                5435: function (I, r, a) {
                  ...
                  class x extends g.Disposable {
                    ...
                    constructor(
                      ...
                      this._parser.registerEscHandler(
                        ...
                        this._parser.setErrorHandler(
                          (S) => (
                            this._logService.error("Parsing error: ", S), S
                          ),
                        ),
                    ...
                    setTitle(C) {
                      return (
                        (this._windowTitle = C), this._onTitleChange.fire(C), !0
                      );
                    }
                    setIconName(C) {
                      ...
                      for (; this._i < this._tasks.length; ) {
                        if (
                          ...
                          return (
                            e - g < -20 &&
                              console.warn(
                                `task queue exceeded allotted deadline by ${Math.abs(Math.round(e - g))}ms`,
                              ),
                            void this._start()
                          );
                        e = s;
                    ...
                    (r.Buffer = class {
                      ...
                      _reflowSmaller(t, i) {
                        ...
                        for (let m = this.lines.length - 1; m >= 0; m--) {
                          ...
                          const p = [h];
                          for (; h.isWrapped && m > 0; )
                            (h = this.lines.get(--m)), p.unshift(h);
                          const b = this.ybase + this.y;
                          if (b >= m && b < m + p.length) continue;
                          const L = p[p.length - 1].getTrimmedLength(),
                          ...
                          T.length > 0 &&
                            (l.push({ start: m + p.length + v, newLines: T }),
                            (v += T.length)),
                            p.push(...T);
                          let O = y.length - 1,
                            M = y[O];
                          ...
                          for (; C >= 0; ) {
                            ...
                            if (p[O] === void 0) break;
                            if (
                              (p[O].copyCellsFrom(p[C], w - D, M - D, D, !0),
                              (M -= D),
                              M === 0 && (O--, (M = y[O])),
                              (w -= D),
                              w === 0)
                      ...
                      if (
                        ((e %= this.length) &&
                          ...
                          this.setCellFromCodePoint(
                            ...
                            0,
                            1,
                            (i == null ? void 0 : i.fg) || 0,
                            (i == null ? void 0 : i.bg) || 0,
                            (i == null ? void 0 : i.extended) ||
                              new c.ExtendedAttrs(),
                          ),
                        s < this.length - e)
                      ) {
                  ...
                  Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.reflowLargerGetLinesToRemove = function (c, _, n, d, f) {
                      ...
                      for (let u = 0; u < c.length - 1; u++) {
                        ...
                        for (
                          ...
                          m++;
                        m > 0 && (g.push(u + t.length - m), g.push(m)),
                          (u += t.length - 1);
                      }
                      return g;
                    }),
                    (r.reflowLargerCreateNewLayout = function (c, _) {
                      ...
                      for (let u = 0; u < c.length; u++)
                        if (f === u) {
                          const e = _[++d];
                          c.onDeleteEmitter.fire({ index: u - g, amount: e }),
                            (u += e - 1),
                            (g += e),
                            (f = _[++d]);
                        } else n.push(u);
                ...
                5295: (I, r, a) => {
                  ...
                  class d extends _.Disposable {
                    ...
                    resize(g, u) {
                      this._normal.resize(g, u),
                        this._alt.resize(g, u),
...
`),
                      ...
                      default:
                        if (!n.ctrlKey || n.shiftKey || n.altKey || n.metaKey)
                          if ((f && !g) || !n.altKey || n.metaKey)
                            ...
                            const s = _[n.keyCode],
                              t = s == null ? void 0 : s[n.shiftKey ? 1 : 0];
                      ...
                      decode(a, c) {
                        ...
                        for (; i < _; ) {
                          ...
                          if (((n = a[i++]), n < 128)) c[u++] = n;
                            ...
                            if (i >= _)
                              return (
                                (this.interim[0] = n), (this.interim[1] = d), u
                              );
                            if (((f = a[i++]), (192 & f) != 128)) {
                              i--;
                              continue;
                  ...
                  (r.parseColor = function (n) {
                    ...
                    if (d.indexOf("rgb:") === 0) {
                      ...
                      if (f) {
                        ...
                        return [
                          Math.round(
                            (parseInt(f[1] || f[4] || f[7] || f[10], 16) / g) *
                              255,
                          ),
                          Math.round(
                            (parseInt(f[2] || f[5] || f[8] || f[11], 16) / g) *
                              255,
                          ),
                          Math.round(
                            (parseInt(f[3] || f[6] || f[9] || f[12], 16) / g) *
                              255,
                          ),
                        ];
                      }
                ...
                6351: (I, r, a) => {
                    ...
                    put(g, u, e) {
                      if (this._active.length)
                        for (let s = this._active.length - 1; s >= 0; s--)
                          this._active[s].put(g, u, e);
                      else
                        this._handlerFb(
                          this._ident,
                          "PUT",
                          (0, c.utf32ToString)(g, u, e),
                        );
                    }
                    unhook(g, u = !0) {
                      if (this._active.length) {
                  ...
                  f.addParam(0),
                    (r.DcsHandler = class {
                      ...
                      hook(g) {
                        (this._params =
                          g.length > 1 || g.params[0] ? g.clone() : f),
                          (this._data = ""),
                          (this._hitLimit = !1);
                      }
                      put(g, u, e) {
                        this._hitLimit ||
                          ((this._data += (0, c.utf32ToString)(g, u, e)),
                            ...
                            case 3:
                              if (i === !1 && p > -1) {
                                for (
                                  ;
                                  p >= 0 &&
                                  ((o = h[p](this._params)), o !== !0);
                                  p--
                                )
                                  if (o instanceof Promise)
                                    return (this._parseStack.handlerPos = p), o;
                              }
                              this._parseStack.handlers = [];
                              break;
                            case 4:
                      ...
                      for (let h = m; h < t; ++h) {
                        switch (
                          ...
                          case 7:
                            ...
                            for (
                              ;
                              b >= 0 && ((o = p[b](this._params)), o !== !0);
                              b--
                            )
                              if (o instanceof Promise)
                                return this._preserveStack(3, p, b, v, h), o;
                            b < 0 &&
                              this._csiHandlerFb(
                                (this._collect << 8) | l,
                                this._params,
                ...
                6242: (I, r, a) => {
                  ...
                  (r.OscParser = class {
                    ...
                    _put(d, f, g) {
                      if (this._active.length)
                        for (let u = this._active.length - 1; u >= 0; u--)
                          this._active[u].put(d, f, g);
                      else
                        this._handlerFb(
                          this._id,
                          "PUT",
                          (0, _.utf32ToString)(d, f, g),
                        );
                    }
                    start() {
                    ...
                    (r.OscHandler = class {
                      ...
                      put(d, f, g) {
                        this._hitLimit ||
                          ((this._data += (0, _.utf32ToString)(d, f, g)),
                  ...
                  class c {
                    ...
                    toArray() {
                      ...
                      for (let d = 0; d < this.length; ++d) {
                        ...
                        g - f > 0 &&
                          n.push(
                            Array.prototype.slice.call(this._subParams, f, g),
                          );
                      }
                      return n;
                    }
                ...
                9074: (I, r, a) => {
                  ...
                  class u extends n.Disposable {
                    ...
                    constructor() {
                      super(),
                        (this._decorations = new d.SortedList((t) =>
                          t == null ? void 0 : t.marker.line,
                        )),
                      ...
                      this._decorations.forEachByKey(i, (v) => {
                        ...
                        (f =
                          ...
                          t >= f &&
                            t < g &&
                            (!o ||
                              ((p = v.options.layer) !== null && p !== void 0
                                ? p
                                : "bottom") === o) &&
                            l(v);
                      });
                ...
                2660: function (I, r, a) {
                        ...
                        var s,
                          ...
                          i =
                            t < 3
                              ? g
                              : e === null
                                ? (e = Object.getOwnPropertyDescriptor(g, u))
                                : e;
                        if (
                          typeof Reflect == "object" &&
                          typeof Reflect.decorate == "function"
                        )
                          i = Reflect.decorate(f, g, u, e);
                        else
                          for (var o = f.length - 1; o >= 0; o--)
                            (s = f[o]) &&
                              (i =
                                (t < 3 ? s(i) : t > 3 ? s(g, u, i) : s(g, u)) ||
                                i);
                  ...
                  let d = (r.OscLinkService = class {
                    ...
                    registerLink(f) {
                      ...
                      if (s)
                        return this.addLineToLink(s.id, g.ybase + g.y), s.id;
                    ...
                    getLinkData(f) {
                      var g;
                      return (g = this._dataByLinkId.get(f)) === null ||
                        g === void 0
                        ? void 0
                        : g.data;
                    }
                ...
                8343: (I, r) => {
                  ...
                  (r.serviceRegistry = new Map()),
                    ...
                    (r.createDecorator = function (_) {
                      ...
                      return (
                        (n.toString = () => _), r.serviceRegistry.set(_, n), n
                      );
                    });
                },
                2585: (I, r, a) => {
            ...
            return (
              (() => {
                ...
                class u extends c.Disposable {
                  ...
                  get unicode() {
                    return (
                      this._checkProposedApi(), new f.UnicodeApi(this._core)
                    );
                  }
                  get textarea() {
                  ...
                  registerMarker(s = 0) {
                    return (
                      this._verifyIntegers(s), this._core.registerMarker(s)
                    );
                  }
                  registerDecoration(s) {
                    var t, i, o;
...
var Ee = we();
const ke = { Terminal: ye.Terminal, FitAddon: Ee.FitAddon };
