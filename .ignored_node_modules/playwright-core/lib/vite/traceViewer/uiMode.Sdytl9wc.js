      ...
      K.useEffect(() => {
        setTimeout(() => {
          a.current &&
            ...
            r.resize(a.current.terminal.cols, a.current.terminal.rows));
        }, 250);
      }, [t, r]),
      o.jsx("div", {
        "data-testid": "output",
        ...
        b.children.forEach(E),
          !f &&
            ...
            ((b.kind === "test" && c.testIds.has(b.test.id)) ||
              (b.kind === "case" &&
                c.testIds.has((M = b.tests[0]) == null ? void 0 : M.id))) &&
            (f = b);
      };
...
`,
      ...
      u.useEffect(() => {
        ...
        for (const P of y.keys())
          m.suites.find((W) => W.title === P) || y.delete(P);
        ...
        !k &&
          ...
          (l.size !== y.size || [...l].some(([P, W]) => y.get(P) !== W)) &&
            _(y);
      }, [l, n]),
      u.useEffect(() => {
        ...
        (p, m) => {
          !w ||
            ...
            (E.current = E.current.then(async () => {
              ...
              {
                for (const j of ((P = n.rootSuite) == null
                  ? void 0
                  : P.allTests()) || [])
                  if (k.has(j.id)) {
                    j.results = [];
              ...
              for (const j of ((W = n.rootSuite) == null
                ? void 0
                : W.allTests()) || [])
