...
const kNestedSelectorNames = new import_builtins.Set([
  "internal:has",
  "internal:has-not",
  "internal:and",
  "internal:or",
...
const kNestedSelectorNamesWithDistance = new import_builtins.Set([
  "left-of",
  "right-of",
  "above",
  "below",
...
const customCSSNames = new import_builtins.Set([
  "not",
  "is",
  "where",
  "has",
...
function parseSelector(selector) {
  ...
  for (const part of parsedStrings.parts) {
    if (part.name === "css" || part.name === "css:light") {
      ...
      const parsedCSS = (0, import_cssParser.parseCSS)(
        part.body,
        customCSSNames,
      );
      parts.push({
    ...
    if (kNestedSelectorNames.has(part.name)) {
      ...
      const lastFrame = [...nested.body.parsed.parts]
        ...
        .find(
          (part2) =>
            part2.name === "internal:control" && part2.body === "enter-frame",
        );
