...
class HttpServer {
  constructor() {
    ...
    this._started = false;
    this._routes = [];
    this._server = (0, import_network.createHttpServer)(
  ...
  createWebSocket(transport, guid) {
    ...
    const wss = new import_utilsBundle.wsServer({
      server: this._server,
      path: "/" + this._wsGuid,
    });
  ...
  _serveRangeFile(request, response, absoluteFilePath) {
    ...
    const readable = import_fs.default.createReadStream(absoluteFilePath, {
      start,
      end,
    });
