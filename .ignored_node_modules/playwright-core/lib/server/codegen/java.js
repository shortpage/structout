...
function formatContextOptions(contextOptions, deviceName) {
  ...
  const device = deviceName
    ? import_deviceDescriptors.deviceDescriptors[deviceName]
    : {};
  ...
  if (options.serviceWorkers)
    lines.push(
      `  .setServiceWorkers(ServiceWorkerPolicy.${options.serviceWorkers.toUpperCase()})`,
    );
