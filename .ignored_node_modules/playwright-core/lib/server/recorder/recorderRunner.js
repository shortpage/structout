...
async function performAction(pageAliases, actionInContext) {
  ...
  const mainFrame = (0, import_recorderUtils.mainFrameForAction)(
    pageAliases,
    actionInContext,
  );
  ...
  if (action.name === "assertText") {
    await mainFrame.expect(callMetadata, selector, {
      ...
      expectedText: (0, import_utils.serializeExpectedTextValues)(
        [action.text],
        { matchSubstring: true, normalizeWhiteSpace: true },
      ),
      isNot: false,
      timeout: kActionTimeout,
    });
