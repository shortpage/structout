...
class VideoRecorder {
  constructor(page, ffmpegPath, progress) {
    ...
    page.on(import_page.Page.Events.ScreencastFrame, (frame) =>
      this.writeFrame(frame.buffer, frame.frameSwapWallTime / 1e3),
    );
  }
  ...
  async stop() {
    ...
    this.writeFrame(
      ...
      this._lastFrameTimestamp +
        ((0, import_utils.monotonicTime)() - this._lastWriteTimestamp) / 1e3,
    );
