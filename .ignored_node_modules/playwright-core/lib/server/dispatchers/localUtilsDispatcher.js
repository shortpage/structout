...
class LocalUtilsDispatcher extends import_dispatcher.Dispatcher {
  constructor(scope, playwright) {
    ...
    const deviceDescriptors = Object.entries(
      import_deviceDescriptors.deviceDescriptors,
  ...
  async addStackToTracingNoReply(params, metadata) {
    return await localUtils.addStackToTracingNoReply(
      this._stackSessions,
      params,
    );
  }
  async connect(params, metadata) {
    ...
    return await controller.run(async (progress) => {
      ...
      const transport = await import_transport.WebSocketTransport.connect(
        progress,
        wsEndpoint,
        {
          headers: wsHeaders,
