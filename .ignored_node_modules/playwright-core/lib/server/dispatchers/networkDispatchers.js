...
class RequestDispatcher extends import_dispatcher.Dispatcher {
  ...
  constructor(scope, request) {
    ...
    const frameDispatcher = frame
      ? import_frameDispatcher.FrameDispatcher.from(scope, frame)
      : null;
    super(pageDispatcher || frameDispatcher || scope, request, "Request", {
      frame: import_frameDispatcher.FrameDispatcher.fromNullable(
        scope,
        request.frame(),
      ),
...
class WebSocketDispatcher extends import_dispatcher.Dispatcher {
  constructor(scope, webSocket) {
    ...
    this.addObjectListener(
      import_network.WebSocket.Events.FrameReceived,
      (event) => this._dispatchEvent("frameReceived", event),
    );
    this.addObjectListener(
      import_network.WebSocket.Events.SocketError,
      (error) => this._dispatchEvent("socketError", { error }),
    );
