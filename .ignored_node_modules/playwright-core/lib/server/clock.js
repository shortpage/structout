...
class Clock {
  ...
  async fastForward(ticks) {
    ...
    await this._evaluateInFrames(
      `globalThis.__pwClock.controller.fastForward(${ticksMillis})`,
    );
  }
  async install(time) {
    await this._installIfNeeded();
    ...
    await this._evaluateInFrames(
      `globalThis.__pwClock.controller.install(${timeMillis})`,
    );
  }
  async pauseAt(ticks) {
    await this._installIfNeeded();
    ...
    await this._evaluateInFrames(
      `globalThis.__pwClock.controller.pauseAt(${timeMillis})`,
    );
  }
  async resume() {
    await this._installIfNeeded();
  ...
  async setFixedTime(time) {
    ...
    await this._evaluateInFrames(
      `globalThis.__pwClock.controller.setFixedTime(${timeMillis})`,
    );
  }
  async setSystemTime(time) {
    ...
    await this._evaluateInFrames(
      `globalThis.__pwClock.controller.setSystemTime(${timeMillis})`,
    );
  }
  async runFor(ticks) {
    await this._installIfNeeded();
    ...
    await this._evaluateInFrames(
      `globalThis.__pwClock.controller.runFor(${ticksMillis})`,
    );
  }
  ...
  async _evaluateInFrames(script) {
    await this._browserContext.safeNonStallingEvaluateInAllFrames(
      script,
      "main",
