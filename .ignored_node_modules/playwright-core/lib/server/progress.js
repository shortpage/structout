  ...
  async run(task, timeout) {
    if (timeout) {
      ...
      this._deadline = timeout
        ? (0, import_utils.monotonicTime)() + timeout
        : 0;
    }
    ...
    const progress = {
      ...
      timeUntilDeadline: () =>
        this._deadline
          ? this._deadline - (0, import_utils.monotonicTime)()
          : 2147483647,
    ...
    const timeoutError = new import_errors.TimeoutError(
    ...
    try {
      ...
      this.sdkObject.attribution.context?._activeProgressControllers.delete(
        this,
      );
      clearTimeout(timer);
    }
