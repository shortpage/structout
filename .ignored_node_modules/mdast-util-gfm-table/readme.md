...
import {
  ...
  gfmTableToMarkdown
} from 'https://esm.sh/mdast-util-gfm-table@2'
```
...
<script type="module">
  import {
    gfmTableFromMarkdown,
    gfmTableToMarkdown
  } from 'https://esm.sh/mdast-util-gfm-table@2?bundle'
</script>
```
...
The _[head][term-head]_ of the node represents the labels of the columns.
...
If the node is a _[head][term-head]_, it represents the labels of the columns
...
**[Table][dfn-table]**, if its parent is a _[head][term-head]_, or a data
cell otherwise.
