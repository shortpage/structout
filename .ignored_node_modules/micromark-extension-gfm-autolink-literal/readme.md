...
} from 'https://esm.sh/micromark-extension-gfm-autolink-literal@2'
```
...
<script type="module">
  import {
    gfmAutolinkLiteral,
    gfmAutolinkLiteralHtml
  } from 'https://esm.sh/micromark-extension-gfm-autolink-literal@2?bundle'
</script>
```
...
```html
<p>
  <a href="https://example.com/alpha%20bravo"
    >https://example.com/alpha%20bravo</a
  >
</p>
```
