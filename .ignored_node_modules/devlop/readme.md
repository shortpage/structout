...
<script type="module">
  import {
    ...
    ok,
    unreachable
  } from 'https://esm.sh/devlop@1?bundle'
  // For development code:
...
var r = u(c, 'Since ES5, please use `String#includes` itself.')
function c(n, t, e) {
  return n.indexOf(t, e || 0) !== -1
}
console.log(r('blue whale', 'dolphin'))
console.log(r('blue whale', 'whale'))
```
...
```js
const l = function (l, e, o) {
  return -1 !== l.indexOf(e, o || 0)
}
console.log(l('blue whale', 'dolphin')), console.log(l('blue whale', 'whale'))
```
