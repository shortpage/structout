!(function (t, n) {
  ...
  function st(t, n, s, u, N, O, P, Q, R, S, U, V, W, X, Y, Z) {
    ...
    let St = (function (t, n) {
        ...
        o(
          o(
            f(at(b, l, y, Rt, Pt, -Qt, Et, Jt, Ot, C), C),
            C,
            at(l, g, p, Ot, Qt, Rt, Gt, Kt, Pt, D),
            D,
            I,
          ),
          I,
          o(
            f(at(g, h, y, Pt, Rt, Ot, Ht, Lt, Qt, E), E),
            E,
            at(h, b, p, Qt, Ot, -Pt, It, Nt, Rt, G),
            G,
            J,
          ),
          J,
    ...
    return (
      (St +=
        (Gt * Gt + Kt * Kt + Pt * Pt) *
          (Qt * Yt + Rt * Zt + Ot * Xt + (xt * rt + gt * st + pt * et)) +
        (It * It + Nt * Nt + Rt * Rt) *
          (Ot * Wt - Pt * Zt + Qt * Vt + (pt * nt - yt * st + xt * $)) -
        ((Et * Et + Jt * Jt + Ot * Ot) *
          (Pt * Xt - Qt * $t + Rt * Wt + (yt * et - xt * ft + gt * nt)) +
          (Ht * Ht + Lt * Lt + Qt * Qt) *
            (Rt * Vt + Ot * $t + Pt * Yt + (gt * $ + pt * ft + yt * rt))) +
        2 *
          ((Gt * it + Kt * lt + Pt * yt) * (Qt * rt + Rt * st + Ot * et) +
            (It * ht + Nt * dt + Rt * gt) * (Ot * nt - Pt * st + Qt * $) -
            ((Et * ut + Jt * bt + Ot * pt) * (Pt * et - Qt * ft + Rt * nt) +
              (Ht * ct + Lt * Mt + Qt * xt) * (Rt * $ + Ot * ft + Pt * rt)))),
      St >= Ut || -St >= Ut
        ? St
        : (function (t, n, r, o, s, f, u, i, c, N, O, P, Q, R, S) {
            ...
            const ut = _(h, b, p, c, r, -f, T),
              ...
              yt = _(d, p, x, c, S, r, B),
              xt = a(
                tt(ct, w, Mt, q, pt, z, it, j, t, n, r, C),
                C,
                tt(ht, A, dt, v, yt, B, ct, w, o, s, f, D),
                D,
                a(
                  tt(bt, F, pt, z, lt, k, ht, A, u, i, c, E),
                  E,
                  tt(ut, T, yt, B, Mt, q, bt, F, N, O, P, G),
                  G,
                  tt(it, j, lt, k, dt, v, ut, T, Q, R, S, H),
                  H,
                  J,
                  K,
                ),
  ...
  (t.insphere = function (t, n, e, r, o, a, s, f, u, i, c, h, b, l, M) {
    ...
    return X > ut || -X > ut
      ? X
      : -st(t, n, e, r, o, a, s, f, u, i, c, h, b, l, M, ft);
  }),
