(function (global, factory) {
  ...
  function orient3dadapt(
    ...
    finlen = sum(
      sum(
        scale(4, bc$2, adz, _8$2),
        _8$2,
        scale(4, ca$1, bdz, _8b$1),
        _8b$1,
        _16$2,
      ),
      _16$2,
      scale(4, ab$2, cdz, _8$2),
      _8$2,
      fin$2,
    );
  ...
  function incircleadapt(ax, ay, bx, by, cx, cy, dx, dy, permanent) {
    ...
    finlen = sum(
      sum(
        sum(
          scale(scale(4, bc$1, adx, _8$1), _8$1, adx, _16$1),
          _16$1,
          scale(scale(4, bc$1, ady, _8$1), _8$1, ady, _16b),
          _16b,
          _32,
        ),
        _32,
        sum(
          scale(scale(4, ca, bdx, _8$1), _8$1, bdx, _16$1),
          _16$1,
          scale(scale(4, ca, bdy, _8$1), _8$1, bdy, _16b),
          _16b,
          _32b,
        ),
        _32b,
      ...
      _64,
      sum(
        scale(scale(4, ab$1, cdx, _8$1), _8$1, cdx, _16$1),
        _16$1,
        scale(scale(4, ab$1, cdy, _8$1), _8$1, cdy, _16b),
        _16b,
        _32,
      ),
      _32,
    ...
    if (adxtail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum_three(
          scale(axtbclen, axtbc, 2 * adx, _16$1),
          _16$1,
          scale(scale(4, cc, adxtail, _8$1), _8$1, bdy, _16b),
          _16b,
          scale(scale(4, bb, adxtail, _8$1), _8$1, -cdy, _16c),
          _16c,
          _32,
          _48$1,
        ),
    ...
    if (adytail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum_three(
          scale(aytbclen, aytbc, 2 * ady, _16$1),
          _16$1,
          scale(scale(4, bb, adytail, _8$1), _8$1, cdx, _16b),
          _16b,
          scale(scale(4, cc, adytail, _8$1), _8$1, -bdx, _16c),
          _16c,
          _32,
          _48$1,
        ),
    ...
    if (bdxtail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum_three(
          scale(bxtcalen, bxtca, 2 * bdx, _16$1),
          _16$1,
          scale(scale(4, aa, bdxtail, _8$1), _8$1, cdy, _16b),
          _16b,
          scale(scale(4, cc, bdxtail, _8$1), _8$1, -ady, _16c),
          _16c,
          _32,
          _48$1,
        ),
    ...
    if (bdytail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum_three(
          scale(bytcalen, bytca, 2 * bdy, _16$1),
          _16$1,
          scale(scale(4, cc, bdytail, _8$1), _8$1, adx, _16b),
          _16b,
          scale(scale(4, aa, bdytail, _8$1), _8$1, -cdx, _16c),
          _16c,
          _32,
          _48$1,
        ),
    ...
    if (cdxtail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum_three(
          scale(cxtablen, cxtab, 2 * cdx, _16$1),
          _16$1,
          scale(scale(4, bb, cdxtail, _8$1), _8$1, ady, _16b),
          _16b,
          scale(scale(4, aa, cdxtail, _8$1), _8$1, -bdy, _16c),
          _16c,
          _32,
          _48$1,
        ),
    ...
    if (cdytail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum_three(
          scale(cytablen, cytab, 2 * cdy, _16$1),
          _16$1,
          scale(scale(4, aa, cdytail, _8$1), _8$1, bdx, _16b),
          _16b,
          scale(scale(4, bb, cdytail, _8$1), _8$1, -adx, _16c),
          _16c,
          _32,
          _48$1,
        ),
    ...
    if (adxtail !== 0 || adytail !== 0) {
      ...
      if (adxtail !== 0) {
        ...
        finlen = finadd(
          finlen,
          sum(
            scale(axtbclen, axtbc, adxtail, _16$1),
            _16$1,
        ...
        finlen = finadd(
          finlen,
          sum_three(
            scale(len2, _8$1, 2 * adx, _16$1),
            _16$1,
            scale(len2, _8$1, adxtail, _16b),
            _16b,
        ...
        if (bdytail !== 0) {
          finlen = finadd(
            finlen,
            scale(scale(4, cc, adxtail, _8$1), _8$1, bdytail, _16$1),
            _16$1,
          );
        }
        if (cdytail !== 0) {
          finlen = finadd(
            finlen,
            scale(scale(4, bb, -adxtail, _8$1), _8$1, cdytail, _16$1),
            _16$1,
          );
        }
      }
      if (adytail !== 0) {
        ...
        finlen = finadd(
          finlen,
          sum(
            scale(aytbclen, aytbc, adytail, _16$1),
            _16$1,
        ...
        finlen = finadd(
          finlen,
          sum_three(
            scale(len2, _8$1, 2 * ady, _16$1),
            _16$1,
            scale(len2, _8$1, adytail, _16b),
            _16b,
    ...
    if (bdxtail !== 0 || bdytail !== 0) {
      ...
      if (bdxtail !== 0) {
        ...
        finlen = finadd(
          finlen,
          sum(
            scale(bxtcalen, bxtca, bdxtail, _16$1),
            _16$1,
        ...
        finlen = finadd(
          finlen,
          sum_three(
            scale(len2, _8$1, 2 * bdx, _16$1),
            _16$1,
            scale(len2, _8$1, bdxtail, _16b),
            _16b,
        ...
        if (cdytail !== 0) {
          finlen = finadd(
            finlen,
            scale(scale(4, aa, bdxtail, _8$1), _8$1, cdytail, _16$1),
            _16$1,
          );
        }
        if (adytail !== 0) {
          finlen = finadd(
            finlen,
            scale(scale(4, cc, -bdxtail, _8$1), _8$1, adytail, _16$1),
            _16$1,
          );
        }
      }
      if (bdytail !== 0) {
        ...
        finlen = finadd(
          finlen,
          sum(
            scale(bytcalen, bytca, bdytail, _16$1),
            _16$1,
        ...
        finlen = finadd(
          finlen,
          sum_three(
            scale(len2, _8$1, 2 * bdy, _16$1),
            _16$1,
            scale(len2, _8$1, bdytail, _16b),
            _16b,
    ...
    if (cdxtail !== 0 || cdytail !== 0) {
      ...
      if (cdxtail !== 0) {
        ...
        finlen = finadd(
          finlen,
          sum(
            scale(cxtablen, cxtab, cdxtail, _16$1),
            _16$1,
        ...
        finlen = finadd(
          finlen,
          sum_three(
            scale(len2, _8$1, 2 * cdx, _16$1),
            _16$1,
            scale(len2, _8$1, cdxtail, _16b),
            _16b,
        ...
        if (adytail !== 0) {
          finlen = finadd(
            finlen,
            scale(scale(4, bb, cdxtail, _8$1), _8$1, adytail, _16$1),
            _16$1,
          );
        }
        if (bdytail !== 0) {
          finlen = finadd(
            finlen,
            scale(scale(4, aa, -cdxtail, _8$1), _8$1, bdytail, _16$1),
            _16$1,
          );
        }
      }
      if (cdytail !== 0) {
        ...
        finlen = finadd(
          finlen,
          sum(
            scale(cytablen, cytab, cdytail, _16$1),
            _16$1,
        ...
        finlen = finadd(
          finlen,
          sum_three(
            scale(len2, _8$1, 2 * cdy, _16$1),
            _16$1,
            scale(len2, _8$1, cdytail, _16b),
            _16b,
  ...
  function insphere(
    ...
    const permanent =
      (cexdeyplus * bezplus + bexdeyplus * cezplus + bexceyplus * dezplus) *
        alift +
      (dexaeyplus * cezplus + aexceyplus * dezplus + cexdeyplus * aezplus) *
        blift +
      (aexbeyplus * dezplus + bexdeyplus * aezplus + dexaeyplus * bezplus) *
        clift +
      (bexceyplus * aezplus + aexceyplus * bezplus + aexbeyplus * cezplus) *
        dlift;
