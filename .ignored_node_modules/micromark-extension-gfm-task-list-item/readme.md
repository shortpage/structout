...
import {
  gfmTaskListItem,
  gfmTaskListItemHtml
} from 'https://esm.sh/micromark-extension-gfm-task-list-item@2'
```
...
<script type="module">
  import {
    gfmTaskListItem,
    gfmTaskListItemHtml
  } from 'https://esm.sh/micromark-extension-gfm-task-list-item@2?bundle'
</script>
```
...
in HTML.
See [_§ 4.10.5.1.15 Checkbox state (`type=checkbox`)_][html-input-checkbox]
