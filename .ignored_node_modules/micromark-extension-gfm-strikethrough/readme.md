...
} from 'https://esm.sh/micromark-extension-gfm-strikethrough@2'
```
...
<script type="module">
  import {
    gfmStrikethrough,
    gfmStrikethroughHtml
  } from 'https://esm.sh/micromark-extension-gfm-strikethrough@2?bundle'
</script>
```
...
HTML.
See [_§ 4.7.2 The `del` element_][html-del] in the HTML spec for more info.
