...
var _omitEventHandlers = _interopRequireDefault(
  require("../omitEventHandlers"),
);
/**
...
function mergeSlotProps(parameters) {
  ...
  const componentsPropsWithoutEventHandlers = (0, _omitEventHandlers.default)(
    externalSlotProps,
  );
  const otherPropsWithoutEventHandlers = (0, _omitEventHandlers.default)(
    externalForwardedProps,
  );
