...
function useList(params) {
  var _params$controlledPro = params.controlledProps,
    ...
    reducerActionContext =
      _params$reducerAction === void 0 ? EMPTY_OBJECT : _params$reducerAction,
    _params$selectionMode = params.selectionMode,
    selectionMode =
      _params$selectionMode === void 0 ? "single" : _params$selectionMode,
    externalReducer = params.stateReducer,
    _params$componentName = params.componentName,
    componentName =
      _params$componentName === void 0 ? "useList" : _params$componentName;
  ...
  var getItemState = React.useCallback(
    function (item) {
      var selected = (selectedValues != null ? selectedValues : []).some(
        function (value) {
