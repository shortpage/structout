...
export function useSlider(parameters) {
  var ariaLabelledby = parameters["aria-labelledby"],
    ...
    disableSwap =
      _parameters$disableSw === void 0 ? false : _parameters$disableSw,
    ...
    orientation =
      _parameters$orientati === void 0 ? "horizontal" : _parameters$orientati,
  ...
  var handleChange =
    ...
    function (event, value, thumbIndex) {
      ...
      var clonedEvent = new nativeEvent.constructor(
        nativeEvent.type,
        nativeEvent,
      );
  ...
  var marks =
    marksProp === true && step !== null
      ? _toConsumableArray(Array(Math.floor((max - min) / step) + 1)).map(
          function (_, index) {
            return {
  ...
  var createHandleHiddenInputFocus = function createHandleHiddenInputFocus(
    otherHandlers,
  ) {
  ...
  var createHandleHiddenInputBlur = function createHandleHiddenInputBlur(
    otherHandlers,
  ) {
    return function (event) {
  ...
  var createHandleHiddenInputKeyDown = function createHandleHiddenInputKeyDown(
    otherHandlers,
  ) {
    return function (event) {
