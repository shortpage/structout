...
export function useNumberInput(parameters) {
  ...
  var min = parameters.min,
    ...
    shiftMultiplier =
      _parameters$shiftMult === void 0 ? 10 : _parameters$shiftMult,
    defaultValueProp = parameters.defaultValue,
    _parameters$disabled = parameters.disabled,
    disabledProp =
      _parameters$disabled === void 0 ? false : _parameters$disabled,
    ...
    requiredProp =
      _parameters$required === void 0 ? false : _parameters$required,
    _parameters$readOnly = parameters.readOnly,
    readOnlyProp =
      _parameters$readOnly === void 0 ? false : _parameters$readOnly,
    ...
    componentName =
      _parameters$component === void 0
        ? "useNumberInput"
        : _parameters$component; // TODO: make it work with FormControl
  ...
  var createHandleInputChange = function createHandleInputChange(
    otherHandlers,
  ) {
    return function (event) {
  ...
  var handleStepperButtonMouseDown = function handleStepperButtonMouseDown(
    event,
  ) {
    event.preventDefault();
    if (inputRef.current) {
  ...
  var isIncrementDisabled =
    disabledProp ||
    (isNumber(value)
      ? value >= (max != null ? max : Number.MAX_SAFE_INTEGER)
      : false);
  ...
  var isDecrementDisabled =
    disabledProp ||
    (isNumber(value)
      ? value <= (min != null ? min : Number.MIN_SAFE_INTEGER)
      : false);
