 ...
 */
var NumberInput = /*#__PURE__*/ React.forwardRef(
    ...
    var inputProps = useSlotProps({
      ...
      getSlotProps: function getSlotProps(otherHandlers) {
        return getInputProps(
          _extends({}, propsForwardedToInputSlot, otherHandlers),
        );
      },
...
process.env.NODE_ENV !== "production"
  ? (NumberInput.propTypes /* remove-proptypes */ = {
      ...
      slotProps: PropTypes.shape({
        decrementButton: PropTypes.oneOfType([
          PropTypes.func,
          PropTypes.object,
        ]),
        incrementButton: PropTypes.oneOfType([
          PropTypes.func,
          PropTypes.object,
        ]),
