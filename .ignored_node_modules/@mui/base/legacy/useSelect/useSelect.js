...
function useSelect(props) {
  var areOptionsEqual = props.areOptionsEqual,
    ...
    getOptionAsString =
      _props$getOptionAsStr === void 0
        ? defaultOptionStringifier
        : _props$getOptionAsStr,
    _props$getSerializedV = props.getSerializedValue,
    getSerializedValue =
      _props$getSerializedV === void 0
        ? defaultFormValueProvider
        : _props$getSerializedV,
    valueProp = props.value,
    _props$componentName = props.componentName,
    componentName =
      _props$componentName === void 0 ? "useSelect" : _props$componentName;
  ...
  var createHandleButtonClick = function createHandleButtonClick(
  ...
  var createHandleButtonKeyDown = function createHandleButtonKeyDown(
    otherHandlers,
  ) {
    return function (event) {
  ...
  var getButtonProps = function getButtonProps() {
    ...
    var combinedProps = combineHooksSlotProps(
      getSelectTriggerProps,
      getButtonRootProps,
    );
    return _extends({}, externalProps, combinedProps(externalEventHandlers));
  };
  var createListboxHandleBlur = function createListboxHandleBlur(
    otherHandlers,
  ) {
    return function (event) {
