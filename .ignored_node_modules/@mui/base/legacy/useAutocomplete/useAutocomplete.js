...
export function createFilterOptions() {
  ...
  var _config$ignoreAccents = config.ignoreAccents,
    ignoreAccents =
      _config$ignoreAccents === void 0 ? true : _config$ignoreAccents,
...
var pageSize = 5;
var defaultIsActiveElementInListbox = function defaultIsActiveElementInListbox(
  listboxRef,
) {
...
export function useAutocomplete(props) {
  var _props$unstable_isAct = props.unstable_isActiveElementInListbox,
    ...
    componentName =
      _props$componentName === void 0
        ? "useAutocomplete"
        : _props$componentName,
  ...
  var focusTag = useEventCallback(function (tagToFocus) {
    if (tagToFocus === -1) {
      ...
      anchorEl
        .querySelector('[data-tag-index="'.concat(tagToFocus, '"]'))
        .focus();
    }
  });
  ...
  var setHighlightedIndex = useEventCallback(function (_ref2) {
    ...
    if (prev) {
      ...
      prev.classList.remove(
        "".concat(unstable_classNamePrefix, "-focusVisible"),
      );
    }
  ...
  var getPreviousHighlightedOptionIndex =
    function getPreviousHighlightedOptionIndex() {
  ...
  function validTagIndex(index, direction) {
    ...
    while (true) {
      ...
      var option = anchorEl.querySelector(
        '[data-tag-index="'.concat(nextFocus, '"]'),
      );
        ...
        switch (event.key) {
          ...
          case "Enter":
            if (highlightedIndexRef.current !== -1 && popupOpen) {
              ...
              var disabled = getOptionDisabled
