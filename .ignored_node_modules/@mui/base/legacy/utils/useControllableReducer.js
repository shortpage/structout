...
function useStateChangeDetection(parameters) {
  ...
  React.useEffect(
    function () {
      ...
      var previousState = getControlledState(
...
export function useControllableReducer(parameters) {
  ...
  var reducer = parameters.reducer,
    ...
    controlledProps =
      _parameters$controlle === void 0 ? EMPTY_OBJECT : _parameters$controlle,
    _parameters$stateComp = parameters.stateComparers,
    stateComparers =
      _parameters$stateComp === void 0 ? EMPTY_OBJECT : _parameters$stateComp,
    _parameters$onStateCh = parameters.onStateChange,
    onStateChange =
      _parameters$onStateCh === void 0 ? NOOP : _parameters$onStateCh,
    actionContext = parameters.actionContext,
    _parameters$component = parameters.componentName,
    componentName =
      _parameters$component === void 0 ? "" : _parameters$component;
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    React.useEffect(
      function () {
        Object.keys(controlledProps).forEach(function (key) {
          if (
            controlledPropsRef.current[key] !== undefined &&
            controlledProps[key] === undefined
          ) {
            console.error(
              "useControllableReducer: "
                .concat(
                  componentName
                    ? "The ".concat(componentName, " component")
                    : "A component",
  ...
  var _React$useReducer = React.useReducer(
