...
<p style="text-align:center;">
  <a href="https://v5.mui.com/base-ui/" rel="noopener" target="_blank">
    <!-- Normal space in the alt text, self-closing tag -->
    <img src="https://v5.mui.com/static/logo.svg"
         width="150"
         height="133"
         alt="Base UI logo" />
  </a>
...
<h1 style="text-align:center;">Base UI</h1>
