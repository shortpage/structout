...
export interface OptionOwnProps<OptionValue> {
  ...
  slotProps?: {
    root?: SlotComponentProps<
      "li",
      OptionRootSlotPropsOverrides,
      OptionOwnerState<OptionValue>
    >;
  };
  /**
...
export type OptionProps<
  ...
  RootComponentType extends
    React.ElementType = OptionTypeMap<OptionValue>["defaultComponent"],
> = PolymorphicProps<
  OptionTypeMap<OptionValue, {}, RootComponentType>,
  RootComponentType
>;
