...
export interface SnackbarOwnProps extends Omit<UseSnackbarParameters, "ref"> {
  ...
  slotProps?: {
    ...
    root?: SlotComponentProps<
      "div",
      SnackbarRootSlotPropsOverrides,
      SnackbarOwnerState
    >;
  };
  /**
...
export type SnackbarProps<
  RootComponentType extends
    React.ElementType = SnackbarTypeMap["defaultComponent"],
...
export interface SnackbarClickAwayListenerSlotProps
  extends ClickAwayListenerProps {
  ownerState: SnackbarOwnerState;
}
