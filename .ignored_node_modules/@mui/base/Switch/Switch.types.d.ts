...
export interface SwitchOwnProps extends UseSwitchParameters {
  ...
  slotProps?: {
    root?: SlotComponentProps<
      "span",
      SwitchRootSlotPropsOverrides,
      SwitchOwnerState
    >;
    thumb?: SlotComponentProps<
      "span",
      SwitchThumbSlotPropsOverrides,
      SwitchOwnerState
    >;
    input?: SlotComponentProps<
      "input",
      SwitchInputSlotPropsOverrides,
      SwitchOwnerState
    >;
    track?: SlotComponentProps<
      "span",
      SwitchTrackSlotPropsOverrides,
      SwitchOwnerState
    >;
  };
}
...
export type SwitchProps<
  RootComponentType extends
    React.ElementType = SwitchTypeMap["defaultComponent"],
