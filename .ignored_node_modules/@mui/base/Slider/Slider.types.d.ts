...
export interface SliderOwnProps extends Omit<UseSliderParameters, "ref"> {
  ...
  slotProps?: {
    root?: SlotComponentProps<
      "span",
      SliderRootSlotPropsOverrides,
      SliderOwnerState
    >;
    track?: SlotComponentProps<
      "span",
      SliderTrackSlotPropsOverrides,
      SliderOwnerState
    >;
    rail?: SlotComponentProps<
      "span",
      SliderRailSlotPropsOverrides,
      SliderOwnerState
    >;
    ...
    mark?: SlotComponentProps<
      "span",
      SliderMarkSlotPropsOverrides,
      SliderOwnerState
    >;
    markLabel?: SlotComponentProps<
      "span",
      SliderMarkLabelSlotPropsOverrides,
      SliderOwnerState
    >;
...
export type SliderProps<
  RootComponentType extends
    React.ElementType = SliderTypeMap["defaultComponent"],
