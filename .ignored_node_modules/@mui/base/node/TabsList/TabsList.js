...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    ...
    (0, _ClassNameConfigurator.useClassNamesOverride)(
      _tabsListClasses.getTabsListUtilityClass,
    ),
  );
};
...
const TabsList = (exports.TabsList = /*#__PURE__*/ React.forwardRef(
  function TabsList(props, forwardedRef) {
    ...
    const { isRtl, orientation, getRootProps, contextValue } = (0,
    _useTabsList.useTabsList)({
    ...
    const TabsListRoot =
      (_slots$root = slots.root) != null ? _slots$root : "div";
    ...
    return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
      _TabsListProvider.TabsListProvider,
      {
        value: contextValue,
