      ...
      (0, _extends2.default)({}, rootProps, {
        children: [
                    ...
                    mark.label != null
                      ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                          ...
                          (0, _extends2.default)(
                            ...
                            markLabelProps,
                            !(0, _isHostComponent.isHostComponent)(
                              MarkLabel,
                            ) && {
          ...
          values.map((value, index) => {
            ...
            const style = axisProps[axis].offset(percent);
            const resolvedSlotProps = (0,
            _resolveComponentProps.resolveComponentProps)(
              slotProps.thumb,
              ownerState,
              {
                index,
...
process.env.NODE_ENV !== "production"
  ? (Slider.propTypes /* remove-proptypes */ = {
       ...
       */
      "aria-label": (0, _utils.chainPropTypes)(
       ...
       */
      "aria-valuetext": (0, _utils.chainPropTypes)(
        _propTypes.default.string,
        (props) => {
          const range = Array.isArray(props.value || props.defaultValue);
