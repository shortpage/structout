...
const InnerMenuItem = /*#__PURE__*/ React.memo(
  /*#__PURE__*/ React.forwardRef(function MenuItem(props, forwardedRef) {
    ...
    const { getRootProps, disabled, focusVisible, highlighted } = (0,
    _useMenuItem.useMenuItem)({
      id,
 ...
 */
const MenuItem = (exports.MenuItem = /*#__PURE__*/ React.forwardRef(
  function MenuItem(props, ref) {
    ...
    const { contextValue, id } = (0, _useMenuItem.useMenuItemContextStabilizer)(
      idProp,
    );
