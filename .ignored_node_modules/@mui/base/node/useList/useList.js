...
const defaultItemStringifier = (item) =>
...
function useList(params) {
  ...
  const stateComparers = React.useMemo(
    () => ({
      ...
      selectedValues: (valuesArray1, valuesArray2) =>
        (0, _areArraysEqual.areArraysEqual)(
          valuesArray1,
          valuesArray2,
          itemComparer,
        ),
  ...
  const reducer =
    externalReducer != null ? externalReducer : _listReducer.listReducer;
  ...
  const handleTextNavigation = (0, _useTextNavigation.useTextNavigation)(
    (searchString, event) =>
      dispatch({
