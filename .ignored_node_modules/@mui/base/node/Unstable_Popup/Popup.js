...
function useUtilityClasses(ownerState) {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    ...
    (0, _ClassNameConfigurator.useClassNamesOverride)(
      _popupClasses.getPopupUtilityClass,
    ),
  );
}
  ...
  function Popup(props, forwardedRef) {
    ...
    (0, _utils.unstable_useEnhancedEffect)(() => {
      if (keepMounted && open && elements.reference && elements.floating) {
        const cleanup = (0, _reactDom.autoUpdate)(
          elements.reference,
          elements.floating,
          update,
        );
    ...
    const { contextValue, hasExited: hasTransitionExited } = (0,
    _useTransition.useTransitionTrigger)(open);
    const visibility =
      keepMounted && hasTransitionExited ? "hidden" : undefined;
    ...
    return /*#__PURE__*/ (0, _jsxRuntime.jsx)(_Portal.Portal, {
      ...
      children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
        _PopupContext.PopupContext.Provider,
        {
          value: popupContextValue,
          children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
            _useTransition.TransitionContext.Provider,
            {
              value: contextValue,
              children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                Root,
