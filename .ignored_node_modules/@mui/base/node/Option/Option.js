...
function useUtilityClasses(ownerState) {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    ...
    (0, _ClassNameConfigurator.useClassNamesOverride)(
      _optionClasses.getOptionUtilityClass,
    ),
  );
}
const InnerOption = /*#__PURE__*/ React.memo(
  /*#__PURE__*/ React.forwardRef(function Option(props, forwardedRef) {
    ...
    const combinedRef = (0, _utils.unstable_useForkRef)(
      optionRef,
      forwardedRef,
    );
    ...
    const { getRootProps, selected, highlighted, index } = (0,
    _useOption.useOption)({
      disabled,
      label: computedLabel,
      rootRef: combinedRef,
      value,
 ...
 */
const Option = (exports.Option = /*#__PURE__*/ React.forwardRef(
