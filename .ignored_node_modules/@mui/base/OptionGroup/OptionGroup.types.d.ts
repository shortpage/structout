...
export interface OptionGroupOwnProps {
  ...
  slotProps?: {
    root?: SlotComponentProps<
      "li",
      OptionGroupRootSlotPropsOverrides,
      OptionGroupOwnerState
    >;
    label?: SlotComponentProps<
      "span",
      OptionGroupLabelSlotPropsOverrides,
      OptionGroupOwnerState
    >;
    list?: SlotComponentProps<
      "ul",
      OptionGroupListSlotPropsOverrides,
      OptionGroupOwnerState
    >;
  };
}
...
export type OptionGroupProps<
  RootComponentType extends
    React.ElementType = OptionGroupTypeMap["defaultComponent"],
> = PolymorphicProps<
  OptionGroupTypeMap<{}, RootComponentType>,
  RootComponentType
>;
