...
var _deleteLegacyGridProps = _interopRequireDefault(
  require("./deleteLegacyGridProps"),
);
...
function createGrid(options = {}) {
  ...
  const useUtilityClasses = (ownerState, theme) => {
    ...
    const slots = {
      root: [
        ...
        ...(container
          ? (0, _gridGenerator.generateSpacingClassNames)(
              spacing,
  ...
  const Grid = /*#__PURE__*/ React.forwardRef(function Grid(inProps, ref) {
    ...
    const size = parseResponsiveProp(
      sizeProp,
      theme.breakpoints,
      (val) => val !== false,
    );
