...
function unstable_createStyleFunctionSx() {
  ...
  function styleFunctionSx(props) {
    ...
    function traverse(sxInput) {
      ...
      const emptyBreakpoints = (0, _breakpoints.createEmptyBreakpointObject)(
        theme.breakpoints,
      );
      ...
      return (0, _cssContainerQueries.sortContainerQueries)(
        theme,
        (0, _breakpoints.removeUnusedBreakpoints)(breakpointsKeys, css),
      );
    }
