...
function gc(a) {
  ...
  if ("object" === typeof a)
    switch (a.$$typeof) {
      ...
      case $b:
        return (
          (b = a.displayName || null), null !== b ? b : gc(a.type) || "Memo"
        );
      case ac:
        b = a._payload;
        a = a._init;
...
function hd(a, b, c) {
  ...
  a.sentCompleteBoundaryFunction
    ? r(b, Gb)
    : ((a.sentCompleteBoundaryFunction = !0), r(b, Fb));
  if (null === d)
    throw Error(
      "An ID must have been assigned before we can complete the boundary.",
    );
...
function id(a, b, c, d) {
  ...
  a.sentCompleteSegmentFunction
    ? r(b, Bb)
    : ((a.sentCompleteSegmentFunction = !0), r(b, Ab));
  r(b, a.segmentPrefix);
  f = f.toString(16);
  r(b, f);
  r(b, Cb);
  ...
  try {
    ...
    for (e = 0; e < f.length; e++) {
      ...
      h.sentClientRenderFunction
        ? r(d, Kb)
        : ((h.sentClientRenderFunction = !0), r(d, Jb));
      if (null === m)
        throw Error(
          "An ID must have been assigned before we can complete the boundary.",
        );
