...
export declare const useSVGOverlayElement: (
...
>;
export declare const useSVGOverlay: (
  props: SVGOverlayProps,
) => import("react").MutableRefObject<
  Readonly<{
    instance: LeafletSVGOverlay;
...
>;
export declare const SVGOverlay: import("react").ForwardRefExoticComponent<
  SVGOverlayProps & import("react").RefAttributes<LeafletSVGOverlay>
>;
