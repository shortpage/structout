...
export declare const useLayersControlElement: (
  props: LayersControlProps,
  context: Readonly<{
    __version: number;
    map: import("leaflet").Map;
    layerContainer?:
      | import("leaflet").LayerGroup<any>
      | import("@react-leaflet/core/lib/context").ControlledLayer
      | undefined;
...
>;
export declare const useLayersControl: (
  props: LayersControlProps,
) => React.MutableRefObject<
  Readonly<{
    instance: Control.Layers;
...
export declare const LayersControl: ForwardRefExoticComponent<
...
export declare function createControlledLayer(
  addLayerToControl: AddLayerFunc,
): (props: ControlledLayerProps) => JSX.Element | null;
export {};
