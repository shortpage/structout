...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _base.unstable_composeClasses)(
    slots,
    _masonryClasses.getMasonryUtilityClass,
    classes,
  );
};
const getStyle = ({ ownerState, theme }) => {
  ...
  if (ownerState.isSSR) {
    const orderStyleSSR = {};
    const defaultSpacing = parseToNumber(
      theme.spacing(ownerState.defaultSpacing),
    );
  ...
  const columnStyleFromPropValue = (propValue) => {
    ...
    const spacing =
      (typeof spacingValues === "string" &&
        !Number.isNaN(Number(spacingValues))) ||
      ...
      (0, _system.handleBreakpoints)(
        ...
        (propValue, breakpoint) => {
          if (breakpoint) {
            ...
            const spacing = (0, _system.getValue)(
              transformer,
              themeSpacingValue,
            );
            const column =
...
const Masonry = /*#__PURE__*/ React.forwardRef(function Masonry(inProps, ref) {
  ...
  const handleResize = React.useCallback(
    (masonryChildren) => {
      ...
      const firstChildComputedStyle =
        window.getComputedStyle(masonryFirstChild);
      const firstChildMarginLeft = parseToNumber(
        firstChildComputedStyle.marginLeft,
      );
      const firstChildMarginRight = parseToNumber(
        firstChildComputedStyle.marginRight,
      );
      ...
      masonry.childNodes.forEach((child) => {
        ...
        const childMarginBottom = parseToNumber(
          childComputedStyle.marginBottom,
        );
...
process.env.NODE_ENV !== "production"
  ? (Masonry.propTypes /* remove-proptypes */ = {
       ...
       */
      children:
        _propTypes.default /* @typescript-to-proptypes-ignore */.node
          .isRequired,
      /**
