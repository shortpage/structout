...
var _loadingButtonClasses = _interopRequireWildcard(
  require("./loadingButtonClasses"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    startIcon: [
      loading && `startIconLoading${(0, _utils2.capitalize)(loadingPosition)}`,
    ],
    endIcon: [
      loading && `endIconLoading${(0, _utils2.capitalize)(loadingPosition)}`,
    ],
    loadingIndicator: [
      "loadingIndicator",
  ...
  overridesResolver: (props, styles) => {
    return [
      ...
      styles.startIconLoadingStart && {
        [`& .${_loadingButtonClasses.default.startIconLoadingStart}`]:
          styles.startIconLoadingStart,
      },
      styles.endIconLoadingEnd && {
        [`& .${_loadingButtonClasses.default.endIconLoadingEnd}`]:
          styles.endIconLoadingEnd,
      },
    ];
  },
...
const LoadingButtonLoadingIndicator = (0, _styles.styled)("span", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[
        `loadingIndicator${(0, _utils2.capitalize)(ownerState.loadingPosition)}`
      ],
    ];
  },
})(({ theme, ownerState }) =>
...
const LoadingButton = /*#__PURE__*/ React.forwardRef(
