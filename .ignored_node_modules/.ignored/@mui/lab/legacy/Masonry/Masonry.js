...
export var getStyle = function getStyle(_ref) {
  ...
  if (ownerState.isSSR) {
    var orderStyleSSR = {};
    var defaultSpacing = parseToNumber(
  ...
  var spacingStyleFromPropValue = function spacingStyleFromPropValue(
    propValue,
  ) {
    var spacing;
      ...
      ownerState.maxColumnHeight && {
        height:
          typeof spacing === "number"
            ...
            : "calc("
                .concat(ownerState.maxColumnHeight, "px + ")
                .concat(spacing, ")"),
      },
    );
  };
...
var Masonry = /*#__PURE__*/ React.forwardRef(function Masonry(inProps, ref) {
  ...
  var handleResize = React.useCallback(
    function (masonryChildren) {
      ...
      var firstChildMarginLeft = parseToNumber(
        firstChildComputedStyle.marginLeft,
      );
      var firstChildMarginRight = parseToNumber(
      ...
      if (!skip) {
        ...
        ReactDOM.flushSync(function () {
          setMaxColumnHeight(
            Math.max.apply(Math, _toConsumableArray(columnHeights)),
          );
  ...
  var lineBreaks = new Array(numberOfLineBreaks)
    .fill("")
