...
exports.TreeItemRoot =
  exports.TreeItemLoadingContainer =
  exports.TreeItemLabel =
  exports.TreeItemIconContainer =
  exports.TreeItemGroupTransition =
  exports.TreeItemErrorContainer =
  exports.TreeItemContent =
  exports.TreeItemCheckbox =
  exports.TreeItem =
    void 0;
...
var _unsupportedProp = _interopRequireDefault(
  require("@mui/utils/unsupportedProp"),
);
...
const TreeItemContent = (exports.TreeItemContent = (0, _zeroStyled.styled)(
  "div",
  {
    name: "MuiTreeItem",
    slot: "Content",
    shouldForwardProp: (prop) =>
      (0, _createStyled.shouldForwardProp)(prop) && prop !== "status",
  },
)(({ theme }) => ({
...
const TreeItemLabel = (exports.TreeItemLabel = (0, _zeroStyled.styled)("div", {
  ...
  slot: "Label",
  shouldForwardProp: (prop) =>
    (0, _createStyled.shouldForwardProp)(prop) && prop !== "editable",
})(({ theme }) =>
  (0, _extends2.default)(
    {
      width: "100%",
...
const TreeItemIconContainer = (exports.TreeItemIconContainer = (0,
_zeroStyled.styled)("div", {
  name: "MuiTreeItem",
  slot: "IconContainer",
})({
  width: 16,
...
const TreeItemGroupTransition = (exports.TreeItemGroupTransition = (0,
_zeroStyled.styled)(_Collapse.default, {
  name: "MuiTreeItem",
...
const TreeItemErrorContainer = (exports.TreeItemErrorContainer = (0,
_zeroStyled.styled)("div", {
  name: "MuiTreeItem",
  slot: "ErrorIcon",
})({
...
const TreeItemLoadingContainer = (exports.TreeItemLoadingContainer = (0,
_zeroStyled.styled)(_CircularProgress.default, {
  name: "MuiTreeItem",
  slot: "LoadingIcon",
})({
  color: "text.primary",
}));
const TreeItemCheckbox = (exports.TreeItemCheckbox = (0, _zeroStyled.styled)(
...
const useUtilityClasses = (classesProp) => {
  const { classes: classesFromTreeView } = (0,
  _TreeViewStyleContext.useTreeViewStyleContext)();
  const classes = (0, _extends2.default)({}, classesProp, {
    root: (0, _clsx.default)(classesProp?.root, classesFromTreeView.root),
    content: (0, _clsx.default)(
      classesProp?.content,
      classesFromTreeView.itemContent,
    ),
    iconContainer: (0, _clsx.default)(
      classesProp?.iconContainer,
      classesFromTreeView.itemIconContainer,
    ),
    checkbox: (0, _clsx.default)(
      classesProp?.checkbox,
      classesFromTreeView.itemCheckbox,
    ),
    label: (0, _clsx.default)(
      classesProp?.label,
      classesFromTreeView.itemLabel,
    ),
    groupTransition: (0, _clsx.default)(
      classesProp?.groupTransition,
      classesFromTreeView.itemGroupTransition,
    ),
    labelInput: (0, _clsx.default)(
      classesProp?.labelInput,
      classesFromTreeView.itemLabelInput,
    ),
    dragAndDropOverlay: (0, _clsx.default)(
      classesProp?.dragAndDropOverlay,
      classesFromTreeView.itemDragAndDropOverlay,
    ),
    errorIcon: (0, _clsx.default)(
      classesProp?.errorIcon,
      classesFromTreeView.itemErrorIcon,
    ),
    loadingIcon: (0, _clsx.default)(
 ...
 */
const TreeItem = (exports.TreeItem = /*#__PURE__*/ React.forwardRef(
  function TreeItem(inProps, forwardedRef) {
    ...
    const contentProps = (0, _useSlotProps.default)({
      ...
      className: (0, _clsx.default)(
        classes.content,
        status.expanded && classes.expanded,
        status.selected && classes.selected,
        status.focused && classes.focused,
        status.disabled && classes.disabled,
        status.editing && classes.editing,
        status.editable && classes.editable,
      ),
    });
    ...
    const LabelInput =
      slots.labelInput ?? _TreeItemLabelInput.TreeItemLabelInput;
    ...
    const DragAndDropOverlay =
      ...
      _TreeItemDragAndDropOverlay.TreeItemDragAndDropOverlay;
    ...
    return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
      _TreeItemProvider.TreeItemProvider,
      (0, _extends2.default)({}, getContextProviderProps(), {
          ...
          (0, _extends2.default)({}, rootProps, {
            children: [
              /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
                Content,
                (0, _extends2.default)({}, contentProps, {
                  children: [
                    /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
                      IconContainer,
                      (0, _extends2.default)({}, iconContainerProps, {
                        children: [
                          status.error &&
                            /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                              ErrorIcon,
                              (0, _extends2.default)({}, errorContainerProps),
                            ),
                          status.loading
                            ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                                LoadingIcon,
                    ...
                    /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                      Checkbox,
                      (0, _extends2.default)({}, checkboxProps),
                    ),
                    status.editing
                      ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                          LabelInput,
                          (0, _extends2.default)({}, labelInputProps),
                        )
                      : /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                          Label,
