...
const TreeItemDragAndDropOverlayRoot = (0, _zeroStyled.styled)("div", {
  ...
  shouldForwardProp: (prop) =>
    (0, _createStyled.shouldForwardProp)(prop) && prop !== "action",
})(({ theme }) => ({
  position: "absolute",
  left: 0,
  display: "flex",
  ...
  variants: [
    {
      ...
      style: {
        marginLeft:
          "calc(var(--TreeView-indentMultiplier) * var(--TreeView-itemDepth))",
    ...
    },
    {
      ...
      style: {
        marginLeft:
          "calc(var(--TreeView-indentMultiplier) * calc(var(--TreeView-itemDepth) - 1))",
        borderBottom: `1px solid ${(theme.vars || theme).palette.action.active}`,
      },
    },
  ],
...
function TreeItemDragAndDropOverlay(props) {
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
    TreeItemDragAndDropOverlayRoot,
...
process.env.NODE_ENV !== "production"
  ? (TreeItemDragAndDropOverlay.propTypes = {
      ...
      // ----------------------------------------------------------------------
      action: _propTypes.default.oneOf([
        "make-child",
        "move-to-parent",
        "reorder-above",
        "reorder-below",
