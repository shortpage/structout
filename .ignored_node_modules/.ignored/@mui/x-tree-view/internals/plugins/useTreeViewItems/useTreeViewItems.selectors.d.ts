 ...
 */
export declare const selectorIsTreeViewLoading: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewItems.types.js").UseTreeViewItemsState<
      import("../../../index.js").TreeViewDefaultItemModelProperties
    > &
    Partial<{}> & {
  ...
  resultFunc: (resultFuncArgs_0: {
    ...
    itemModelLookup: {
      [itemId: string]: import("../../../index.js").TreeViewBaseItem<
        import("../../../index.js").TreeViewDefaultItemModelProperties
      >;
    };
    itemMetaLookup: {
 ...
 */
export declare const selectorGetTreeViewError: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewItems.types.js").UseTreeViewItemsState<
      import("../../../index.js").TreeViewDefaultItemModelProperties
    > &
 ...
 */
export declare const selectorItemMetaLookup: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewItems.types.js").UseTreeViewItemsState<
      import("../../../index.js").TreeViewDefaultItemModelProperties
    > &
 ...
 */
export declare const selectorItemOrderedChildrenIds: ((
  state: any,
  itemId: string | null,
) => string[]) & {
  clearCache: () => void;
  ...
  lastResult: () => string[];
  dependencies: [
    TreeViewRootSelector<UseTreeViewItemsSignature>,
 ...
 */
export declare const selectorItemModel: ((
  state: any,
  itemId: string,
) => import("../../../index.js").TreeViewBaseItem<
  import("../../../index.js").TreeViewDefaultItemModelProperties
>) & {
  clearCache: () => void;
  resultsCount: () => number;
  ...
  lastResult: () => import("../../../index.js").TreeViewBaseItem<
    import("../../../index.js").TreeViewDefaultItemModelProperties
  >;
  dependencies: [
    TreeViewRootSelector<UseTreeViewItemsSignature>,
 ...
 */
export declare const selectorItemMeta: ((
  state: any,
  itemId: string | null,
) => TreeViewItemMeta | null) & {
  clearCache: () => void;
  resultsCount: () => number;
  resetResultsCount: () => void;
} & {
 ...
 */
export declare const selectorIsItemDisabled: ((
  state: any,
  itemId: string,
) => boolean) & {
  clearCache: () => void;
 ...
 */
export declare const selectorItemIndex: ((
  state: any,
  itemId: string | null,
) => number) & {
  clearCache: () => void;
  ...
  resultFunc: (
    ...
    resultFuncArgs_1: TreeViewItemMeta | null,
  ) => number;
  memoizedResultFunc: ((
    resultFuncArgs_0: {
      disabledItemsFocusable: boolean;
  ...
  dependencies: [
    TreeViewRootSelector<UseTreeViewItemsSignature>,
    ((state: any, itemId: string | null) => TreeViewItemMeta | null) & {
      clearCache: () => void;
      resultsCount: () => number;
      resetResultsCount: () => void;
    } & {
 ...
 */
export declare const selectorItemParentId: ((
  state: any,
  itemId: string | null,
) => string | null) & {
  clearCache: () => void;
  ...
  memoizedResultFunc: ((
    resultFuncArgs_0: TreeViewItemMeta | null,
  ) => string | null) & {
    clearCache: () => void;
    resultsCount: () => number;
    resetResultsCount: () => void;
 ...
 */
export declare const selectorItemDepth: ((
  state: any,
  itemId: string | null,
) => number) & {
  clearCache: () => void;
 ...
 */
export declare const selectorDisabledItemFocusable: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewItems.types.js").UseTreeViewItemsState<
      import("../../../index.js").TreeViewDefaultItemModelProperties
    > &
...
export declare const selectorCanItemBeFocused: ((
  state: any,
  itemId: string,
) => boolean) & {
  clearCache: () => void;
  ...
  memoizedResultFunc: ((
    resultFuncArgs_0: boolean,
    resultFuncArgs_1: boolean,
  ) => boolean) & {
    clearCache: () => void;
    resultsCount: () => number;
    resetResultsCount: () => void;
