...
var _useEnhancedEffect = _interopRequireDefault(
  require("@mui/utils/useEnhancedEffect"),
);
...
const useTreeViewJSXItems = ({ instance, store }) => {
  ...
  const insertJSXItem = (0, _useEventCallback.default)((item) => {
    ...
    return () => {
      store.update((prevState) => {
        const newItemMetaLookup = (0, _extends2.default)(
          {},
          prevState.items.itemMetaLookup,
        );
        const newItemModelLookup = (0, _extends2.default)(
          {},
          prevState.items.itemModelLookup,
        );
      ...
      (0, _extends2.default)({}, prevState, {
        items: (0, _extends2.default)({}, prevState.items, {
          ...
          itemChildrenIndexesLookup: (0, _extends2.default)(
            ...
            {
              [parentIdWithDefault]: (0, _useTreeViewItems.buildSiblingIndexes)(
                orderedChildrenIds,
              ),
            },
          ),
...
const useTreeViewJSXItemsItemPlugin = ({ props, rootRef, contentRef }) => {
  const { instance, store } = (0, _TreeViewProvider.useTreeViewContext)();
  const { children, disabled = false, label, itemId, id } = props;
  const parentContext = React.useContext(
    _TreeViewChildrenItemProvider.TreeViewChildrenItemContext,
  );
  ...
  React.useEffect(() => {
    if (label) {
      return instance.mapFirstCharFromJSX(
        itemId,
        (pluginContentRef.current?.textContent ?? "")
          .substring(0, 1)
          .toLowerCase(),
      );
    }
...
useTreeViewJSXItems.wrapItem = ({ children, itemId, idAttribute }) => {
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
    _TreeViewChildrenItemProvider.TreeViewChildrenItemProvider,
    {
      itemId: itemId,
...
if (process.env.NODE_ENV !== "production")
  useTreeViewJSXItems.wrapItem.displayName = "useTreeViewJSXItems.wrapItem";
...
if (process.env.NODE_ENV !== "production")
  useTreeViewJSXItems.wrapRoot.displayName = "useTreeViewJSXItems.wrapRoot";
