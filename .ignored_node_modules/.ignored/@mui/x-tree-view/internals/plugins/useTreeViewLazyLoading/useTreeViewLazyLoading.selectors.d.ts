...
export declare const selectorDataSourceState: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewLazyLoading.types.js").UseTreeViewLazyLoadingState &
    Partial<{}> & {
 ...
 */
export declare const selectorIsLazyLoadingEnabled: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    Partial<
      import("./useTreeViewLazyLoading.types.js").UseTreeViewLazyLoadingState
    > & {
  ...
  resultFunc: (
    resultFuncArgs_0:
      | {
          ...
          dataSource: {
            loading: Record<
              import("../../../index.js").TreeViewItemId,
              boolean
            >;
            errors: Record<
              import("../../../index.js").TreeViewItemId,
  ...
  lastResult: () => boolean;
  dependencies: [
    TreeViewRootSelectorForOptionalPlugin<UseTreeViewLazyLoadingSignature>,
  ];
  recomputations: () => number;
  resetRecomputations: () => void;
  dependencyRecomputations: () => number;
 ...
 */
export declare const selectorIsItemLoading: ((
  state: any,
  itemId: string,
) => boolean) & {
  clearCache: () => void;
 ...
 */
export declare const selectorGetTreeItemError: ((
  state: any,
  itemId: string,
) => Error | null) & {
  clearCache: () => void;
