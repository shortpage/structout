...
function selectorItemCheckboxStatus(state, itemId) {
  ...
  _useTreeViewSelection.selectorIsCheckboxSelectionEnabled)(state);
  const isSelectionEnabledForItem = (0,
  _useTreeViewSelection.selectorIsItemSelectionEnabled)(state, itemId);
  ...
  return {
    ...
    checked: (0, _useTreeViewSelection.selectorSelectionPropagationRules)(state)
      .parents
...
const useTreeViewSelectionItemPlugin = ({ props }) => {
  ...
  const checkboxStatus = (0, _useSelector.useSelector)(
    store,
    ...
    propsEnhancers: {
      checkbox: ({ externalEventHandlers, interactions }) => {
        const handleChange = (event) => {
          ...
          if (
            !(0, _useTreeViewSelection.selectorIsItemSelectionEnabled)(
              store.value,
              itemId,
            )
          ) {
