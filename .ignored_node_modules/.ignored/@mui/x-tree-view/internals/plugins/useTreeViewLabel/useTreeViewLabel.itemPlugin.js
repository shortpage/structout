...
const useTreeViewLabelItemPlugin = ({ props }) => {
  ...
  const isItemEditable = (0, _useSelector.useSelector)(
    store,
    _useTreeViewLabel.selectorIsItemEditable,
    itemId,
  );
  const isItemBeingEdited = (0, _useSelector.useSelector)(
    store,
    _useTreeViewLabel.selectorIsItemBeingEdited,
    itemId,
  );
  React.useEffect(() => {
