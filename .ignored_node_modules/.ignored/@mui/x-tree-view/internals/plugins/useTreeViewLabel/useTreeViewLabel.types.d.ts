...
export type UseTreeViewLabelParametersWithDefaults<R extends {}> =
  DefaultizedProps<UseTreeViewLabelParameters<R>, "isItemEditable">;
...
export interface UseTreeItemLabelInputSlotPropsFromLabelEditing
  extends TreeItemLabelInputProps {}
...
declare module "@mui/x-tree-view/useTreeItem" {
  ...
  interface UseTreeItemLabelSlotOwnProps
    extends UseTreeItemLabelSlotPropsFromLabelEditing {}
}
