...
const useTreeViewKeyboardNavigation = ({ instance, store, params }) => {
  ...
  const itemMetaLookup = (0, _useSelector.useSelector)(
    store,
  ...
  const canToggleItemSelection = (itemId) =>
    (0, _useTreeViewSelection.selectorIsSelectionEnabled)(store.value) &&
    !(0, _useTreeViewItems.selectorIsItemDisabled)(store.value, itemId);
  ...
  const handleItemKeyDown = async (event, itemId) => {
    ...
    if (
      event.altKey ||
      (0, _tree.isTargetInDescendants)(event.target, event.currentTarget)
    ) {
      return;
    }
    const ctrlPressed = event.ctrlKey || event.metaKey;
    const key = event.key;
    const isMultiSelectEnabled = (0,
    _useTreeViewSelection.selectorIsMultiSelectEnabled)(store.value);
    ...
    switch (true) {
      ...
      case key === "Enter": {
        if (
          (0, _plugins.hasPlugin)(
            instance,
            _useTreeViewLabel.useTreeViewLabel,
          ) &&
          (0, _useTreeViewLabel2.selectorIsItemEditable)(store.value, itemId) &&
          !(0, _useTreeViewLabel2.selectorIsItemBeingEdited)(
            store.value,
            itemId,
          )
        ) {
          ...
          if (isMultiSelectEnabled) {
            ...
            !(0, _useTreeViewSelection.selectorIsItemSelected)(
              store.value,
              itemId,
            )
          ) {
      ...
      case (key === "ArrowLeft" && !isRtl) || (key === "ArrowRight" && isRtl): {
        ...
        if (
          ...
          const parent = (0, _useTreeViewItems.selectorItemParentId)(
            store.value,
            itemId,
          );
          if (parent) {
      ...
      case key === "Home": {
        ...
        if (
          ...
          instance.focusItem(
            event,
            (0, _tree.getFirstNavigableItem)(store.value),
          );
        }
        event.preventDefault();
        break;
      ...
      case key === "End": {
        ...
        if (
          ...
          instance.focusItem(
            event,
            (0, _tree.getLastNavigableItem)(store.value),
          );
        }
        event.preventDefault();
        break;
