...
const useTreeViewFocus = ({ instance, params, store }) => {
  const setFocusedItemId = (0, _useEventCallback.default)((itemId) => {
    store.update((prevState) => {
      const focusedItemId = (0, _useTreeViewFocus.selectorFocusedItemId)(
        prevState,
      );
  ...
  const isItemVisible = (itemId) => {
    ...
    return (
      ...
      (itemMeta.parentId == null ||
        (0, _useTreeViewExpansion.selectorIsItemExpanded)(
          store.value,
          itemMeta.parentId,
        ))
    );
  ...
  (0, _useInstanceEventHandler.useInstanceEventHandler)(
    instance,
    "removeItem",
    ({ id }) => {
      const focusedItemId = (0, _useTreeViewFocus.selectorFocusedItemId)(
      ...
      const defaultFocusableItemId = (0,
      _useTreeViewFocus.selectorDefaultFocusableItemId)(store.value);
