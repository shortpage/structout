...
exports.selectorIsItemTheDefaultFocusableItem =
  exports.selectorIsItemFocused =
  exports.selectorFocusedItemId =
  exports.selectorDefaultFocusableItemId =
    void 0;
 ...
 */
const selectorDefaultFocusableItemId = (exports.selectorDefaultFocusableItemId =
  (0, _selectors.createSelector)(
    [
      _useTreeViewSelection.selectorSelectionModelArray,
      _useTreeViewExpansion.selectorExpandedItemsMap,
      _useTreeViewItems.selectorItemMetaLookup,
      _useTreeViewItems.selectorDisabledItemFocusable,
      (state) =>
        (0, _useTreeViewItems.selectorItemOrderedChildrenIds)(state, null),
    ],
    (
      selectedItems,
      expandedItemsMap,
      ...
      const firstSelectedItem = selectedItems.find((itemId) => {
        if (
          !disabledItemsFocusable &&
          (0, _useTreeViewItems2.isItemDisabled)(itemMetaLookup, itemId)
        ) {
          return false;
        }
        ...
        return (
          itemMeta &&
          (itemMeta.parentId == null || expandedItemsMap.has(itemMeta.parentId))
        );
      });
 ...
 */
const selectorIsItemTheDefaultFocusableItem =
  (exports.selectorIsItemTheDefaultFocusableItem = (0,
  _selectors.createSelector)(
    [selectorDefaultFocusableItemId, (_, itemId) => itemId],
 ...
 */
const selectorFocusedItemId = (exports.selectorFocusedItemId = (0,
_selectors.createSelector)(
 ...
 */
const selectorIsItemFocused = (exports.selectorIsItemFocused = (0,
_selectors.createSelector)(
  [selectorFocusedItemId, (_, itemId) => itemId],
