 ...
 */
export declare const selectorDefaultFocusableItemId: ((
  state: any,
) => string | null) & {
  clearCache: () => void;
  resultsCount: () => number;
  ...
  resultFunc: (
    resultFuncArgs_0: string[],
    resultFuncArgs_1: Map<string, true>,
    resultFuncArgs_2: {
      [itemId: string]: import("../../index.js").TreeViewItemMeta;
    },
    resultFuncArgs_3: boolean,
    resultFuncArgs_4: string[],
  ) => string | null;
  memoizedResultFunc: ((
    resultFuncArgs_0: string[],
    resultFuncArgs_1: Map<string, true>,
  ...
  dependencies: [
    ((
      state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
        import("../useTreeViewSelection/useTreeViewSelection.types.js").UseTreeViewSelectionState &
        Partial<{}> & {
      ...
      memoizedResultFunc: ((
        resultFuncArgs_0: string | string[] | null,
      ) => string[]) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
        ...
        ((
          ...
          dependencies: [
            TreeViewRootSelector<
              import("../useTreeViewSelection/index.js").UseTreeViewSelectionSignature
            >,
          ];
    ...
    ((
      state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
        import("../useTreeViewExpansion/useTreeViewExpansion.types.js").UseTreeViewExpansionState &
        Partial<{}> & {
          cacheKey: import("../../models/index.js").TreeViewStateCacheKey;
        },
    ) => Map<string, true>) & {
      ...
      dependencies: [
        ((
          ...
          dependencies: [
            TreeViewRootSelector<
              import("../useTreeViewExpansion/index.js").UseTreeViewExpansionSignature
            >,
          ];
          recomputations: () => number;
          resetRecomputations: () => void;
    ...
    ((
      state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
        import("../useTreeViewItems/index.js").UseTreeViewItemsState<
      ...
      dependencies: [
        TreeViewRootSelector<
          import("../useTreeViewItems/index.js").UseTreeViewItemsSignature
        >,
      ];
      recomputations: () => number;
      resetRecomputations: () => void;
 ...
 */
export declare const selectorIsItemTheDefaultFocusableItem: ((
  state: any,
  itemId: string,
) => boolean) & {
  clearCache: () => void;
 ...
 */
export declare const selectorFocusedItemId: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewFocus.types.js").UseTreeViewFocusState &
    Partial<{}> & {
      cacheKey: import("../../models/index.js").TreeViewStateCacheKey;
    },
) => string | null) & {
 ...
 */
export declare const selectorIsItemFocused: ((
  state: any,
  itemId: string,
) => boolean) & {
  clearCache: () => void;
