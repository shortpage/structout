...
> = TSignature[TProperty] &
  ...
  Partial<
    MergeSignaturesProperty<TSignature["optionalDependencies"], TProperty>
  >;
...
export type TreeViewUsedParamsWithDefaults<
  TSignature extends TreeViewAnyPluginSignature,
...
export type TreeViewUsedStore<TSignature extends TreeViewAnyPluginSignature> =
  TreeViewStore<[TSignature, ...TSignature["dependencies"]]>;
export type TreeViewUsedEvents<TSignature extends TreeViewAnyPluginSignature> =
  TSignature["events"] &
    MergeSignaturesProperty<TreeViewRequiredPlugins<TSignature>, "events">;
export type TreeItemWrapper<
