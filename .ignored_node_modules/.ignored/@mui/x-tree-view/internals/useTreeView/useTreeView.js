...
const useTreeView = ({ plugins: inPlugins, rootRef, props }) => {
  const plugins = React.useMemo(
    () => [..._corePlugins.TREE_VIEW_CORE_PLUGINS, ...inPlugins],
    [inPlugins],
  );
  const { pluginParams, forwardedProps, apiRef } = (0,
  _useExtractPluginParamsFromProps.useExtractPluginParamsFromProps)({
    plugins,
    props,
  });
