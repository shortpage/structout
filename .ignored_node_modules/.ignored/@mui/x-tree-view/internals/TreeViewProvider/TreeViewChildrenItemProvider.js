...
const TreeViewChildrenItemContext = (exports.TreeViewChildrenItemContext =
...
function TreeViewChildrenItemProvider(props) {
  ...
  const { instance, store, rootRef } = (0,
  _TreeViewContext.useTreeViewContext)();
  ...
  React.useEffect(() => {
    ...
    const escapedIdAttr = (0, _utils.escapeOperandAttributeSelector)(
