...
export declare const getPreviousNavigableItem: (
  state: TreeViewState<
    [UseTreeViewItemsSignature, UseTreeViewExpansionSignature]
  >,
  itemId: string,
) => string | null;
export declare const getNextNavigableItem: (
  state: TreeViewState<
    [UseTreeViewItemsSignature, UseTreeViewExpansionSignature]
  >,
  itemId: string,
) => string | null;
export declare const getLastNavigableItem: (
  state: TreeViewState<
    [UseTreeViewExpansionSignature, UseTreeViewItemsSignature]
  >,
) => string;
export declare const getFirstNavigableItem: (
  state: TreeViewState<
    [UseTreeViewExpansionSignature, UseTreeViewItemsSignature]
  >,
) => string;
...
export declare const getNonDisabledItemsInRange: (
  state: TreeViewState<
    [UseTreeViewItemsSignature, UseTreeViewExpansionSignature]
  >,
  itemAId: string,
...
export declare const getAllNavigableItems: (
  state: TreeViewState<
    [UseTreeViewItemsSignature, UseTreeViewExpansionSignature]
  >,
) => string[];
 ...
 */
export declare const isTargetInDescendants: (
  target: HTMLElement,
