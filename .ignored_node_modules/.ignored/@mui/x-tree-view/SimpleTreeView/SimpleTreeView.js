...
const useUtilityClasses = (ownerState) => {
  ...
  return React.useMemo(() => {
    ...
    return (0, _composeClasses.default)(
      slots,
      _simpleTreeViewClasses.getSimpleTreeViewUtilityClass,
      classes,
    );
  }, [classes]);
};
const SimpleTreeViewRoot = (exports.SimpleTreeViewRoot = (0,
_zeroStyled.styled)("ul", {
 ...
 */
const SimpleTreeView = (exports.SimpleTreeView = /*#__PURE__*/ React.forwardRef(
  function SimpleTreeView(inProps, ref) {
