...
function TreeItemIcon(props) {
  ...
  const iconProps = (0, _useSlotProps.default)({
    ...
    externalSlotProps: (tempOwnerState) =>
      (0, _extends2.default)(
        {},
        (0, _resolveComponentProps.default)(
          slotPropsFromTreeView[iconName],
          tempOwnerState,
        ),
        (0, _resolveComponentProps.default)(
          slotPropsFromTreeItem?.[iconName],
          tempOwnerState,
        ),
      ),
