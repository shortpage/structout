...
const useUtilityClasses = (ownerState) => {
  ...
  return React.useMemo(() => {
    ...
    return (0, _composeClasses.default)(
      slots,
      _richTreeViewClasses.getRichTreeViewUtilityClass,
      classes,
    );
  }, [classes]);
};
const RichTreeViewRoot = (exports.RichTreeViewRoot = (0, _zeroStyled.styled)(
  "ul",
  {
 ...
 */
const RichTreeView = (exports.RichTreeView = /*#__PURE__*/ React.forwardRef(
  function RichTreeView(inProps, ref) {
    ...
    const isLoading = (0, _useSelector.useSelector)(
      contextValue.store,
      _useTreeViewItems.selectorIsTreeViewLoading,
    );
    const treeViewError = (0, _useSelector.useSelector)(
      contextValue.store,
      _useTreeViewItems.selectorGetTreeViewError,
    );
    ...
    return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
      _TreeViewProvider.TreeViewProvider,
      {
        ...
        children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
          ...
          (0, _extends2.default)({}, rootProps, {
            children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
              _RichTreeViewItems.RichTreeViewItems,
              {
                slots: slots,
                slotProps: slotProps,
              },
...
if (process.env.NODE_ENV !== "production")
  RichTreeView.displayName = "RichTreeView";
process.env.NODE_ENV !== "production"
  ? (RichTreeView.propTypes = {
       ...
       * @default []
       */
      defaultExpandedItems: _propTypes.default.arrayOf(
       ...
       * @default () => false
       */
      isItemEditable: _propTypes.default.oneOfType([
       ...
       * @default 12px
       */
      itemChildrenIndentation: _propTypes.default.oneOfType([
