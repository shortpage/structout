...
} from "../../internals/plugins/useTreeViewExpansion/useTreeViewExpansion.selectors.js";
...
} from "../../internals/plugins/useTreeViewSelection/useTreeViewSelection.selectors.js";
import {
  selectorGetTreeItemError,
  selectorIsItemLoading,
  selectorIsLazyLoadingEnabled,
} from "../../internals/plugins/useTreeViewLazyLoading/useTreeViewLazyLoading.selectors.js";
import {
  selectorIsItemBeingEdited,
  selectorIsItemEditable,
} from "../../internals/plugins/useTreeViewLabel/useTreeViewLabel.selectors.js";
...
export const useTreeItemUtils = ({ itemId, children }) => {
  const { instance, store, publicAPI } = useTreeViewContext();
  ...
  const error = useSelector(store, (state) =>
    isLazyLoadingEnabled
      ? Boolean(selectorGetTreeItemError(state, itemId))
      : false,
  );
  ...
  const handleExpansion = (event) => {
    ...
    if (
      status.expandable &&
      !(multiple && selectorIsItemExpanded(store.value, itemId))
    ) {
