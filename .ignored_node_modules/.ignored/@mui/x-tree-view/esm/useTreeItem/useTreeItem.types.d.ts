...
export interface UseTreeItemRootSlotOwnProps
  extends UseTreeItemRootSlotPropsFromUseTreeItem {}
...
export type UseTreeItemIconContainerSlotProps<ExternalProps = {}> =
  ExternalProps & UseTreeItemIconContainerSlotOwnProps;
...
export type UseTreeItemErrorContainerSlotProps<ExternalProps = {}> =
  ExternalProps & {};
export type UseTreeItemLoadingContainerSlotProps<ExternalProps = {}> =
  ExternalProps & {
    size: string;
    thickness: number;
  };
...
export type UseTreeItemGroupTransitionSlotProps<ExternalProps = {}> =
  ExternalProps & UseTreeItemGroupTransitionSlotOwnProps;
export interface UseTreeItemDragAndDropOverlaySlotOwnProps {}
export type UseTreeItemDragAndDropOverlaySlotProps<ExternalProps = {}> =
  ExternalProps & UseTreeItemDragAndDropOverlaySlotOwnProps;
