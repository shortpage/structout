...
} from "../internals/plugins/useTreeViewItems/useTreeViewItems.selectors.js";
 ...
 */
const RichTreeView = /*#__PURE__*/ React.forwardRef(
  function RichTreeView(inProps, ref) {
    ...
    const treeViewError = useSelector(
      contextValue.store,
      selectorGetTreeViewError,
    );
...
process.env.NODE_ENV !== "production"
  ? (RichTreeView.propTypes = {
       ...
       * @default 12px
       */
      itemChildrenIndentation: PropTypes.oneOfType([
        PropTypes.number,
        PropTypes.string,
      ]),
