...
} from "../plugins/useTreeViewExpansion/useTreeViewExpansion.selectors.js";
import {
...
export const getPreviousNavigableItem = (state, itemId) => {
  ...
  while (
    selectorIsItemExpanded(state, currentItemId) &&
...
export const getNextNavigableItem = (state, itemId) => {
  ...
  if (selectorIsItemExpanded(state, itemId)) {
    const firstNavigableChild = selectorItemOrderedChildrenIds(
      state,
      itemId,
    ).find((childId) => selectorCanItemBeFocused(state, childId));
...
export const getNonDisabledItemsInRange = (state, itemAId, itemBId) => {
  const getNextItem = (itemId) => {
    ...
    if (
      selectorIsItemExpandable(state, itemId) &&
      selectorIsItemExpanded(state, itemId)
    ) {
    ...
    while (itemMeta != null) {
      ...
      itemMeta = itemMeta.parentId
        ? selectorItemMeta(state, itemMeta.parentId)
        : null;
    }
