 ...
 */
export type TreeViewRootSelectorForOptionalPlugin<
  TSignature extends TreeViewAnyPluginSignature,
> = <TSignatures extends [], TOptionalSignatures extends [TSignature]>(
  state: TreeViewState<TSignatures, TOptionalSignatures>,
) => TSignature["state"][keyof TSignature["state"]] | undefined;
export type TreeViewSelector<TState, TArgs, TResult> = (
  state: TState,
  args: TArgs,
) => TResult;
/**
