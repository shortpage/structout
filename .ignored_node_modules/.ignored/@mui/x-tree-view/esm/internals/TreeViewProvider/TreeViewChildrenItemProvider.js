...
export function TreeViewChildrenItemProvider(props) {
  ...
  const { instance, store, rootRef } = useTreeViewContext();
  ...
  React.useEffect(() => {
    ...
    const previousChildrenIds =
      selectorItemOrderedChildrenIds(store.value, itemId ?? null) ?? [];
    const escapedIdAttr = escapeOperandAttributeSelector(
