...
export interface UseTreeViewLazyLoadingInstance
  extends UseTreeViewLazyLoadingPublicAPI {
  /**
...
export type UseTreeViewLazyLoadingParametersWithDefaults<R extends {}> =
  DefaultizedProps<UseTreeViewLazyLoadingParameters<R>, "dataSource">;
