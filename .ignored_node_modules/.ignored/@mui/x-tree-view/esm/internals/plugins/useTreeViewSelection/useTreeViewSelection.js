...
import {
  ...
  getLookupFromArray,
} from "./useTreeViewSelection.utils.js";
import {
...
} from "./useTreeViewSelection.selectors.js";
import { useTreeViewSelectionItemPlugin } from "./useTreeViewSelection.itemPlugin.js";
export const useTreeViewSelection = ({ store, params }) => {
    ...
    if (keepExistingSelection) {
      ...
      if (
        ...
        (shouldBeSelected == null &&
          selectorIsItemSelected(store.value, itemId))
      ) {
