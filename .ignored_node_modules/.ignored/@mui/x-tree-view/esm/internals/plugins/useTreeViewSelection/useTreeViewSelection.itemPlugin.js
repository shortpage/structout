...
function selectorItemCheckboxStatus(state, itemId) {
  ...
  const isSelectionEnabledForItem = selectorIsItemSelectionEnabled(
    state,
    itemId,
  );
  ...
  const traverseDescendants = (itemToTraverseId) => {
    ...
    selectorItemOrderedChildrenIds(state, itemToTraverseId).forEach(
      traverseDescendants,
    );
  };
...
export const useTreeViewSelectionItemPlugin = ({ props }) => {
  const { itemId } = props;
