...
} from "../../TreeViewProvider/TreeViewChildrenItemProvider.js";
import {
  buildSiblingIndexes,
  TREE_VIEW_ROOT_PARENT_ID,
} from "../useTreeViewItems/useTreeViewItems.utils.js";
...
export const useTreeViewJSXItems = ({ instance, store }) => {
  ...
  const insertJSXItem = useEventCallback((item) => {
    ...
    return () => {
      store.update((prevState) => {
        ...
        const newItemModelLookup = _extends(
          {},
