 ...
 */
export declare const selectorExpandedItems: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewExpansion.types.js").UseTreeViewExpansionState &
    Partial<{}> & {
 ...
 */
export declare const selectorExpandedItemsMap: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewExpansion.types.js").UseTreeViewExpansionState &
    Partial<{}> & {
      cacheKey: import("../../models/index.js").TreeViewStateCacheKey;
 ...
 */
export declare const selectorIsItemExpanded: ((
  state: any,
  itemId: string,
) => boolean) & {
  clearCache: () => void;
 ...
 */
export declare const selectorIsItemExpandable: ((
  state: any,
  itemId: string | null,
) => boolean) & {
  clearCache: () => void;
  ...
  resultFunc: (
    resultFuncArgs_0: import("../../index.js").TreeViewItemMeta | null,
  ) => boolean;
  memoizedResultFunc: ((
    resultFuncArgs_0: import("../../index.js").TreeViewItemMeta | null,
  ) => boolean) & {
  ...
  dependencies: [
    ((
      state: any,
      itemId: string | null,
    ) => import("../../index.js").TreeViewItemMeta | null) & {
      clearCache: () => void;
      resultsCount: () => number;
      resetResultsCount: () => void;
    } & {
 ...
 */
export declare const selectorItemExpansionTrigger: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    import("./useTreeViewExpansion.types.js").UseTreeViewExpansionState &
    Partial<{}> & {
      cacheKey: import("../../models/index.js").TreeViewStateCacheKey;
