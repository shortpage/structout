...
} from "./useTreeViewExpansion.selectors.js";
...
export const useTreeViewExpansion = ({ instance, store, params }) => {
  ...
  const expandAllSiblings = (event, itemId) => {
    ...
    const siblings = selectorItemOrderedChildrenIds(
      store.value,
      itemMeta.parentId,
    );
    const diff = siblings.filter(
      (child) =>
        selectorIsItemExpandable(store.value, child) &&
        !selectorIsItemExpanded(store.value, child),
    );
