 ...
 */
export declare const selectorIsItemEditable: ((
  state: any,
  itemId: string,
) => boolean) & {
  clearCache: () => void;
  ...
  resultFunc: (
    resultFuncArgs_0:
      ...
      | undefined,
    resultFuncArgs_1: import("../../../index.js").TreeViewBaseItem<
  ...
  lastResult: () => boolean;
  dependencies: [
    TreeViewRootSelector<UseTreeViewLabelSignature, true>,
    (
      state: any,
      itemId: string,
 ...
 */
export declare const selectorIsItemBeingEdited: ((
  state: any,
  itemId: string | null,
) => boolean) & {
  clearCache: () => void;
 ...
 */
export declare const selectorIsAnyItemBeingEdited: ((
  state: import("../../corePlugins/useTreeViewId/useTreeViewId.types.js").UseTreeViewIdState &
    Partial<import("./useTreeViewLabel.types.js").UseTreeViewLabelState> & {
