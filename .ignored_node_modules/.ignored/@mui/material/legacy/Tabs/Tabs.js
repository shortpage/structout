...
var Tabs = /*#__PURE__*/ React.forwardRef(function Tabs(inProps, ref) {
  ...
  var ariaLabel = props["aria-label"],
    ...
    allowScrollButtonsMobile =
      _props$allowScrollBut === void 0 ? false : _props$allowScrollBut,
    _props$indicatorColor = props.indicatorColor,
    indicatorColor =
      _props$indicatorColor === void 0 ? "primary" : _props$indicatorColor,
    ...
    ScrollButtonComponent =
      _props$ScrollButtonCo === void 0
        ? TabScrollButton
        : _props$ScrollButtonCo,
    _props$scrollButtons = props.scrollButtons,
    scrollButtons =
      _props$scrollButtons === void 0 ? "auto" : _props$scrollButtons,
    ...
    TabIndicatorProps =
      _props$TabIndicatorPr === void 0 ? {} : _props$TabIndicatorPr,
    _props$TabScrollButto = props.TabScrollButtonProps,
    TabScrollButtonProps =
      _props$TabScrollButto === void 0 ? {} : _props$TabScrollButto,
    ...
    visibleScrollbar =
      _props$visibleScrollb === void 0 ? false : _props$visibleScrollb,
  ...
  React.useEffect(
    function () {
        ...
        records.forEach(function (record) {
          record.removedNodes.forEach(function (item) {
            ...
            (_resizeObserver = resizeObserver) == null ||
              _resizeObserver.unobserve(item);
          });
          record.addedNodes.forEach(function (item) {
            var _resizeObserver2;
            (_resizeObserver2 = resizeObserver) == null ||
              _resizeObserver2.observe(item);
          });
        });
        handleResize();
      ...
      return function () {
        ...
        (_resizeObserver3 = resizeObserver) == null ||
          _resizeObserver3.disconnect();
      };
    },
  ...
  React.useEffect(
    function () {
      ...
      if (
        ...
        var handleScrollButtonStart = function handleScrollButtonStart(
          entries,
        ) {
        ...
        var lastObserver = new IntersectionObserver(
        ...
        children: [
          ...
          /*#__PURE__*/ _jsxs(TabsScroller, {
            ...
            style: _defineProperty(
              ...
              vertical
                ? "margin".concat(isRtl ? "Left" : "Right")
                : "marginBottom",
...
process.env.NODE_ENV !== "production"
  ? (Tabs.propTypes /* remove-proptypes */ = {
      ...
      indicatorColor: PropTypes /* @typescript-to-proptypes-ignore */.oneOfType(
        [PropTypes.oneOf(["primary", "secondary"]), PropTypes.string],
      ),
      /**
       ...
       * @default 'auto'
       */
      scrollButtons: PropTypes /* @typescript-to-proptypes-ignore */.oneOf([
        "auto",
        false,
        true,
      ]),
