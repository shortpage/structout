...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    avatar: [
      "avatar",
      "avatar".concat(capitalize(size)),
      "avatarColor".concat(capitalize(color)),
    ],
    icon: [
      "icon",
      "icon".concat(capitalize(size)),
      "iconColor".concat(capitalize(iconColor)),
    ],
    deleteIcon: [
      "deleteIcon",
      ...
      "deleteIcon"
        .concat(capitalize(variant), "Color")
        .concat(capitalize(color)),
    ],
  };
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      _defineProperty(
        ...
        styles["icon".concat(capitalize(size))],
      ),
      _defineProperty(
        {},
        "& .".concat(chipClasses.icon),
      ...
      clickable &&
        color !== "default" &&
        styles["clickableColor".concat(capitalize(color), ")")],
      onDelete && styles.deletable,
      onDelete &&
        color !== "default" &&
        styles["deletableColor".concat(capitalize(color))],
      styles[variant],
...
var Chip = /*#__PURE__*/ React.forwardRef(function Chip(inProps, ref) {
  ...
  var avatarProp = props.avatar,
    ...
    skipFocusWhenDisabled =
      _props$skipFocusWhenD === void 0 ? false : _props$skipFocusWhenD,
