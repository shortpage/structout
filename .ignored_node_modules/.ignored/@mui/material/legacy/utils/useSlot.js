...
export default function useSlot(
  ...
  var rootComponent = externalForwardedProps.component,
    ...
    other = _objectWithoutProperties(externalForwardedProps, [
      "component",
      "slots",
      "slotProps",
    ]);
  ...
  var resolvedComponentsProps = resolveComponentProps(
    slotProps[name],
    ownerState,
  );
  var _mergeSlotProps = mergeSlotProps(
    ...
    mergedProps = _objectWithoutProperties(_mergeSlotProps$props, [
      "component",
    ]),
