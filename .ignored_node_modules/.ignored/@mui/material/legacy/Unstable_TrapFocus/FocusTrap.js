...
function isNonTabbableRadio(node) {
  ...
  var getRadio = function getRadio(selector) {
    return node.ownerDocument.querySelector(
      'input[type="radio"]'.concat(selector),
    );
  };
...
function FocusTrap(props) {
  var children = props.children,
    ...
    getTabbable =
      _props$getTabbable === void 0 ? defaultGetTabbable : _props$getTabbable,
    _props$isEnabled = props.isEnabled,
    isEnabled =
      _props$isEnabled === void 0 ? defaultIsEnabled : _props$isEnabled,
    open = props.open;
