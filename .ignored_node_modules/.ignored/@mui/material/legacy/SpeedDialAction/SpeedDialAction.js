...
var SpeedDialActionStaticTooltip = styled("span", {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      styles[
        "tooltipPlacement".concat(capitalize(ownerState.tooltipPlacement))
      ],
    ];
  },
})(function (_ref2) {
...
var SpeedDialAction = /*#__PURE__*/ React.forwardRef(
  function SpeedDialAction(inProps, ref) {
    ...
    var className = props.className,
      ...
      tooltipOpenProp =
        _props$tooltipOpen === void 0 ? false : _props$tooltipOpen,
      _props$tooltipPlaceme = props.tooltipPlacement,
      tooltipPlacement =
        _props$tooltipPlaceme === void 0 ? "left" : _props$tooltipPlaceme,
