...
var TableSortLabelIcon = styled("span", {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.icon,
      styles["iconDirection".concat(capitalize(ownerState.direction))],
    ];
  },
})(function (_ref3) {
 ...
 */
var TableSortLabel = /*#__PURE__*/ React.forwardRef(
  function TableSortLabel(inProps, ref) {
    ...
    var _props$active = props.active,
      ...
      hideSortIcon =
        _props$hideSortIcon === void 0 ? false : _props$hideSortIcon,
