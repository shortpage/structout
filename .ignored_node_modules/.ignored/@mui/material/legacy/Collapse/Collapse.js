...
var Collapse = /*#__PURE__*/ React.forwardRef(function Collapse(inProps, ref) {
  ...
  var addEndListener = props.addEndListener,
    ...
    collapsedSizeProp =
      _props$collapsedSize === void 0 ? "0px" : _props$collapsedSize,
    ...
    orientation =
      _props$orientation === void 0 ? "vertical" : _props$orientation,
    style = props.style,
  ...
  var handleEntered = normalizedTransitionCallback(
    function (node, isAppearing) {
            ...
            _extends(
              {
                ...
                className: clsx(
                  ...
                  className,
                  {
                    ...
                    exited:
                      !inProp && collapsedSize === "0px" && classes.hidden,
                  }[state],
                ),
                style: _extends(
                  _defineProperty(
