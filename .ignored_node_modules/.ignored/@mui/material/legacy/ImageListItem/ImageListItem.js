...
import imageListItemClasses, {
  getImageListItemUtilityClass,
} from "./imageListItemClasses";
...
var ImageListItem = /*#__PURE__*/ React.forwardRef(
  function ImageListItem(inProps, ref) {
    ...
    var _React$useContext = React.useContext(ImageListContext),
      ...
      rowHeight =
        _React$useContext$row === void 0 ? "auto" : _React$useContext$row,
          ...
          style: _extends(
            {
              height: height,
              gridColumnEnd:
                variant !== "masonry" ? "span ".concat(cols) : undefined,
              gridRowEnd:
                variant !== "masonry" ? "span ".concat(rows) : undefined,
