  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      ownerState.padding !== "normal" &&
        styles["padding".concat(capitalize(ownerState.padding))],
      ownerState.align !== "inherit" &&
        styles["align".concat(capitalize(ownerState.align))],
...
var TableCell = /*#__PURE__*/ React.forwardRef(
  function TableCell(inProps, ref) {
    ...
    var ownerState = _extends({}, props, {
      ...
      component: component,
      padding:
        paddingProp || (table && table.padding ? table.padding : "normal"),
