...
var StepConnectorLine = styled("span", {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.line,
      styles["line".concat(capitalize(ownerState.orientation))],
    ];
  },
})(function (_ref2) {
...
var StepConnector = /*#__PURE__*/ React.forwardRef(
  function StepConnector(inProps, ref) {
    ...
    var _React$useContext = React.useContext(StepperContext),
      ...
      orientation =
        _React$useContext$ori === void 0 ? "horizontal" : _React$useContext$ori;
