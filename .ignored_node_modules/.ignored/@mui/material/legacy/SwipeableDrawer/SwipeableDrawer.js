...
function calculateCurrentX(anchor, touches, doc) {
  return anchor === "right"
    ? doc.body.offsetWidth - touches[0].pageX
    : touches[0].pageX;
}
...
var SwipeableDrawer = /*#__PURE__*/ React.forwardRef(
  function SwipeableDrawer(inProps, ref) {
    ...
    var _props$anchor = props.anchor,
      ...
      disableDiscovery =
        _props$disableDiscove === void 0 ? false : _props$disableDiscove,
      _props$disableSwipeTo = props.disableSwipeToOpen,
      disableSwipeToOpen =
        _props$disableSwipeTo === void 0 ? iOS : _props$disableSwipeTo,
      hideBackdrop = props.hideBackdrop,
      _props$hysteresis = props.hysteresis,
      hysteresis = _props$hysteresis === void 0 ? 0.52 : _props$hysteresis,
      _props$allowSwipeInCh = props.allowSwipeInChildren,
      allowSwipeInChildren =
        _props$allowSwipeInCh === void 0 ? false : _props$allowSwipeInCh,
      _props$minFlingVeloci = props.minFlingVelocity,
      minFlingVelocity =
        _props$minFlingVeloci === void 0 ? 450 : _props$minFlingVeloci,
      _props$ModalProps = props.ModalProps,
      _props$ModalProps2 =
        _props$ModalProps === void 0 ? {} : _props$ModalProps,
      BackdropProps = _props$ModalProps2.BackdropProps,
      ModalPropsProp = _objectWithoutProperties(_props$ModalProps2, [
        "BackdropProps",
      ]),
      ...
      swipeAreaWidth =
        _props$swipeAreaWidth === void 0 ? 20 : _props$swipeAreaWidth,
    ...
    var setPosition = React.useCallback(
      function (translate) {
        ...
        var _options$mode = options.mode,
          ...
          changeTransition =
            _options$changeTransi === void 0 ? true : _options$changeTransi;
        var anchorRtl = getAnchor(theme, anchor);
        var rtlTranslateMultiplier =
          ["right", "bottom"].indexOf(anchorRtl) !== -1 ? 1 : -1;
        ...
        if (!disableBackdropTransition && !hideBackdrop) {
          ...
          backdropStyle.opacity =
            1 - translate / getMaxTranslate(horizontalSwipe, paperRef.current);
          if (changeTransition) {
    ...
    var handleBodyTouchMove = useEventCallback(function (nativeEvent) {
      ...
      if (
        ...
        var domTreeShapes = getDomTreeShapes(
          nativeEvent.target,
          paperRef.current,
        );
          ...
          _extends(
            {
              ...
              PaperProps: _extends({}, PaperProps, {
                style: _extends(
                  {
                    pointerEvents:
                      variant === "temporary" && !open && !allowSwipeInChildren
                        ? "none"
                        : "",
                  },
                  PaperProps.style,
              ...
              anchor: anchor,
              transitionDuration:
                calculatedDurationRef.current || transitionDuration,
              onClose: onClose,
              ref: ref,
            },
            other,
...
process.env.NODE_ENV !== "production"
  ? (SwipeableDrawer.propTypes /* remove-proptypes */ = {
       ...
       * @default false
       */
      allowSwipeInChildren: PropTypes.oneOfType([
        PropTypes.func,
        PropTypes.bool,
      ]),
      /**
