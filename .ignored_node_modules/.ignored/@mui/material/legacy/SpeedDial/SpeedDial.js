...
var SpeedDialRoot = styled("div", {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.root,
      styles["direction".concat(capitalize(ownerState.direction))],
    ];
  },
})(function (_ref) {
...
var SpeedDial = /*#__PURE__*/ React.forwardRef(
  function SpeedDial(inProps, ref) {
    ...
    var ariaLabel = props.ariaLabel,
      ...
      TransitionComponent =
        _props$TransitionComp === void 0 ? Zoom : _props$TransitionComp,
     ...
     */
    var createHandleSpeedDialActionButtonRef =
      function createHandleSpeedDialActionButtonRef(
        dialActionIndex,
        origButtonRef,
      ) {
    ...
    var handleKeyDown = function handleKeyDown(event) {
      ...
      var _nextItemArrowKey$cur = nextItemArrowKey.current,
        nextItemArrowKeyCurrent =
          _nextItemArrowKey$cur === void 0 ? key : _nextItemArrowKey$cur;
      if (event.key === "Escape") {
        setOpenState(false);
    ...
    var allItems = React.Children.toArray(childrenProp).filter(
      function (child) {
    ...
    var children = allItems.map(function (child, index) {
      var _child$props = child.props,
        ...
        _child$props$FabProps2 =
          _child$props$FabProps === void 0 ? {} : _child$props$FabProps,
        origButtonRef = _child$props$FabProps2.ref,
        ChildFabProps = _objectWithoutProperties(_child$props$FabProps2, [
          "ref",
        ]),
        tooltipPlacementProp = _child$props.tooltipPlacement;
      var tooltipPlacement =
        tooltipPlacementProp ||
