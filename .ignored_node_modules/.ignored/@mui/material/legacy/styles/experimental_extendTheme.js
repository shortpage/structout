...
var defaultDarkOverlays = _toConsumableArray(Array(25)).map(
  function (_, index) {
    if (index === 0) {
      return undefined;
    }
...
export var createGetCssVar = function createGetCssVar() {
  var cssVarPrefix =
    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "mui";
...
export default function extendTheme() {
  ...
  var _options$colorSchemes = options.colorSchemes,
    colorSchemesInput =
      _options$colorSchemes === void 0 ? {} : _options$colorSchemes,
    _options$cssVarPrefix = options.cssVarPrefix,
    cssVarPrefix =
      _options$cssVarPrefix === void 0 ? "mui" : _options$cssVarPrefix,
    _options$shouldSkipGe = options.shouldSkipGeneratingVar,
    shouldSkipGeneratingVar =
      _options$shouldSkipGe === void 0
        ? defaultShouldSkipGeneratingVar
        : _options$shouldSkipGe,
  ...
  Object.keys(theme.colorSchemes).forEach(function (key) {
    ...
    if (key === "light") {
      setColor(
        palette.Alert,
        "errorColor",
        safeDarken(palette.error.light, 0.6),
      );
      setColor(palette.Alert, "infoColor", safeDarken(palette.info.light, 0.6));
      setColor(
        palette.Alert,
        "successColor",
        safeDarken(palette.success.light, 0.6),
      );
      setColor(
        palette.Alert,
        "warningColor",
        safeDarken(palette.warning.light, 0.6),
      );
      setColor(
        palette.Alert,
        "errorFilledBg",
      ...
      setColor(
        palette.Alert,
        "errorStandardBg",
        safeLighten(palette.error.light, 0.9),
      );
      setColor(
        palette.Alert,
        "infoStandardBg",
        safeLighten(palette.info.light, 0.9),
      );
      setColor(
        palette.Alert,
        "successStandardBg",
        safeLighten(palette.success.light, 0.9),
      );
      setColor(
        palette.Alert,
        "warningStandardBg",
        safeLighten(palette.warning.light, 0.9),
      );
      setColor(
        palette.Alert,
        "errorIconColor",
      ...
      setColor(
        ...
        "primaryBg",
        safeLighten(palette.primary.main, 0.62),
      );
      setColor(
        palette.LinearProgress,
        "secondaryBg",
        safeLighten(palette.secondary.main, 0.62),
      );
      setColor(
        palette.LinearProgress,
        "errorBg",
        safeLighten(palette.error.main, 0.62),
      );
      setColor(
        palette.LinearProgress,
        "infoBg",
        safeLighten(palette.info.main, 0.62),
      );
      setColor(
        palette.LinearProgress,
        "successBg",
        safeLighten(palette.success.main, 0.62),
      );
      setColor(
        palette.LinearProgress,
        "warningBg",
        safeLighten(palette.warning.main, 0.62),
      );
      setColor(
        palette.Skeleton,
        "bg",
        "rgba(".concat(
          setCssVarColor("palette-text-primaryChannel"),
          " / 0.11)",
        ),
      );
      setColor(
      ...
      var snackbarContentBackground = safeEmphasize(
      ...
      setColor(
        palette.TableCell,
        "border",
        safeLighten(safeAlpha(palette.divider, 1), 0.88),
      );
      ...
      setColor(
        palette.Alert,
        "errorColor",
        safeLighten(palette.error.light, 0.6),
      );
      setColor(
        palette.Alert,
        "infoColor",
        safeLighten(palette.info.light, 0.6),
      );
      setColor(
        palette.Alert,
        "successColor",
        safeLighten(palette.success.light, 0.6),
      );
      setColor(
        palette.Alert,
        "warningColor",
        safeLighten(palette.warning.light, 0.6),
      );
      setColor(
        palette.Alert,
        "errorFilledBg",
      ...
      setColor(
        palette.Alert,
        "errorStandardBg",
        safeDarken(palette.error.light, 0.9),
      );
      setColor(
        palette.Alert,
        "infoStandardBg",
        safeDarken(palette.info.light, 0.9),
      );
      setColor(
        palette.Alert,
        "successStandardBg",
        safeDarken(palette.success.light, 0.9),
      );
      setColor(
        palette.Alert,
        "warningStandardBg",
        safeDarken(palette.warning.light, 0.9),
      );
      setColor(
        palette.Alert,
        "errorIconColor",
      ...
      setColor(
        palette.LinearProgress,
        "primaryBg",
        safeDarken(palette.primary.main, 0.5),
      );
      setColor(
        palette.LinearProgress,
        "secondaryBg",
        safeDarken(palette.secondary.main, 0.5),
      );
      setColor(
        palette.LinearProgress,
        "errorBg",
        safeDarken(palette.error.main, 0.5),
      );
      setColor(
        palette.LinearProgress,
        "infoBg",
        safeDarken(palette.info.main, 0.5),
      );
      setColor(
        palette.LinearProgress,
        "successBg",
        safeDarken(palette.success.main, 0.5),
      );
      setColor(
        palette.LinearProgress,
        "warningBg",
        safeDarken(palette.warning.main, 0.5),
      );
      setColor(
        palette.Skeleton,
        "bg",
      ...
      var _snackbarContentBackground = safeEmphasize(
        palette.background.default,
        0.98,
      );
      ...
      setColor(
        palette.Switch,
        "primaryDisabledColor",
        safeDarken(palette.primary.main, 0.55),
      );
      setColor(
        palette.Switch,
        "secondaryDisabledColor",
        safeDarken(palette.secondary.main, 0.55),
      );
      setColor(
        palette.Switch,
        "errorDisabledColor",
        safeDarken(palette.error.main, 0.55),
      );
      setColor(
        palette.Switch,
        "infoDisabledColor",
        safeDarken(palette.info.main, 0.55),
      );
      setColor(
        palette.Switch,
        "successDisabledColor",
        safeDarken(palette.success.main, 0.55),
      );
      setColor(
        palette.Switch,
        "warningDisabledColor",
        safeDarken(palette.warning.main, 0.55),
      );
      setColor(
        palette.TableCell,
        "border",
        safeDarken(safeAlpha(palette.divider, 1), 0.68),
      );
      setColor(palette.Tooltip, "bg", safeAlpha(palette.grey[700], 0.92));
    }
      ...
      if (colors && _typeof(colors) === "object") {
        ...
        if (colors.main) {
          setColor(
            palette[color],
            "mainChannel",
            safeColorChannel(toRgb(colors.main)),
          );
        }
        if (colors.light) {
          setColor(
            palette[color],
            "lightChannel",
            safeColorChannel(toRgb(colors.light)),
          );
        }
        if (colors.dark) {
          setColor(
            palette[color],
            "darkChannel",
            safeColorChannel(toRgb(colors.dark)),
          );
        }
