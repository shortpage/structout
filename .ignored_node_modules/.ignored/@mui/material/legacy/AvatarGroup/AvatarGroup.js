...
import avatarGroupClasses, {
  getAvatarGroupUtilityClass,
} from "./avatarGroupClasses";
...
var AvatarGroup = /*#__PURE__*/ React.forwardRef(
  function AvatarGroup(inProps, ref) {
    ...
    var children = React.Children.toArray(childrenProp).filter(
      function (child) {
    ...
    var extraAvatars = Math.max(
      totalAvatars - clampedMax,
      totalAvatars - maxAvatars,
      0,
    );
    var extraAvatarsElement = renderSurplus
