      ...
      _defineProperty(
        _defineProperty(
          _defineProperty(
            _defineProperty(
              {},
              '&[data-popper-placement*="bottom"] .'.concat(
    ...
    return [
      ...
      styles[
        "tooltipPlacement".concat(
          capitalize(ownerState.placement.split("-")[0]),
        )
      ],
    ];
  },
...
var Tooltip = /*#__PURE__*/ React.forwardRef(function Tooltip(inProps, ref) {
  ...
  var _props$arrow = props.arrow,
    ...
    describeChild =
      _props$describeChild === void 0 ? false : _props$describeChild,
    ...
    disableInteractiveProp =
      _props$disableInterac === void 0 ? false : _props$disableInterac,
