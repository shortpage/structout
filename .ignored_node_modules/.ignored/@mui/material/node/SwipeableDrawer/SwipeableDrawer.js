...
var _useEventCallback = _interopRequireDefault(
  require("../utils/useEventCallback"),
);
var _useEnhancedEffect = _interopRequireDefault(
  require("../utils/useEnhancedEffect"),
);
...
const SwipeableDrawer = /*#__PURE__*/ React.forwardRef(
  function SwipeableDrawer(inProps, ref) {
    ...
    const {
      ...
      ModalPropsProp = (0, _objectWithoutPropertiesLoose2.default)(
        props.ModalProps,
        _excluded,
      ),
    ...
    const handleBodyTouchMove = (0, _useEventCallback.default)(
      (nativeEvent) => {
        // the ref may be null when a parent component updates while swiping
        ...
        if (
          ...
          const domTreeShapes = getDomTreeShapes(
            nativeEvent.target,
            paperRef.current,
          );
        ...
        if (open) {
          if (!swipeInstance.current.paperHit) {
            const paperHit = horizontalSwipe
    ...
    const handleBodyTouchStart = (0, _useEventCallback.default)(
      (nativeEvent) => {
    ...
    return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(React.Fragment, {
      children: [
        ...
        !disableSwipeToOpen &&
          variant === "temporary" &&
          /*#__PURE__*/ (0, _jsxRuntime.jsx)(_NoSsr.default, {
