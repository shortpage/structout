...
var _AccordionContext = _interopRequireDefault(
  require("../Accordion/AccordionContext"),
);
var _accordionSummaryClasses = _interopRequireWildcard(
  require("./accordionSummaryClasses"),
);
...
const AccordionSummary = /*#__PURE__*/ React.forwardRef(
  function AccordionSummary(inProps, ref) {
    const props = (0, _DefaultPropsProvider.useDefaultProps)({
      props: inProps,
      name: "MuiAccordionSummary",
    });
    const { children, className, expandIcon, focusVisibleClassName, onClick } =
        props,
