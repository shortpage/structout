...
var _formControlLabelClasses = _interopRequireWildcard(
  require("./formControlLabelClasses"),
);
...
const FormControlLabelRoot = (exports.FormControlLabelRoot = (0,
_styled.default)("label", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles.root,
      styles[
        `labelPlacement${(0, _capitalize.default)(ownerState.labelPlacement)}`
      ],
    ];
  },
})(({ theme, ownerState }) =>
...
const FormControlLabel = /*#__PURE__*/ React.forwardRef(
  function FormControlLabel(inProps, ref) {
    ...
    const disabled =
      (_ref = disabledProp != null ? disabledProp : control.props.disabled) !=
      null
        ? _ref
        : muiFormControl == null
          ? void 0
    ...
    const required =
      requiredProp != null ? requiredProp : control.props.required;
    const controlProps = {
      disabled,
      required,
    };
    ...
    if (
      label != null &&
      label.type !== _Typography.default &&
      !disableTypography
    ) {
...
process.env.NODE_ENV !== "production"
  ? (FormControlLabel.propTypes /* remove-proptypes */ = {
       ...
       * @default 'end'
       */
      labelPlacement: _propTypes.default.oneOf([
        "bottom",
        "end",
        "start",
        "top",
