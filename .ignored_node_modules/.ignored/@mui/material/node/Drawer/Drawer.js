...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    paper: [
      ...
      variant !== "temporary" &&
        `paperAnchorDocked${(0, _capitalize.default)(anchor)}`,
    ],
  };
  return (0, _composeClasses.default)(
    slots,
    _drawerClasses.getDrawerUtilityClass,
    classes,
  );
};
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      ownerState.variant !== "temporary" &&
        styles[
          `paperAnchorDocked${(0, _capitalize.default)(ownerState.anchor)}`
        ],
    ];
  },
})(({ theme, ownerState }) =>
...
const Drawer = /*#__PURE__*/ React.forwardRef(function Drawer(inProps, ref) {
  ...
  const {
    ...
    ModalProps = (0, _objectWithoutPropertiesLoose2.default)(
      props.ModalProps,
      _excluded,
    ),
