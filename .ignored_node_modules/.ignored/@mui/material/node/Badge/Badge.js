...
var _usePreviousProps = _interopRequireDefault(
  require("@mui/utils/usePreviousProps"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _badgeClasses.getBadgeUtilityClass,
    classes,
  );
};
...
process.env.NODE_ENV !== "production"
  ? (Badge.propTypes /* remove-proptypes */ = {
      ...
      componentsProps: _propTypes.default.shape({
        badge: _propTypes.default.oneOfType([
      ...
      variant: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(["dot", "standard"]),
          _propTypes.default.string,
        ]),
    })
  : void 0;
