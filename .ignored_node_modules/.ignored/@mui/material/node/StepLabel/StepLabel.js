...
var _StepperContext = _interopRequireDefault(
  require("../Stepper/StepperContext"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _stepLabelClasses.getStepLabelUtilityClass,
    classes,
  );
};
...
const StepLabel = /*#__PURE__*/ React.forwardRef(
  function StepLabel(inProps, ref) {
    ...
    const { alternativeLabel, orientation } = React.useContext(
    ...
    const labelSlotProps =
      (_slotProps$label = slotProps.label) != null
        ? _slotProps$label
