...
var _ArrowDownward = _interopRequireDefault(
  require("../internal/svg-icons/ArrowDownward"),
);
var _styled = _interopRequireDefault(require("../styles/styled"));
var _DefaultPropsProvider = require("../DefaultPropsProvider");
var _capitalize = _interopRequireDefault(require("../utils/capitalize"));
var _tableSortLabelClasses = _interopRequireWildcard(
  require("./tableSortLabelClasses"),
);
...
const TableSortLabelIcon = (0, _styled.default)("span", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.icon,
      styles[`iconDirection${(0, _capitalize.default)(ownerState.direction)}`],
    ];
  },
})(({ theme, ownerState }) =>
  (0, _extends2.default)(
 ...
 */
const TableSortLabel = /*#__PURE__*/ React.forwardRef(
