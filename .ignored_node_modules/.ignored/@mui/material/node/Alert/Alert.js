...
var _SuccessOutlined = _interopRequireDefault(
  require("../internal/svg-icons/SuccessOutlined"),
);
...
var _ErrorOutline = _interopRequireDefault(
  require("../internal/svg-icons/ErrorOutline"),
);
var _InfoOutlined = _interopRequireDefault(
  require("../internal/svg-icons/InfoOutlined"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _alertClasses.getAlertUtilityClass,
    classes,
  );
};
const AlertRoot = (0, _zeroStyled.styled)(_Paper.default, {
  ...
  const getColor =
    theme.palette.mode === "light"
      ? _colorManipulator.darken
      : _colorManipulator.lighten;
...
const Alert = /*#__PURE__*/ React.forwardRef(function Alert(inProps, ref) {
  ...
  const [CloseButtonSlot, closeButtonProps] = (0, _useSlot.default)(
    "closeButton",
    {
