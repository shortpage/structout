...
var _paginationItemClasses = _interopRequireWildcard(
  require("./paginationItemClasses"),
);
var _ButtonBase = _interopRequireDefault(require("../ButtonBase"));
var _capitalize = _interopRequireDefault(require("../utils/capitalize"));
var _FirstPage = _interopRequireDefault(
  require("../internal/svg-icons/FirstPage"),
);
var _LastPage = _interopRequireDefault(
  require("../internal/svg-icons/LastPage"),
);
var _NavigateBefore = _interopRequireDefault(
  require("../internal/svg-icons/NavigateBefore"),
);
var _NavigateNext = _interopRequireDefault(
  require("../internal/svg-icons/NavigateNext"),
);
...
const overridesResolver = (props, styles) => {
  ...
  return [
    ...
    ownerState.variant === "text" &&
      styles[`text${(0, _capitalize.default)(ownerState.color)}`],
...
const useUtilityClasses = (ownerState) => {
  const { classes, color, disabled, selected, size, shape, type, variant } =
    ownerState;
  const slots = {
    root: [
      "root",
...
const PaginationItemPage = (0, _styled.default)(_ButtonBase.default, {
  ...
  ({ theme, ownerState }) =>
    (0, _extends2.default)(
      {},
      ownerState.variant === "text" && {
        [`&.${_paginationItemClasses.default.selected}`]: (0,
        _extends2.default)(
          {},
  ...
  function PaginationItem(inProps, ref) {
    ...
    const normalizedIcons = isRtl
      ? {
          ...
          next:
            slots.previous || components.previous || _NavigateBefore.default,
...
process.env.NODE_ENV !== "production"
  ? (PaginationItem.propTypes /* remove-proptypes */ = {
      ...
      variant: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(["outlined", "text"]),
          _propTypes.default.string,
        ]),
    })
  : void 0;
