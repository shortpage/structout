...
var _FormControlContext = _interopRequireDefault(
  require("../FormControl/FormControlContext"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _inputBaseClasses.getInputBaseUtilityClass,
    classes,
  );
};
...
const InputBaseComponent = (exports.InputBaseComponent = (0, _styled.default)(
  "input",
  {
    name: "MuiInputBase",
    slot: "Input",
...
const inputGlobalStyles = /*#__PURE__*/ (0, _jsxRuntime.jsx)(
  _GlobalStyles.default,
  {
    styles: {
 ...
 */
const InputBase = /*#__PURE__*/ React.forwardRef(
...
process.env.NODE_ENV !== "production"
  ? (InputBase.propTypes /* remove-proptypes */ = {
       ...
       */
      maxRows: _propTypes.default.oneOfType([
       ...
       */
      minRows: _propTypes.default.oneOfType([
        _propTypes.default.number,
        _propTypes.default.string,
      ]),
      /**
