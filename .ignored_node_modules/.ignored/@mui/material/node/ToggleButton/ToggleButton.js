...
var _toggleButtonClasses = _interopRequireWildcard(
  require("./toggleButtonClasses"),
);
...
var _isValueSelected = _interopRequireDefault(
  require("../ToggleButtonGroup/isValueSelected"),
);
...
const ToggleButton = /*#__PURE__*/ React.forwardRef(
  function ToggleButton(inProps, ref) {
    ...
    const _React$useContext = React.useContext(
        _ToggleButtonGroupContext.default,
      ),
      { value: contextValue } = _React$useContext,
      contextProps = (0, _objectWithoutPropertiesLoose2.default)(
        _React$useContext,
        _excluded,
      );
...
process.env.NODE_ENV !== "production"
  ? (ToggleButton.propTypes /* remove-proptypes */ = {
       ...
       */
      value:
        _propTypes.default /* @typescript-to-proptypes-ignore */.any.isRequired,
    })
  : void 0;
