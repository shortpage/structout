...
var _styleFunctionSx = _interopRequireWildcard(
  require("@mui/system/styleFunctionSx"),
);
var _colorManipulator = require("@mui/system/colorManipulator");
var _shouldSkipGeneratingVar = _interopRequireDefault(
  require("./shouldSkipGeneratingVar"),
);
...
function extendTheme(options = {}, ...args) {
  ...
  Object.keys(theme.colorSchemes).forEach((key) => {
    ...
    if (key === "light") {
      ...
      _colorManipulator.private_safeEmphasize)(palette.background.default, 0.8);
      ...
      setColor(
        ...
        "fabHoverBg",
        (0, _colorManipulator.private_safeEmphasize)(
      ...
      const snackbarContentBackground = (0,
      _colorManipulator.private_safeEmphasize)(
      ...
      if (colors && typeof colors === "object") {
        ...
        if (colors.light) {
          setColor(
            palette[color],
            "lightChannel",
            (0, _colorManipulator.private_safeColorChannel)(
              toRgb(colors.light),
            ),
          );
        }
  ...
  const { vars: themeVars, generateCssVars } = (0,
  _system.unstable_prepareCssVars)(theme, parserConfig);
