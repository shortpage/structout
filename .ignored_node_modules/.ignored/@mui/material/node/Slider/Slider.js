...
var _isHostComponent = _interopRequireDefault(
  require("@mui/utils/isHostComponent"),
);
var _useSlider = require("./useSlider");
var _zeroStyled = require("../zero-styled");
var _DefaultPropsProvider = require("../DefaultPropsProvider");
var _slotShouldForwardProp = _interopRequireDefault(
              ...
              : (0, _extends2.default)(
                  {
                    ...
                    borderColor: (0, _colorManipulator.lighten)(
                      theme.palette[color].main,
                      0.62,
                    ),
                  },
                  ...
                  theme.applyStyles("dark", {
                    borderColor: (0, _colorManipulator.darken)(
                      theme.palette[color].main,
                      0.5,
                    ),
                  }),
    ...
    variants: [
      ...
      ...Object.keys(
        ...
        .map((color) => ({
          ...
          style: {
            [`&:hover, &.${_sliderClasses.default.focusVisible}`]: (0,
            _extends2.default)(
              {},
              theme.vars
                ? {
...
const SliderMark = (exports.SliderMark = (0, _zeroStyled.styled)("span", {
  ...
  shouldForwardProp: (prop) =>
    (0, _slotShouldForwardProp.default)(prop) && prop !== "markActive",
  overridesResolver: (props, styles) => {
...
const SliderMarkLabel = (exports.SliderMarkLabel = (0, _zeroStyled.styled)(
  "span",
  {
    name: "MuiSlider",
    slot: "MarkLabel",
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _sliderClasses.getSliderUtilityClass,
    classes,
  );
};
    ...
    (0, _extends2.default)({}, rootProps, {
      children: [
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(
          RailSlot,
          (0, _extends2.default)({}, railProps),
        ),
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(
          TrackSlot,
          (0, _extends2.default)({}, trackProps),
        ),
        marks
          .filter((mark) => mark.value >= min && mark.value <= max)
          .map((mark, index) => {
            const percent = (0, _useSlider.valueToPercent)(
              mark.value,
              min,
              max,
            );
...
process.env.NODE_ENV !== "production"
  ? (Slider.propTypes /* remove-proptypes */ = {
       ...
       */
      "aria-label": (0, _chainPropTypes.default)(
       ...
       */
      "aria-valuetext": (0, _chainPropTypes.default)(
        _propTypes.default.string,
        (props) => {
          const range = Array.isArray(props.value || props.defaultValue);
      ...
      componentsProps: _propTypes.default.shape({
        input: _propTypes.default.oneOfType([
        ...
        rail: _propTypes.default.oneOfType([
          _propTypes.default.func,
          _propTypes.default.object,
        ]),
        ...
        thumb: _propTypes.default.oneOfType([
          _propTypes.default.func,
          _propTypes.default.object,
        ]),
