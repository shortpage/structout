...
var _stepButtonClasses = _interopRequireWildcard(
  require("./stepButtonClasses"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _stepButtonClasses.getStepButtonUtilityClass,
    classes,
  );
};
...
const StepButton = /*#__PURE__*/ React.forwardRef(
  function StepButton(inProps, ref) {
