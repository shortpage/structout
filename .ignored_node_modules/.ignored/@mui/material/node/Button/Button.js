...
var _ButtonGroupContext = _interopRequireDefault(
  require("../ButtonGroup/ButtonGroupContext"),
);
...
const ButtonRoot = (0, _styled.default)(_ButtonBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[
        `${ownerState.variant}${(0, _capitalize.default)(ownerState.color)}`
      ],
      styles[`size${(0, _capitalize.default)(ownerState.size)}`],
      styles[
        `${ownerState.variant}Size${(0, _capitalize.default)(ownerState.size)}`
      ],
