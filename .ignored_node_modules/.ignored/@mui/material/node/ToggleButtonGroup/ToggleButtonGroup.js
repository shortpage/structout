...
var _getValidReactChildren = _interopRequireDefault(
  require("@mui/utils/getValidReactChildren"),
);
var _styled = _interopRequireDefault(require("../styles/styled"));
var _DefaultPropsProvider = require("../DefaultPropsProvider");
var _capitalize = _interopRequireDefault(require("../utils/capitalize"));
var _toggleButtonGroupClasses = _interopRequireWildcard(
  require("./toggleButtonGroupClasses"),
);
var _ToggleButtonGroupContext = _interopRequireDefault(
  require("./ToggleButtonGroupContext"),
);
var _ToggleButtonGroupButtonContext = _interopRequireDefault(
  require("./ToggleButtonGroupButtonContext"),
);
var _toggleButtonClasses = _interopRequireDefault(
  require("../ToggleButton/toggleButtonClasses"),
);
...
const ToggleButtonGroupRoot = (0, _styled.default)("div", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      {
        [`& .${_toggleButtonGroupClasses.default.firstButton}`]:
          styles.firstButton,
      },
      {
        [`& .${_toggleButtonGroupClasses.default.lastButton}`]:
          styles.lastButton,
      },
      {
        [`& .${_toggleButtonGroupClasses.default.middleButton}`]:
          styles.middleButton,
      },
      styles.root,
  ...
  (0, _extends2.default)(
    ...
    {
      [`& .${_toggleButtonGroupClasses.default.grouped}`]: (0,
      _extends2.default)(
        {},
...
const ToggleButtonGroup = /*#__PURE__*/ React.forwardRef(
      ...
      (0, _extends2.default)(
        ...
        other,
        {
          children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
            _ToggleButtonGroupContext.default.Provider,
            {
              value: context,
