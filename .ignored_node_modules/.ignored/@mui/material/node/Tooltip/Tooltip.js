...
var _elementAcceptingRef = _interopRequireDefault(
  require("@mui/utils/elementAcceptingRef"),
);
...
var _appendOwnerState = _interopRequireDefault(
  require("@mui/utils/appendOwnerState"),
);
...
var _useIsFocusVisible = _interopRequireDefault(
  require("../utils/useIsFocusVisible"),
);
...
const TooltipTooltip = (0, _styles.styled)("div", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[
        `tooltipPlacement${(0, _capitalize.default)(ownerState.placement.split("-")[0])}`
      ],
    ];
  },
})(({ theme, ownerState }) =>
...
const Tooltip = /*#__PURE__*/ React.forwardRef(function Tooltip(inProps, ref) {
  ...
  const handleRef = (0, _useForkRef.default)(
    (0, _getReactElementRef.default)(children),
    focusVisibleRef,
    setChildNode,
    ref,
  );
  ...
  const ArrowComponent =
    ...
    null
      ? _ref5
      : TooltipArrow;
  const popperProps = (0, _appendOwnerState.default)(
    PopperComponent,
    (0, _extends2.default)(
      {},
      PopperProps,
  ...
  const transitionProps = (0, _appendOwnerState.default)(
    TransitionComponent,
    (0, _extends2.default)(
      {},
      TransitionProps,
  ...
  const tooltipProps = (0, _appendOwnerState.default)(
    TooltipComponent,
    (0, _extends2.default)(
      {},
  ...
  const tooltipArrowProps = (0, _appendOwnerState.default)(
    ArrowComponent,
    (0, _extends2.default)(
      {},
