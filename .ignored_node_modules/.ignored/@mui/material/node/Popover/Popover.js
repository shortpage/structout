...
var _HTMLElementType = _interopRequireDefault(
  require("@mui/utils/HTMLElementType"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _popoverClasses.getPopoverUtilityClass,
    classes,
  );
};
const PopoverRoot = (exports.PopoverRoot = (0, _styled.default)(
  _Modal.default,
  {
    name: "MuiPopover",
    slot: "Root",
...
const PopoverPaper = (exports.PopoverPaper = (0, _styled.default)(
  _Paper.default,
  {
    name: "MuiPopover",
    slot: "Paper",
...
const Popover = /*#__PURE__*/ React.forwardRef(function Popover(inProps, ref) {
  ...
  const {
    ...
    TransitionProps = (0, _objectWithoutPropertiesLoose2.default)(
  ...
  const handlePaperRef = (0, _useForkRef.default)(
    paperRef,
  ...
  const getPositioningStyle = React.useCallback(
    (element) => {
      ...
      const containerWindow = (0, _ownerWindow.default)(
  ...
  const container =
    containerProp ||
    (anchorEl
      ? (0, _ownerDocument.default)(resolveAnchorEl(anchorEl)).body
      : undefined);
  const RootSlot =
  ...
  const _useSlotProps = (0, _useSlotProps2.default)({
    ...
    rootProps = (0, _objectWithoutPropertiesLoose2.default)(
      _useSlotProps,
      _excluded3,
    );
...
process.env.NODE_ENV !== "production"
  ? (Popover.propTypes /* remove-proptypes */ = {
       ...
       * @default 'anchorEl'
       */
      anchorReference: _propTypes.default.oneOf([
        "anchorEl",
        "anchorPosition",
        "none",
      ]),
