...
var _outlinedInputClasses = _interopRequireWildcard(
...
const OutlinedInputRoot = (0, _styled.default)(_InputBase.InputBaseRoot, {
  shouldForwardProp: (prop) =>
    (0, _styled.rootShouldForwardProp)(prop) || prop === "classes",
            ...
            /*#__PURE__*/ (0, _jsxRuntime.jsx)(NotchedOutlineRoot, {
              ...
              label:
                label != null && label !== "" && fcs.required
                  ? _React$Fragment ||
                    (_React$Fragment = /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
                      React.Fragment,
                      {
                        children: [label, "\u2009", "*"],
                      },
...
process.env.NODE_ENV !== "production"
  ? (OutlinedInput.propTypes /* remove-proptypes */ = {
      ...
      color: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(["primary", "secondary"]),
