...
var _getTextDecoration = _interopRequireWildcard(
  require("./getTextDecoration"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _linkClasses.getLinkUtilityClass,
    classes,
  );
};
    ...
    (0, _extends2.default)(
      {
        ...
        variant: variant,
        sx: [
          ...(!Object.keys(_getTextDecoration.colorTransformations).includes(
            color,
          )
            ? [
                {
