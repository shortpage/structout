...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _snackbarClasses.getSnackbarUtilityClass,
    classes,
  );
};
...
const Snackbar = /*#__PURE__*/ React.forwardRef(
  function Snackbar(inProps, ref) {
    ...
    const { getRootProps, onClickAway } = (0, _useSnackbar.default)(
