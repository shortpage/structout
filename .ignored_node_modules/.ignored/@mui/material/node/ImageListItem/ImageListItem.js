...
var _ImageListContext = _interopRequireDefault(
  require("../ImageList/ImageListContext"),
);
var _styled = _interopRequireDefault(require("../styles/styled"));
var _DefaultPropsProvider = require("../DefaultPropsProvider");
var _isMuiElement = _interopRequireDefault(require("../utils/isMuiElement"));
var _imageListItemClasses = _interopRequireWildcard(
  require("./imageListItemClasses"),
);
...
const ImageListItem = /*#__PURE__*/ React.forwardRef(
  function ImageListItem(inProps, ref) {
      ...
      (0, _extends2.default)(
        ...
        other,
        {
          children: React.Children.map(children, (child) => {
            ...
            if (
              child.type === "img" ||
              (0, _isMuiElement.default)(child, ["Image"])
            ) {
