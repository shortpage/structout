...
var _integerPropType = _interopRequireDefault(
  require("@mui/utils/integerPropType"),
);
...
var _inputBaseClasses = _interopRequireDefault(
  require("../InputBase/inputBaseClasses"),
);
var _outlinedInputClasses = _interopRequireDefault(
  require("../OutlinedInput/outlinedInputClasses"),
);
var _filledInputClasses = _interopRequireDefault(
  require("../FilledInput/filledInputClasses"),
);
var _Close = _interopRequireDefault(require("../internal/svg-icons/Close"));
var _ArrowDropDown = _interopRequireDefault(
  require("../internal/svg-icons/ArrowDropDown"),
);
var _zeroStyled = require("../zero-styled");
var _DefaultPropsProvider = require("../DefaultPropsProvider");
var _autocompleteClasses = _interopRequireWildcard(
  require("./autocompleteClasses"),
);
...
const AutocompleteRoot = (0, _zeroStyled.styled)("div", {
  ...
  overridesResolver: (props, styles) => {
    ...
    const { fullWidth, hasClearIcon, hasPopupIcon, inputFocused, size } =
      ownerState;
    return [
      {
...
const AutocompleteClearIndicator = (0, _zeroStyled.styled)(
  _IconButton.default,
  {
    name: "MuiAutocomplete",
    slot: "ClearIndicator",
...
const AutocompletePopupIndicator = (0, _zeroStyled.styled)(
  _IconButton.default,
  {
    name: "MuiAutocomplete",
    slot: "PopupIndicator",
  ...
  function Autocomplete(inProps, ref) {
    ...
    const {
        ...
        popupIcon = _ArrowDropDownIcon ||
          (_ArrowDropDownIcon = /*#__PURE__*/ (0, _jsxRuntime.jsx)(
            _ArrowDropDown.default,
            {},
          )),
        readOnly = false,
    ...
    const { ref: externalListboxRef } =
      ListboxProps != null ? ListboxProps : {};
    const _getListboxProps = getListboxProps(),
      { ref: listboxRef } = _getListboxProps,
      otherListboxProps = (0, _objectWithoutPropertiesLoose2.default)(
        _getListboxProps,
        _excluded2,
      );
    const combinedListboxRef = (0, _useForkRef.default)(
      listboxRef,
      externalListboxRef,
    );
              ...
              children: renderInput({
                ...
                InputProps: (0, _extends2.default)(
                  ...
                  (hasClearIcon || hasPopupIcon) && {
                    endAdornment: /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
...
process.env.NODE_ENV !== "production"
  ? (Autocomplete.propTypes /* remove-proptypes */ = {
       ...
       */
      defaultValue: (0, _chainPropTypes.default)(
      ...
      size: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(["small", "medium"]),
