...
var _visuallyHidden = _interopRequireDefault(
  require("@mui/utils/visuallyHidden"),
);
...
var _StarBorder = _interopRequireDefault(
  require("../internal/svg-icons/StarBorder"),
);
...
const useUtilityClasses = (ownerState) => {
  const { classes, size, readOnly, disabled, emptyValueFocused, focusVisible } =
    ownerState;
  const slots = {
    root: [
      "root",
  ...
  return (0, _composeClasses.default)(
    slots,
    _ratingClasses.getRatingUtilityClass,
    classes,
  );
};
...
const RatingDecimal = (0, _styled.default)("span", {
  ...
  shouldForwardProp: (prop) =>
    (0, _styled.slotShouldForwardProp)(prop) && prop !== "iconActive",
  overridesResolver: (props, styles) => {
...
const defaultEmptyIcon = /*#__PURE__*/ (0, _jsxRuntime.jsx)(
  _StarBorder.default,
  {
    fontSize: "inherit",
  },
...
process.env.NODE_ENV !== "production"
  ? (Rating.propTypes /* remove-proptypes */ = {
       ...
       * @default 1
       */
      precision: (0, _chainPropTypes.default)(
