...
var _speedDialActionClasses = _interopRequireWildcard(
  require("./speedDialActionClasses"),
);
...
const SpeedDialActionStaticTooltip = (0, _styled.default)("span", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[
        `tooltipPlacement${(0, _capitalize.default)(ownerState.tooltipPlacement)}`
      ],
    ];
  },
})(({ theme, ownerState }) => ({
  ...
  display: "flex",
  alignItems: "center",
  [`& .${_speedDialActionClasses.default.staticTooltipLabel}`]: (0,
  _extends2.default)(
    {
...
const SpeedDialAction = /*#__PURE__*/ React.forwardRef(
  function SpeedDialAction(inProps, ref) {
