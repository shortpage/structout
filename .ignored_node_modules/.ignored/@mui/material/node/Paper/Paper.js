...
var _getOverlayAlpha = _interopRequireDefault(
  require("../styles/getOverlayAlpha"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _paperClasses.getPaperUtilityClass,
    classes,
  );
};
...
process.env.NODE_ENV !== "production"
  ? (Paper.propTypes /* remove-proptypes */ = {
       ...
       * @default 1
       */
      elevation: (0, _chainPropTypes.default)(
        _integerPropType.default,
        (props) => {
