...
var _cardHeaderClasses = _interopRequireWildcard(
  require("./cardHeaderClasses"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _cardHeaderClasses.getCardHeaderUtilityClass,
    classes,
  );
};
...
const CardHeader = /*#__PURE__*/ React.forwardRef(
  function CardHeader(inProps, ref) {
    ...
    if (
      title != null &&
      title.type !== _Typography.default &&
      !disableTypography
    ) {
    ...
    if (
      subheader != null &&
      subheader.type !== _Typography.default &&
      !disableTypography
    ) {
