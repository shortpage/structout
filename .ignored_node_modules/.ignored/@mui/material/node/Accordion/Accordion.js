...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _accordionClasses.getAccordionUtilityClass,
    classes,
  );
};
...
const Accordion = /*#__PURE__*/ React.forwardRef(
  function Accordion(inProps, ref) {
    ...
    const [TransitionSlot, transitionProps] = (0, _useSlot.default)(
      "transition",
      {
      ...
      children: (0, _chainPropTypes.default)(
        ...
        (props) => {
          ...
          if (!(/*#__PURE__*/ React.isValidElement(summary))) {
            return new Error(
              "MUI: Expected the first child of Accordion to be a valid element.",
            );
          }
          return null;
        },
