...
exports.nativeSelectSelectStyles =
  exports.nativeSelectIconStyles =
  exports.default =
    void 0;
...
var _nativeSelectClasses = _interopRequireWildcard(
  require("./nativeSelectClasses"),
);
...
const NativeSelectIcon = (0, _styled.default)("svg", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.icon,
      ownerState.variant &&
        styles[`icon${(0, _capitalize.default)(ownerState.variant)}`],
