...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _listItemClasses.getListItemUtilityClass,
    classes,
  );
};
...
const ListItem = /*#__PURE__*/ React.forwardRef(
  function ListItem(inProps, ref) {
    ...
    const {
      ...
      ContainerProps = (0, _objectWithoutPropertiesLoose2.default)(
    ...
    const hasSecondaryAction =
      children.length &&
      (0, _isMuiElement.default)(children[children.length - 1], [
...
process.env.NODE_ENV !== "production"
  ? (ListItem.propTypes /* remove-proptypes */ = {
       ...
       * be the last child.
       */
      children: (0, _chainPropTypes.default)(
        ...
        (props) => {
          ...
          for (let i = children.length - 1; i >= 0; i -= 1) {
            ...
            if (
              (0, _isMuiElement.default)(child, ["ListItemSecondaryAction"])
            ) {
