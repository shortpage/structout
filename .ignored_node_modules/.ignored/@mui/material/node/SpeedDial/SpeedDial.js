...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _speedDialClasses.getSpeedDialUtilityClass,
    classes,
  );
};
...
const SpeedDialRoot = (0, _styled.default)("div", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.root,
      styles[`direction${(0, _capitalize.default)(ownerState.direction)}`],
    ];
  },
})(({ theme, ownerState }) =>
  (0, _extends2.default)(
...
const SpeedDial = /*#__PURE__*/ React.forwardRef(
  function SpeedDial(inProps, ref) {
    ...
    const {
      ...
      FabProps = (0, _objectWithoutPropertiesLoose2.default)(
        props.FabProps,
        _excluded,
      ),
    ...
    const handleFabRef = (0, _useForkRef.default)(
      origDialButtonRef,
      handleOwnFabRef,
    );
