...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    titleWrap: [
      ...
      actionIcon &&
        `titleWrapActionPos${(0, _capitalize.default)(actionPosition)}`,
    ],
    title: ["title"],
    subtitle: ["subtitle"],
    actionIcon: [
      "actionIcon",
      `actionIconActionPos${(0, _capitalize.default)(actionPosition)}`,
    ],
  };
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      ownerState.actionIcon &&
        styles[
          `titleWrapActionPos${(0, _capitalize.default)(ownerState.actionPosition)}`
        ],
    ];
  },
})(({ theme, ownerState }) => {
...
const ImageListItemBarActionIcon = (0, _styled.default)("div", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.actionIcon,
      styles[
        `actionIconActionPos${(0, _capitalize.default)(ownerState.actionPosition)}`
      ],
    ];
  },
})(({ ownerState }) => {
...
const ImageListItemBar = /*#__PURE__*/ React.forwardRef(
  function ImageListItemBar(inProps, ref) {
