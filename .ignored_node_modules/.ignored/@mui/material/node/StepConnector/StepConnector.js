...
const StepConnectorLine = (0, _styled.default)("span", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.line,
      styles[`line${(0, _capitalize.default)(ownerState.orientation)}`],
    ];
  },
})(({ ownerState, theme }) => {
  const borderColor =
...
const StepConnector = /*#__PURE__*/ React.forwardRef(
  function StepConnector(inProps, ref) {
    ...
    const { active, disabled, completed } = React.useContext(
      _StepContext.default,
    );
