...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _chipClasses.getChipUtilityClass,
    classes,
  );
};
    ...
    return [
      ...
      },
      {
        [`& .${_chipClasses.default.avatar}`]:
          styles[`avatar${(0, _capitalize.default)(size)}`],
      },
      {
        [`& .${_chipClasses.default.avatar}`]:
      ...
      },
      {
        [`& .${_chipClasses.default.icon}`]:
          styles[`icon${(0, _capitalize.default)(size)}`],
      },
      {
        [`& .${_chipClasses.default.icon}`]:
      ...
      onDelete &&
        color !== "default" &&
        styles[`deletableColor${(0, _capitalize.default)(color)}`],
      styles[variant],
...
const Chip = /*#__PURE__*/ React.forwardRef(function Chip(inProps, ref) {
  ...
  const component =
    clickable || onDelete ? _ButtonBase.default : ComponentProp || "div";
...
process.env.NODE_ENV !== "production"
  ? (Chip.propTypes /* remove-proptypes */ = {
      ...
      variant: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(["filled", "outlined"]),
          _propTypes.default.string,
        ]),
    })
  : void 0;
