...
var _iconButtonClasses = _interopRequireWildcard(
  require("./iconButtonClasses"),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _iconButtonClasses.getIconButtonUtilityClass,
    classes,
  );
};
const IconButtonRoot = (0, _styled.default)(_ButtonBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      ownerState.edge &&
        styles[`edge${(0, _capitalize.default)(ownerState.edge)}`],
