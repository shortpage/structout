    ...
    this.id = transformCallback((rawMessage) => {
      ...
      if (
        ...
        while (
          ...
          const message = tslib_es6.__classPrivateFieldGet(
            this,
            _Channel_pendingMessages,
            "f",
          )[
        ...
        if (
          ...
          tslib_es6.__classPrivateFieldGet(this, _Channel_messageEndIndex, "f")
        ) {
          this.cleanupCallback();
        }
      }
