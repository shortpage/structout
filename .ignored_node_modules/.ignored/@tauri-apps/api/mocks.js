...
function mockInternals() {
  ...
  window.__TAURI_INTERNALS__ =
    (_a = window.__TAURI_INTERNALS__) !== null && _a !== void 0 ? _a : {};
}
/**
...
function clearMocks() {
  ...
  if (
    (_a = window.__TAURI_INTERNALS__) === null || _a === void 0
      ? void 0
      : _a.convertFileSrc
  )
  ...
  if (
    (_b = window.__TAURI_INTERNALS__) === null || _b === void 0
      ? void 0
      : _b.invoke
  )
    // @ts-expect-error "The operand of a 'delete' operator must be optional' does not matter in this case
  ...
  if (
    (_c = window.__TAURI_INTERNALS__) === null || _c === void 0
      ? void 0
      : _c.metadata
  )
    // @ts-expect-error "The operand of a 'delete' operator must be optional' does not matter in this case
