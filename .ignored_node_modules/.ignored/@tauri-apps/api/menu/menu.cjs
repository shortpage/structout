...
class Menu extends base.MenuItemBase {
  ...
  static async default() {
    return core
      .invoke("plugin:menu|create_default")
      .then(([rid, id]) => new Menu(rid, id));
  }
  /**
  ...
  async popup(at, window) {
    ...
    return core.invoke("plugin:menu|popup", {
      ...
      kind: this.kind,
      window:
        (_a = window === null || window === void 0 ? void 0 : window.label) !==
          null && _a !== void 0
          ? _a
          : null,
  ...
  async setAsAppMenu() {
    return core
      .invoke("plugin:menu|set_as_app_menu", {
        rid: this.rid,
      })
  ...
  async setAsWindowMenu(window) {
    ...
    return core
      .invoke("plugin:menu|set_as_window_menu", {
        ...
        window:
          (_a =
            window === null || window === void 0 ? void 0 : window.label) !==
            null && _a !== void 0
            ? _a
            : null,
      })
