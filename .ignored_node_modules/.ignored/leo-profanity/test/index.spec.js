...
describe("clean", function () {
  ...
  it("should replace profanity word with *", function () {
    ...
    expect(filter.clean("lorem zoophilia ipsum")).to.equal(
      "lorem ********* ipsum",
    );
  });
  ...
  it("should detect multi occurrence", function () {
    expect(filter.clean("I have boob,boob, ass, and etc.")).to.equal(
      "I have ****,****, ***, and etc.",
    );
  });

  it("should not detect unspaced-word", function () {
    expect(filter.clean("Buy classic watches online")).to.equal(
  ...
  it("should detect multi-length-space and multi-space", function () {
    ...
    expect(filter.clean(",I h  a.   v e BoOb.")).to.equal(
      ",I h  a.   v e ****.",
    );
  });
...
describe("badWordsUsed", function () {
  ...
  it("should found profanity word", function () {
    ...
    expect(filter.badWordsUsed("lorem zoophilia ipsum")).to.deep.equal([
      "zoophilia",
    ]);
  });
...
describe("loadDictionary", function () {
  ...
  if (wordDictionary["ru"]) {
    it('should load "ru" dictionary', function () {
      ...
      expect(filter.clean("долбоёб пошёл в пизду")).to.eql(
        "******* пошёл в *****",
      );
