...
class TeleReporterEmitter {
  ...
  _serializeProject(suite) {
    ...
    const report = {
      ...
      testIgnore: (0, import_teleReceiver.serializeRegexPatterns)(
        project.testIgnore,
      ),
      testMatch: (0, import_teleReceiver.serializeRegexPatterns)(
        project.testMatch,
      ),
      ...
      grepInvert: (0, import_teleReceiver.serializeRegexPatterns)(
        project.grepInvert || [],
      ),
