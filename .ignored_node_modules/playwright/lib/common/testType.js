...
class TestTypeImpl {
  constructor(fixtures) {
    ...
    const test = (0, import_transform.wrapFunctionWithLocation)(
      this._createTest.bind(this, "default"),
    );
    test[testTypeSymbol] = this;
    test.expect = import_expect.expect;
    test.only = (0, import_transform.wrapFunctionWithLocation)(
      this._createTest.bind(this, "only"),
    );
    test.describe = (0, import_transform.wrapFunctionWithLocation)(
      this._describe.bind(this, "default"),
    );
    test.describe.only = (0, import_transform.wrapFunctionWithLocation)(
      this._describe.bind(this, "only"),
    );
    test.describe.configure = (0, import_transform.wrapFunctionWithLocation)(
      this._configure.bind(this),
    );
    test.describe.fixme = (0, import_transform.wrapFunctionWithLocation)(
      this._describe.bind(this, "fixme"),
    );
    test.describe.parallel = (0, import_transform.wrapFunctionWithLocation)(
      this._describe.bind(this, "parallel"),
    );
    test.describe.parallel.only = (0,
    import_transform.wrapFunctionWithLocation)(
      this._describe.bind(this, "parallel.only"),
    );
    test.describe.serial = (0, import_transform.wrapFunctionWithLocation)(
      this._describe.bind(this, "serial"),
    );
    test.describe.serial.only = (0, import_transform.wrapFunctionWithLocation)(
      this._describe.bind(this, "serial.only"),
    );
    test.describe.skip = (0, import_transform.wrapFunctionWithLocation)(
      this._describe.bind(this, "skip"),
    );
    test.beforeEach = (0, import_transform.wrapFunctionWithLocation)(
      this._hook.bind(this, "beforeEach"),
    );
    test.afterEach = (0, import_transform.wrapFunctionWithLocation)(
      this._hook.bind(this, "afterEach"),
    );
    test.beforeAll = (0, import_transform.wrapFunctionWithLocation)(
      this._hook.bind(this, "beforeAll"),
    );
    test.afterAll = (0, import_transform.wrapFunctionWithLocation)(
      this._hook.bind(this, "afterAll"),
    );
    test.skip = (0, import_transform.wrapFunctionWithLocation)(
      this._modifier.bind(this, "skip"),
    );
    test.fixme = (0, import_transform.wrapFunctionWithLocation)(
      this._modifier.bind(this, "fixme"),
    );
    test.fail = (0, import_transform.wrapFunctionWithLocation)(
      this._modifier.bind(this, "fail"),
    );
    test.fail.only = (0, import_transform.wrapFunctionWithLocation)(
      this._createTest.bind(this, "fail.only"),
    );
    test.slow = (0, import_transform.wrapFunctionWithLocation)(
      this._modifier.bind(this, "slow"),
    );
    test.setTimeout = (0, import_transform.wrapFunctionWithLocation)(
      this._setTimeout.bind(this),
    );
    test.step = this._step.bind(this, "pass");
    test.step.skip = this._step.bind(this, "skip");
    test.use = (0, import_transform.wrapFunctionWithLocation)(
      this._use.bind(this),
    );
    test.extend = (0, import_transform.wrapFunctionWithLocation)(
      this._extend.bind(this),
    );
    test.info = () => {
  ...
  _createTest(type, location, title, fnOrDetails, fn) {
    ...
    else if (type === "fail.only") test.annotations.push({ type: "fail" });
  }
  ...
  async _step(expectation, title, body, options = {}) {
    ...
    return await (0, import_utils.currentZone)()
      .with("stepZone", step)
      .run(async () => {
        try {
          let result = void 0;
          result = await (0, import_utils.raceAgainstDeadline)(
            async () => {
              try {
                ...
                if (result?.timedOut) testInfo._failWithError(e);
                throw e;
              }
            },
            options.timeout
              ? (0, import_utils.monotonicTime)() + options.timeout
              : 0,
          );
          if (result.timedOut)
            throw new import_playwright_core.errors.TimeoutError(
...
function validateTestDetails(details) {
  const annotations = Array.isArray(details.annotation)
    ...
    : details.annotation
      ? [details.annotation]
      : [];
  const tags = Array.isArray(details.tag)
    ? details.tag
    : details.tag
      ? [details.tag]
      : [];
...
Did you mean to call test.extend() with fixtures instead?`);
    const newFixtures = testTypeImpl.fixtures.filter(
      (theirs) =>
        !result.fixtures.find((ours) => ours.fixtures === theirs.fixtures),
    );
