...
class FullConfigInternal {
  constructor(location, userConfig, configCLIOverrides, metadata) {
    ...
    this.failOnFlakyTests = takeFirst(
    ...
    const projectConfigs = configCLIOverrides.projects ||
      userConfig.projects || [userConfig];
  ...
  constructor(
    ...
    this.project = {
      ...
      outputDir: takeFirst(
        ...
        import_path.default.join(packageJsonDir, "test-results"),
      ),
      ...
      use: (0, import_util.mergeObjects)(
        config.use,
        projectConfig.use,
    ...
    if (this.expect.toHaveScreenshot?.stylePath) {
      ...
      this.expect.toHaveScreenshot.stylePath = stylePaths.map((stylePath) =>
        import_path.default.resolve(configDir, stylePath),
      );
    }
