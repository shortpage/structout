...
class TeleSuiteUpdater {
  constructor(options) {
    ...
    this._receiver = new import_teleReceiver.TeleReporterReceiver(
      this._createReporter(),
      {
        mergeProjects: true,
        mergeTestCases: true,
        resolvePath: (rootDir, relativePath) =>
          rootDir + options.pathSeparator + relativePath,
      ...
      onConfigure: (c) => {
        ...
        this._lastRunReceiver = new import_teleReceiver.TeleReporterReceiver(
          ...
          },
          {
            ...
            resolvePath: (rootDir, relativePath) =>
              rootDir + this._options.pathSeparator + relativePath,
          },
        );
      },
      onBegin: (suite) => {
  ...
  asModel() {
    return {
      rootSuite:
        this.rootSuite || new import_teleReceiver.TeleSuite("", "root"),
      config: this.config,
