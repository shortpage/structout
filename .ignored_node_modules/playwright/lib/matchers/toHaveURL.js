  ...
  if (typeof expected !== "function") {
    throw new Error(
      [
        ...
        (0, import_matcherHint.matcherHint)(
          this,
          void 0,
          matcherName,
          expression,
  ...
  try {
    await page.mainFrame().waitForURL(
      (url) => {
        ...
        return (
          !this.isNot ===
          (0, import_utils.urlMatches)(baseURL, lastCheckedURLString, expected)
        );
      },
      { timeout },
    );
...
function toHaveURLMessage(
  ...
  if (typeof expected === "function") {
    ...
    if (pass) {
      ...
      import_expect.printReceivedStringContainExpectedResult)(
        receivedString,
        null,
      );
  ...
  const resultDetails = printedDiff
    ? printedDiff
    : printedExpected + "\n" + printedReceived;
