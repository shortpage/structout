...
class Fixture {
  constructor(runner, registration) {
    ...
    this.value = null;
    const shouldGenerateStep =
      !this.registration.box && !this.registration.option;
    const isUserFixture =
      this.registration.location &&
      (0, import_util.filterStackFile)(this.registration.location.file);
    const title = this.registration.customTitle || this.registration.name;
    const location = isUserFixture ? this.registration.location : void 0;
    this._stepInfo = shouldGenerateStep
      ? { title: `fixture: ${title}`, category: "fixture", location }
      : void 0;
...
function getRequiredFixtureNames(fn, location) {
  return (0, import_fixtures.fixtureParameterNames)(
    fn,
    location ?? { file: "<unknown>", line: 1, column: 1 },
    (e) => {
      throw new Error(
        `${(0, import_util.formatLocation)(e.location)}: ${e.message}`,
      );
    },
  );
}
