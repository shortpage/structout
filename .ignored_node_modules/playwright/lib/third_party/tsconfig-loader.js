...
function resolveConfigFile(baseConfigFile, referencedConfigFile) {
  ...
  let resolvedConfigFile = import_path.default.resolve(
    currentDir,
  ...
  if (
    ...
    referencedConfigFile.includes(".") &&
    !import_fs.default.existsSync(resolvedConfigFile)
  )
    resolvedConfigFile = import_path.default.join(
      currentDir,
      "node_modules",
      referencedConfigFile,
    );
...
function innerLoadTsConfig(
  ...
  if (!import_fs.default.existsSync(configFilePath)) return result;
  ...
  if (parsedConfig.compilerOptions?.baseUrl !== void 0) {
    result.absoluteBaseUrl = import_path.default.resolve(
      import_path.default.dirname(configFilePath),
  ...
  if (
    import_path.default.basename(configFilePath) === "jsconfig.json" &&
    result.allowJs === void 0
  )
    result.allowJs = true;
  return result;
}
