...
<html lang="en">
  ...
  <body>
    ...
    <p>
      ...
      <a href="https://en.wikipedia.org/wiki/Dwarf_planet">dwarf planet</a> in
      the <a href="https://en.wikipedia.org/wiki/Kuiper_belt">Kuiper belt</a>.
    </p>
  </body>
</html>
```
...
- if a [processor][github-unified-processor] is given,
  ...
  ([_bridge mode_][github-unified-mode])
- otherwise,
  returns a hast tree,
  the plugins used after `remarkRehype` are rehype plugins
  ([_mutate mode_][github-unified-mode])
...
<p>
  ...
  Symbol ist daher eine stilisierte Sichel: ⚳.<sup
    ><a
    ...
    <li id="user-content-fn-nasa-2015">
      <p>
        ...
        <a href="https://www.jpl.nasa.gov/infographics/what-is-a-dwarf-planet"
          ><em>What is a Dwarf Planet?</em></a
        >
